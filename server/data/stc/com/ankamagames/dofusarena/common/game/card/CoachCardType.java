...
/*    */   
/*    */   private CoachCardType(int typeId, String humanReadableName, short[] inventoryPositions)
/*    */   {
/* 42 */     this.m_id = typeId;
...
/*    */   
/*    */ 
/* 56 */   public short[] getInventoryPosition() { return this.m_inventoryPositions; }
/*    */   
/*    */   public static CoachCardType getFromId(int typeId) {
/*    */     CoachCardType[] arrayOfCoachCardType;
/* 60 */     int j = (arrayOfCoachCardType = values()).length; for (int i = 0; i < j; i++) { CoachCardType type = arrayOfCoachCardType[i];
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\card\CoachCardType.class
