...
/*     */ 
/*     */ public class Pull extends ArenaRunningEffect
/*     */ {
/*  26 */   private static final ObjectPool m_staticPool = new MonitoredPool(new com.ankamagames.framework.kernel.core.common.ObjectFactory() {
...
/*     */ 
/*     */ 
/*  32 */   private int m_lifePointsToLose = 0;
/*     */   private Point3 m_arrivalCell;
/*  34 */   private boolean m_mustBeExecuted = true;
/*     */   
/*     */ 
/*     */ 
...
/*     */     Pull wre;
/*     */     try {
/*  48 */       Pull wre = (Pull)m_staticPool.borrowObject();
...
/*     */   {
/*  64 */     if (!this.m_mustBeExecuted) { return;
/*     */     }
...
/*  74 */           HPLoss hpLoss = HPLoss.checkOut(this.m_context, Elements.EARTH, this.m_lifePointsToLose, fighter);
/*  75 */           hpLoss.disableValueComputation();
/*  76 */           hpLoss.execute(null, false);
/*     */         }
/*     */         
/*     */       }
/*     */       else {
...
/*     */     {
/*     */ 
/* 122 */       if ((((AbstractFighter)this.m_target).getProperties().isActiveProperty(FighterPropertyType.STABILIZED)) || (((AbstractFighter)this.m_target).getProperties().isActiveProperty(FighterPropertyType.ROOTED))) {
...
/*     */     
/* 149 */     MovementObstacleInformationProvider obstacleInformationProvider = fighter.getCurrentFight();
/*     */     
/* 151 */     for (int cellsCount = 0; cellsCount < this.m_value; cellsCount++) {
...
/*     */       }
/*     */       
/* 175 */       if (obstacleInformationProvider.getMovementObstacle(x + dirVector[0], y + dirVector[1], cellArrivalAltitude) != null) {
/*     */         break;
/*     */       }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\effect\runningEffect\Pull.class
