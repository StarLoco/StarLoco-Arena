...
/*     */ 
/*     */ public class Push extends ArenaRunningEffect
/*     */ {
...
/*     */ 
/*     */ 
/*  34 */   private int m_lifePointsToLose = 0;
/*     */   private Point3 m_arrivalCell;
/*     */   private int m_cellsCount;
/*     */   private int m_fallHeight;
/*     */   private boolean m_stoppedOnVoid;
/*  39 */   private boolean m_mustBeExecuted = true;
/*  40 */   private MovementObstacle m_obstacle = null;
/*     */   
...
/*     */     Push wre;
/*     */     try {
/*  57 */       Push wre = (Push)m_staticPool.borrowObject();
...
/*     */   {
/*  73 */     if (!this.m_mustBeExecuted) { return;
/*     */     }
...
/*  81 */           HPLoss hpLoss = HPLoss.checkOut(this.m_context, Elements.PHYSICAL, this.m_lifePointsToLose, fighter);
/*  82 */           hpLoss.disableValueComputation();
/*  83 */           hpLoss.execute(null, false);
...
/*  88 */             obstacleHpLoss.execute(null, false);
/*     */           }
/*     */           
/*     */         }
/*     */       }
...
/* 110 */         this.m_context.getEffectAreaManager().checkInAndOut(startPos, this.m_arrivalCell, fighter);
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/*     */     {
/*     */ 
/* 138 */       if ((((AbstractFighter)this.m_target).getProperties().isActiveProperty(FighterPropertyType.STABILIZED)) || (((AbstractFighter)this.m_target).getProperties().isActiveProperty(FighterPropertyType.ROOTED))) {
...
/* 175 */     for (this.m_cellsCount = 0; this.m_cellsCount < this.m_value; this.m_cellsCount += 1) {
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\effect\runningEffect\Push.class
