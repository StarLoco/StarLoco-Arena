...
/*     */   {
/*  58 */     TargetValidity bestAnswer = TargetValidity.INVALID;
/*     */     int[] arrayOfInt;
/*  60 */     int j = (arrayOfInt = this.m_conditions).length; for (int i = 0; i < j; i++) { int condition = arrayOfInt[i];
/*     */       
/*     */ 
...
/*     */ 
/*     */           }
/* 114 */           else if (((0x40 & condition) == 0) || 
/* 115 */             ((target instanceof BasicEffectArea)))
/*     */           {
/*     */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\fight\FightTargetValidator.class
