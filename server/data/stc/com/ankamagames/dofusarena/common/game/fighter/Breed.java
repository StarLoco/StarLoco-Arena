...
/*  37 */   COACH((byte)99);
/*     */   
/*  39 */   protected static final Logger m_logger = Logger.getLogger(Breed.class);
/*     */   
...
/*     */   
/*     */   private Breed(byte id, int baseHp, int baseAp, int baseMp, int baseInit, int baseCC, int baseEC, int value, Elements closeCombatElement, int closeCombatAp, int closeCombatDamages, int closeCombatCriticalDamages)
/*     */   {
/*  58 */     this.m_id = id;
...
/*  78 */       new int[0], 
/*  79 */       0L, 
/*  80 */       new FightTargetValidator(new int[] { 1 }), 
/*  81 */       true);
...
/*  90 */       new int[0], 
/*  91 */       0L, 
/*  92 */       new FightTargetValidator(new int[] { 1 }), 
/*  93 */       true);
/*     */   }
/*     */   
...
/*     */   
/*     */ 
/* 175 */   public Effect getCloseCombatCriticalEffect() { return this.m_closeCombatCriticalEffect; }
/*     */   
/*     */   public static Breed getBreedFromId(int id) {
/*     */     Breed[] arrayOfBreed;
/* 179 */     int j = (arrayOfBreed = values()).length; for (int i = 0; i < j; i++) { Breed breed = arrayOfBreed[i];
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\fighter\Breed.class
