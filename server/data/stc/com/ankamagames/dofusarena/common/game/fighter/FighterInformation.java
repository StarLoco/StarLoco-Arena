...
/*     */   implements Poolable
/*     */ {
/*  26 */   protected static final Logger m_logger = Logger.getLogger(FighterInformation.class);
/*     */   protected ObjectPool m_pool;
/*  28 */   private static final ObjectPool m_staticPool = new MonitoredPool(new ObjectFactory() {
/*     */     public FighterInformation makeObject() {
/*  30 */       return new FighterInformation();
/*     */     }
/*  28 */   });
/*     */   
/*     */ 
/*     */ 
/*     */   private static final byte CURRENT_SERIALIZATION_VERSION = 1;
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected byte m_breedId;
/*     */   
/*     */ 
/*  43 */   protected String m_name = "";
/*     */   protected byte m_skinIndex;
/*     */   protected byte m_sex;
/*     */   protected byte[] m_spellsInventory;
/*     */   protected byte[] m_cardsInventory;
/*  48 */   protected short m_budget = 0;
/*     */   
/*     */   public static FighterInformation checkOut(byte breedId, String name, byte skinIndex, byte sex, byte[] spellInventory, byte[] cardsInventory, short budget) {
...
/*     */     try {
/*  73 */       FighterInformation information = (FighterInformation)m_staticPool.borrowObject();
...
/* 216 */       byte[] name = new byte[buf.get()];
/* 217 */       buf.get(name);
...
/*     */     
/*     */     default: 
/* 239 */       m_logger.error("Version de FighterInformation non traitée : " + version + " version actuelle : " + 1);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\fighter\FighterInformation.class
