...
/*    */   {
/* 26 */     HashMap<String, DofusArenaUser> ignoreGroup = DofusArenaUserGroupManager.getInstance().getIgnoreGroup();
/* 27 */     if (ignoreGroup != null) {
/* 28 */       String messageText = DofusArenaTranslator.getInstance().getString("chat.ignoreList", new Object[0]);
/* 29 */       messageText = messageText + " :\n";
/* 30 */       StringBuilder s = new StringBuilder("");
/* 31 */       for (DofusArenaUser u : ignoreGroup.values()) {
/* 32 */         s.append(" +").append(u.getName()).append(" (");
/* 33 */         if (u.isOnline()) s.append("onLine"); else
/* 34 */           s.append("offLine");
/* 35 */         s.append(")\n");
/*    */       }
/* 37 */       messageText = messageText + s.toString();
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\chat\console\command\ListIgnoresCommand\class.class
