...
/*  22 */   private HashMap<String, DofusArenaUser> m_list = new HashMap();
...
/*     */     } else {
/*  44 */       DofusArenaUser dau = (DofusArenaUser)this.m_list.get(user.getName().toLowerCase());
...
/*  70 */       DofusArenaUser user = (DofusArenaUser)this.m_list.get(userName.toLowerCase());
...
/*     */   {
/*  89 */     HashMap<String, DofusArenaUser> friendList = new HashMap();
...
/*     */   {
/* 102 */     HashMap<String, DofusArenaUser> ignoreList = new HashMap();
...
/*     */   {
/* 123 */     ArrayList<DofusArenaUser> property = new ArrayList();
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\chat\DofusArenaUserGroupManager.class
