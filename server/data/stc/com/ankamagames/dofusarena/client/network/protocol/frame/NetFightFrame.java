...
/*     */     {
/*     */     case 8000: 
/*  62 */       FightCreationMessage msg = (FightCreationMessage)message;
/*     */       
...
/*  74 */           DofusArenaGameEntity.getInstance().removeFrame(UITeamManagementFrame.getInstance());
/*  75 */           DofusArenaGameEntity.getInstance().removeFrame(UIFightTeamManagementFrame.getInstance());
/*  76 */           DofusArenaGameEntity.getInstance().removeFrame(UIRandomFightTeamManagementFrame.getInstance());
/*     */           
/*     */ 
...
/*     */     {
/*     */ 
/* 170 */       DofusArenaClientInstance.getInstance().getPreferenceStore().pushChild(FightPreferenceStore.getInstance());
/*     */       
/*     */ 
...
/*     */     {
/*     */ 
/* 190 */       DofusArenaClientInstance.getInstance().getPreferenceStore().removeChild(FightPreferenceStore.getInstance());
/*     */       
/*     */ 
...
/* 210 */       DofusArenaGameEntity.getInstance().removeFrame(UIFightPresentationFrame.getInstance());
/* 211 */       DofusArenaGameEntity.getInstance().removeFrame(UIFightPlacementFrame.getInstance());
/* 212 */       DofusArenaGameEntity.getInstance().removeFrame(UIFightObservationFrame.getInstance());
/* 213 */       DofusArenaGameEntity.getInstance().removeFrame(UIFightFrame.getInstance());
/* 214 */       DofusArenaGameEntity.getInstance().removeFrame(UIFighterFrame.getInstance());
/* 215 */       DofusArenaGameEntity.getInstance().removeFrame(UIFightMenuBarFrame.getInstance());
/*     */       
/*     */ 
