...
/*     */     {
/*     */     case 4600: 
/*  66 */       EnterInstanceMessage msg = (EnterInstanceMessage)message;
/*     */       
/*     */ 
/*  69 */       MusicGroup musics = (MusicGroup)SoundManager.getInstance().getGroupByName("musics");
/*  70 */       if (musics != null) {
...
/*     */ 
/*     */ 
/*  94 */         IsoWorldTarget target = new DefaultIsoWorldTarget(msg.getWorldX(), msg.getWorldY(), msg.getAltitude());
/*  95 */         DofusArenaClientInstance.getInstance().getWorldScene().setCameraTarget(target);
/*  96 */         DofusArenaClientInstance.getInstance().getWorldScene().alignCameraOnTrackingTarget();
/*     */         
/*     */ 
/*  99 */         DofusArenaGameEntity.getInstance().removeFrame(UIMenuBarFrame.getInstance());
/* 100 */         DofusArenaGameEntity.getInstance().removeFrame(UIIslandWorldSceneInteractionFrame.getInstance());
...
/* 104 */         DofusArenaGameEntity.getInstance().removeFrame(UIFightTeamManagementFrame.getInstance());
...
/* 107 */         DofusArenaGameEntity.getInstance().removeFrame(UICoachInventoryManagementFrame.getInstance());
/*     */         
/*     */ 
...
/* 122 */           ActionGroup actionGroup = (ActionGroup)QueueActionGroupManager.getInstance().getExecutingActionGroups().getFirst();
...
/*     */         
/*     */ 
/* 144 */         NetActorsFrame.addMobile(localCoach);
/*     */         
/*     */ 
...
/*     */ 
/*     */ 
/* 152 */         DofusArenaClientInstance.getInstance().getWorldScene().setCameraTarget(localCoach);
/* 153 */         DofusArenaClientInstance.getInstance().getWorldScene().alignCameraOnTrackingTarget();
/*     */         
/*     */ 
/* 156 */         DofusArenaGameEntity.getInstance().pushFrame(UIMenuBarFrame.getInstance());
/* 157 */         DofusArenaGameEntity.getInstance().pushFrame(UIIslandWorldSceneInteractionFrame.getInstance());
...
/* 160 */         DofusArenaGameEntity.getInstance().pushFrame(UIChatFrame.getInstance());
