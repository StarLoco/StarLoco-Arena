...
/* 170 */     if ((getEvents() != null ? 1 : 0) == (getEvents().isEmpty() ? 0 : 1)) {
/* 171 */       event = (Event)getEvents().get(0);
/*     */     }
/* 173 */     return event;
/*     */   }
/*     */   
...
/*     */   {
/* 190 */     TableTurnTimeEvent te = TableTurnTimeEvent.checkOut(getTimeline().getCurrentTableturn() + 1, getTimeline());
/* 191 */     te.unvalidate();
/* 192 */     getTimeline().addTimeEvent(te);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*     */ 
/* 264 */     DofusArenaGameEntity.getInstance().pushFrame(NetFightPresentationFrame.getInstance());
/* 265 */     DofusArenaGameEntity.getInstance().pushFrame(UIFightPresentationFrame.getInstance());
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 281 */     DofusArenaGameEntity.getInstance().removeFrame(NetFightPresentationFrame.getInstance());
/* 282 */     DofusArenaGameEntity.getInstance().removeFrame(UIFightPresentationFrame.getInstance());
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 302 */     DofusArenaGameEntity.getInstance().pushFrame(NetFightPlacementFrame.getInstance());
/* 303 */     DofusArenaGameEntity.getInstance().pushFrame(UIFightPlacementFrame.getInstance());
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 322 */     DofusArenaGameEntity.getInstance().removeFrame(NetFightPlacementFrame.getInstance());
/* 323 */     DofusArenaGameEntity.getInstance().removeFrame(UIFightPlacementFrame.getInstance());
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 339 */     DofusArenaGameEntity.getInstance().pushFrame(NetFightObservationFrame.getInstance());
/* 340 */     DofusArenaGameEntity.getInstance().pushFrame(UIFightObservationFrame.getInstance());
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 364 */     DofusArenaGameEntity.getInstance().removeFrame(NetFightObservationFrame.getInstance());
/* 365 */     DofusArenaGameEntity.getInstance().removeFrame(UIFightObservationFrame.getInstance());
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 387 */     DofusArenaGameEntity.getInstance().pushFrame(NetFightActionFrame.getInstance());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 424 */     super.onFighterStartTurn(fighter);
/* 425 */     if ((isLocalCoachFighter(fighter)) && (!fighter.isSummoned()))
/*     */     {
/* 427 */       DofusArenaGameEntity.getInstance().pushFrame(UIFighterFrame.getInstance());
/*     */     }
/*     */     
...
/*     */   {
/* 440 */     super.onFighterEndTurn(fighter);
/* 441 */     if ((isLocalCoachFighter(fighter)) && (!fighter.isSummoned()))
/*     */     {
/* 443 */       DofusArenaGameEntity.getInstance().removeFrame(UIFighterFrame.getInstance());
/*     */     }
/*     */     
...
/*     */   {
/* 456 */     super.onFighterDeath(fighter);
/*     */     
/* 458 */     if (fighter.isCarrying()) {
/* 459 */       fighter.getCarriedFighter().setPosition(fighter.getPosition());
/*     */     }
/*     */     
/* 462 */     MobileManager.getInstance().removeMobile(fighter.getActor());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*     */ 
/* 491 */     DofusArenaGameEntity.getInstance().pushFrame(UIFightFrame.getInstance());
/* 492 */     DofusArenaGameEntity.getInstance().pushFrame(NetFightActorsFrame.getInstance());
/* 493 */     DofusArenaGameEntity.getInstance().pushFrame(NetFightGlobalActionFrame.getInstance());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*     */     Iterator<Fighter> fighterIterator;
/* 509 */     for (Iterator localIterator = getTeams().iterator(); localIterator.hasNext(); 
/*     */         
/* 511 */         fighterIterator.hasNext())
/*     */     {
/* 509 */       FightingTeam<Fighter> team = (FightingTeam)localIterator.next();
/* 510 */       fighterIterator = team.getFighterIterator();
/* 511 */       continue;
/* 512 */       Fighter fighter = (Fighter)fighterIterator.next();
/* 513 */       fighter.onCheckIn();
/*     */     }
/*     */     
/*     */ 
/*     */ 
/* 518 */     DofusArenaGameEntity.getInstance().removeFrame(NetFightFrame.getInstance());
/* 519 */     DofusArenaGameEntity.getInstance().removeFrame(NetFightGlobalActionFrame.getInstance());
/*     */     
/*     */ 
...
/*     */     {
/*     */     case 2: 
/* 604 */       StaticRunningEffectDelayedTimeEvent cte = (StaticRunningEffectDelayedTimeEvent)te;
/* 605 */       StaticRunningEffect re = cte.getStaticRunningEffect();
/* 606 */       re.run(cte.getGenericEffect(), cte.getContainer(), cte.getContext(), cte.getLauncher(), cte.getTargetCell(), true);
/* 607 */       break;
/*     */     
/*     */ 
/*     */     case 1: 
...
/*     */ 
/*     */     case 107: 
/* 615 */       FighterTurnTimeEvent cte = (FighterTurnTimeEvent)te;
...
/*     */     {
/*     */     case 1: 
/* 642 */       RunningEffectDurationTimeEvent cte = (RunningEffectDurationTimeEvent)te;
/* 643 */       cte.getRunningEffect().askForUnapplication();
/* 644 */       break;
/*     */     
/*     */ 
/*     */     case 107: 
/* 648 */       FighterTurnTimeEvent cte = (FighterTurnTimeEvent)te;
/* 649 */       onFighterEndTurn((Fighter)cte.getTurnBasedFighter());
/* 650 */       break;
/*     */     
/*     */ 
/*     */     case 106: 
...
/*     */ 
/*     */     case 1001: 
/* 659 */       FightClockedPeriodTimeEvent cte = (FightClockedPeriodTimeEvent)te;
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\fight\Fight.class
