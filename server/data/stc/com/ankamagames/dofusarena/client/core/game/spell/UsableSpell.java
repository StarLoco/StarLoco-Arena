...
/*     */ 
/*     */ 
/*  30 */   public static final String[] ALL_FIELDS = new String[FIELDS.length + Spell.FIELDS.length];
...
/*  82 */       return DofusArenaGameEntity.getInstance().getFight().getSpellCastValidity(this.m_fighter, this, null);
/*     */     }
...
/* 106 */       if (getCastValidity() == SpellCastValidity.OK) return Boolean.valueOf(true); return Boolean.valueOf(false);
/*     */     }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\spell\UsableSpell.class
