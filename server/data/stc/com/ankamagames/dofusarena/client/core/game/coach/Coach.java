...
/*  87 */   public static final String[] FIELDS = {
/*  88 */     "name", 
/*  89 */     "sex", 
/*  90 */     "hairIndex", 
/*  91 */     "hairColor", 
...
/*     */   
/* 124 */   public static final String[] ACTOR_LINKAGES = {
...
/*     */ 
/*     */ 
/* 138 */   private static final String[] HAIR_COLORED_PARTS = { "Cheveux", "Natte" };
/* 139 */   private static final String[] SKIN_COLORED_PARTS = { "Peau", "Main", "Crane", "Oreille" };
/*     */   
...
/*     */   {
/* 192 */     super(-1L);
/* 193 */     this.m_coachCardInventories = new CoachCardInventories(CoachCardProvider.getInstance());
/* 194 */     this.m_coachCardInventories.addEquipmentObserver(this);
/* 195 */     this.m_fighters = new HashMap();
/* 196 */     this.m_previousLaddersStrength = new HashMap();
/* 197 */     this.m_laddersStrength = new HashMap();
...
/* 330 */       this.m_betCards = new ArrayList();
/*     */     }
...
/*     */   {
/* 379 */     this.m_coachSpellInventory = new CoachSpellInventory(SpellManager.getInstance(), (short)4);
...
/* 434 */     int j = (arrayOfFighterActorEquipmentType = FighterActorEquipmentType.values()).length; for (int i = 0; i < j; i++) { FighterActorEquipmentType equipmentType = arrayOfFighterActorEquipmentType[i];
...
/*     */   {
/* 607 */     return (Iterable)this.m_fighters.values();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 807 */         ArrayList<Spell> coachCards = new ArrayList();
...
/*     */     case CLEARED: 
/*     */     case ITEM_ADDED: 
/* 889 */       InventoryItemModifiedEvent modifiedEvent = (InventoryItemModifiedEvent)event;
...
/* 896 */       InventoryItemModifiedEvent modifiedEvent = (InventoryItemModifiedEvent)event;
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\coach\Coach.class
