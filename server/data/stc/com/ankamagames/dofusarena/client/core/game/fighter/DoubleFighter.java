...
/*    */     }
/*    */     
/* 39 */     getCharacteristic(FighterCharacteristicType.HP).setMax(b.getBaseHp());
/* 40 */     getCharacteristic(FighterCharacteristicType.MP).setMax(b.getBaseMp());
/* 41 */     getCharacteristic(FighterCharacteristicType.AP).setMax(b.getBaseAp());
/* 42 */     getCharacteristic(FighterCharacteristicType.AP).toMax();
/* 43 */     getCharacteristic(FighterCharacteristicType.HP).toMax();
/* 44 */     getCharacteristic(FighterCharacteristicType.MP).toMax();
/* 45 */     getCharacteristic(FighterCharacteristicType.INIT).setMax(this.m_father.getCharacteristicValue(FighterCharacteristicType.INIT));
/* 46 */     getCharacteristic(FighterCharacteristicType.INIT).toMax();
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\fighter\DoubleFighter.class
