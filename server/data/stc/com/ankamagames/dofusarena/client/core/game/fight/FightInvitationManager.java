...
/*     */   
/*  34 */   private final HashMap<Long, FightInvitation> m_invitations = new HashMap();
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*     */ 
/*  60 */     DofusArenaGameEntity.getInstance().pushFrame(UIFightInvitationFrame.getInstance());
/*     */     
/*     */ 
/*  63 */     int messageBoxOptions = localInviter ? 4 : 24;
/*     */     
/*     */ 
/*  66 */     ArrayList<String> opponents = new ArrayList();
/*  67 */     for (NamedFightingTeam<Fighter> team : opponentTeams) {
/*  68 */       String teamMessage = "";
/*  69 */       for (TeamMate<Fighter> teamMate : team.getTeamMates()) {
/*  70 */         teamMessage = teamMessage + teamMate.getName();
/*     */       }
...
/*  80 */       if (bet != 0) {
/*  81 */         message = message + "( " + DofusArenaTranslator.getInstance().getString("fightInvitation.withBet", new Object[0]) + ")";
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/*  95 */           Worker.getInstance().pushMessage(message);
/*     */ 
/*     */         }
/*     */         else
/*     */         {
...
/* 102 */           Worker.getInstance().pushMessage(message);
/*     */         }
/*     */       }
/*     */     });
/*     */   }
...
/*     */   {
/* 116 */     FightInvitation invitation = (FightInvitation)this.m_invitations.get(Long.valueOf(invitationId));
...
/*     */   {
/* 126 */     return (FightInvitation)this.m_invitations.get(Long.valueOf(invitationId));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\fight\FightInvitationManager.class
