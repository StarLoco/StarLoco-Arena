...
/*  81 */   public static final String[] FIELDS = {
...
/*     */ 
/*     */ 
/* 116 */   public static final String[] ALL_FIELDS = new String[FIELDS.length + Coach.FIELDS.length];
/* 117 */   static { System.arraycopy(FIELDS, 0, ALL_FIELDS, 0, FIELDS.length);
/* 118 */     System.arraycopy(Coach.FIELDS, 0, ALL_FIELDS, FIELDS.length, Coach.FIELDS.length);
/*     */   }
/*     */   
/* 121 */   private static final String[] UPDATE_EQUIPMENT_PROPERTIES = {
/* 122 */     "pantEquipment", 
/* 123 */     "hairsEquipment", 
/* 124 */     "tatooEquipment", 
...
/*     */   
/*     */ 
/* 140 */   private static final String[] UPDATE_STATISTICS_PROPERTIES = {
...
/*     */ 
/*     */ 
/* 158 */   private boolean m_editableEquipmentChanged = false;
/*     */   
/*     */ 
/*     */ 
/*     */ 
/* 163 */   private boolean m_editableInventoryChanged = false;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 178 */   private ArrayList<CostFilter> m_costFilterList = new ArrayList();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 203 */   private boolean m_inventorySynchronized = true;
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */   public LocalCoach()
/*     */   {
/* 210 */     this.m_editableCoachCardInventories = new CoachCardInventories(CoachCardProvider.getInstance(), EquipedCoachCardProvider.getInstance());
/* 211 */     this.m_editableCoachCardInventories.addInventoryObserver(new InventoryObserver() {
/*     */       public void onInventoryEvent(InventoryEvent event) {
/* 213 */         LocalCoach.this.updateFiltredInventoryProperty();
/*     */       }
/*     */       
/* 216 */     });
/* 217 */     setCardTypeFilter(new TypeFilter());
/* 218 */     setSetCardFilter(new SetFilter());
/* 219 */     setPetCardFilter(new PetFilter());
/*     */     
/* 221 */     this.m_costFilterList.add(new CostFilter(0, Integer.MAX_VALUE));
/* 222 */     this.m_costFilterList.add(new CostFilter(0, 199));
/* 223 */     this.m_costFilterList.add(new CostFilter(200, 4999));
/* 224 */     this.m_costFilterList.add(new CostFilter(5000, 29999));
/* 225 */     this.m_costFilterList.add(new CostFilter(30000, 39999));
/* 226 */     this.m_costFilterList.add(new CostFilter(40000, Integer.MAX_VALUE));
/* 227 */     this.m_selectedCostFilter = ((CostFilter)this.m_costFilterList.get(0));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 261 */     return this.m_cardTypeFilter;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 278 */     return this.m_setCardFilter;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 295 */     return this.m_petCardFilter;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 342 */           removeEquipment(oldEquipment);
/*     */         }
/*     */         else {
/* 345 */           return;
/*     */         }
...
/*     */       
/*     */ 
/* 353 */       if (getEditableCoachCardInventories().addEquipmentAt(equipedCoachCard, position))
/*     */       {
...
/*     */     
/*     */ 
/* 386 */     getEditableCoachCardInventories().removeEquipment(equipment);
/*     */     
/*     */     try
/*     */     {
/* 390 */       getEditableCoachCardInventories().addToInventory(coachCard);
/*     */     }
/*     */     catch (Exception localException) {}
/*     */     
/*     */ 
...
/*     */   {
/* 407 */     getEditableCoachCardInventories().removeFromInventory(equipment);
/*     */     
/*     */ 
...
/*     */   {
/* 422 */     if (getEditableCoachCardInventories().lockCard(equipment))
/*     */     {
/*     */ 
...
/*     */     else
/*     */     {
/* 429 */       Xulor.getInstance().msgBox(DofusArenaTranslator.getInstance().getString("error.coachManagement.tooManyLocks", new Object[] { Short.valueOf(10) }), 66);
/*     */     }
/*     */     
/*     */ 
...
/*     */   {
/* 443 */     if (getEditableCoachCardInventories().unlockCard(equipment))
/*     */     {
/*     */ 
...
/* 510 */       ArrayList<CoachCard> inventory = new ArrayList();
...
/* 517 */       ArrayList<CoachCard> filtredInventory = new ArrayList();
...
/* 528 */       ArrayList<String> sets = new ArrayList();
...
/* 541 */       ArrayList<CoachCard> filtredInventory = new ArrayList();
...
/* 555 */       ArrayList<CoachCard> filtredInventory = new ArrayList();
...
/* 566 */       ArrayList<CoachCard> emotes = new ArrayList();
...
/* 576 */       ArrayList<CoachCard> emotes = new ArrayList();
...
/*     */   }
/*     */   
/* 682 */   private boolean m_cardSetInitialized = false;
/*     */   
/*     */ 
/*     */ 
/*     */   public void updateFiltredInventoryProperty()
/*     */   {
/* 688 */     Xulor.getInstance().getEnvironment().getPropertiesProvider().firePropertyValueChanged(this, "filtredEquipmentCardInventory");
...
/* 739 */       ItemExchangerEndEvent endEvent = (ItemExchangerEndEvent)event;
/*     */       
/* 741 */       switch (endEvent.getReason()) {
/*     */       case INVITATION_IMPOSSIBLE_USER_BUSY: 
/*     */       case INVITATION_LOCALLY_CANCELED: 
/* 744 */         CardTrade trade = (CardTrade)event.getItemExchanger();
/* 745 */         MessageBoxControler controler = trade.getInvitationMessageBoxControler();
/*     */         
...
/* 755 */         DofusArenaGameEntity.getInstance().removeFrame(UIExchangeFrame.getInstance());
/* 756 */         DofusArenaGameEntity.getInstance().removeFrame(NetExchangeFrame.getInstance());
/* 757 */         break;
/*     */       
/*     */       case REMOTELY_CANCELED: 
/* 760 */         DofusArenaGameEntity.getInstance().removeFrame(UIExchangeFrame.getInstance());
/* 761 */         DofusArenaGameEntity.getInstance().removeFrame(NetExchangeFrame.getInstance());
/*     */       }
/*     */       
/* 764 */       break;
/*     */     
...
/* 768 */       CardTrade trade = (CardTrade)event.getItemExchanger();
/* 769 */       byte localIndex = trade.getIndexByUser(this);
/*     */       
/* 771 */       if (event.getUserIndex() == localIndex) {
/* 772 */         trade.updateLocalReadyProperties();
/*     */       } else {
...
/* 782 */       CardTrade trade = (CardTrade)event.getItemExchanger();
/* 783 */       Xulor.getInstance().unload(trade.getInvitationMessageBoxControler().getMessageBoxId());
/*     */       
/*     */ 
/* 786 */       DofusArenaGameEntity.getInstance().removeFrame(UIExchangeInvitationFrame.getInstance());
/*     */       
/*     */ 
/* 789 */       Xulor.getInstance().getEnvironment().getPropertiesProvider().setPropertyValue("exchange.cardTrade", trade);
/*     */       
/* 791 */       int remoteUserIndex = trade.isRequesterLocal() ? 1 : 0;
...
/*     */       
/*     */ 
/* 795 */       DofusArenaGameEntity.getInstance().pushFrame(UIExchangeFrame.getInstance());
/* 796 */       DofusArenaGameEntity.getInstance().pushFrame(NetExchangeFrame.getInstance());
/*     */       
/* 798 */       break;
/*     */     
/*     */ 
/*     */ 
/*     */     case EXCHANGE_END: 
/* 803 */       DofusArenaGameEntity.getInstance().pushFrame(UIExchangeInvitationFrame.getInstance());
/*     */       
/* 805 */       final CardTrade trade = (CardTrade)event.getItemExchanger();
/* 806 */       String message = DofusArenaTranslator.getInstance().getString("exchangeInvitation.messageOut", new Object[] { trade.getUser(1).getName() });
/*     */       
/*     */ 
/* 809 */       MessageBoxControler messageBoxControler = Xulor.getInstance().msgBox(message, 132);
...
/* 816 */           Worker.getInstance().pushMessage(message);
/*     */         }
/* 818 */       });
/* 819 */       break;
/*     */     
...
/* 824 */       DofusArenaGameEntity.getInstance().pushFrame(UIExchangeInvitationFrame.getInstance());
/*     */       
/* 826 */       final CardTrade trade = (CardTrade)event.getItemExchanger();
/* 827 */       String message = DofusArenaTranslator.getInstance().getString("exchangeInvitation.messageIn", new Object[] { trade.getUser(0).getName() });
/*     */       
/*     */ 
/* 830 */       MessageBoxControler messageBoxControler = Xulor.getInstance().msgBox(message, 152);
...
/* 839 */             Worker.getInstance().pushMessage(message);
/*     */ 
/*     */           }
/*     */           else
/*     */           {
...
/* 846 */             Worker.getInstance().pushMessage(message);
/*     */           }
/*     */         }
/* 849 */       });
/* 850 */       break;
...
/* 855 */       ItemExchangerModifiedEvent modifiedEvent = (ItemExchangerModifiedEvent)event;
/*     */       
/* 857 */       CardTrade trade = (CardTrade)modifiedEvent.getItemExchanger();
/* 858 */       byte localIndex = trade.getIndexByUser(this);
/*     */       
/* 860 */       if (modifiedEvent.getUserIndex() == localIndex) {
...
/* 873 */         trade.updateLocalCardProperties();
/*     */       }
/*     */       else
/*     */       {
/* 877 */         trade.updateRemoteCardProperties();
/*     */       }
/*     */       
/*     */ 
/* 881 */       trade.updateRemoteReadyProperties();
/* 882 */       trade.updateLocalReadyProperties();
/*     */     }
/*     */     
/*     */     
/*     */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\coach\LocalCoach.class
