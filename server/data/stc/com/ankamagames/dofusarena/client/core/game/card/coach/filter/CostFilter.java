...
/*  29 */   public static final String[] FIELDS = { "minimum", "maximum", "name" };
/*     */   
/*     */ 
...
/* 131 */       value = DofusArenaTranslator.getInstance().getString("coachCardCost.lessThan", new Object[0]) + " " + this.m_maximun; } else { String value;
/* 132 */       if (this.m_maximun == Integer.MAX_VALUE) {
/* 133 */         value = DofusArenaTranslator.getInstance().getString("coachCardCost.moreThan", new Object[0]) + " " + this.m_minimum;
/*     */       } else {
/* 135 */         value = DofusArenaTranslator.getInstance().getString("coachCardCost.from", new Object[0]) + " " + this.m_minimum + " ";
/* 136 */         value = value + DofusArenaTranslator.getInstance().getString("coachCardCost.to", new Object[0]) + " " + this.m_maximun;
/*     */       } }
/* 138 */     return value + " " + DofusArenaTranslator.getInstance().getString("coachCardCost.unit", new Object[0]);
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\card\coach\filter\CostFilter.class
