...
/*     */           
/*  86 */           if (rangeMax == 0) {
/*  87 */             targetDescriptionKey = "cast.targetCaster";
/*     */           } else {
/*  89 */             int[] conditions = ((FightTargetValidator)effect.getTargetValidator()).getConditions();
/*  90 */             int[] arrayOfInt1; int j = (arrayOfInt1 = conditions).length; for (int i = 0; i < j; i++) { int c = arrayOfInt1[i];
/*  91 */               if ((0x4 & c) != 0) {
...
/*     */         {
/*     */ 
/* 142 */           description.append(DofusArenaTranslator.getInstance().getString("cast.rangeDescription", new Object[] { Integer.valueOf(rangeMin) })).append(DofusArenaTranslator.getInstance().getString(targetDescriptionKey, new Object[0])).append("\n");
/*     */         }
/*     */         
/*     */       }
/*     */       else {
/* 147 */         description.append(DofusArenaTranslator.getInstance().getString("cast.rangeDescription", new Object[] { Integer.valueOf(rangeMin), Integer.valueOf(rangeMax) })).append(DofusArenaTranslator.getInstance().getString(targetDescriptionKey, new Object[0])).append("\n");
/*     */       }
...
/*     */ 
/*     */ 
/* 166 */     description.append(" \n<style=italic,color=").append("333333").append("|").append(DofusArenaTranslator.getInstance().getString(backgroundDescriptionTranslationType, id)).append(">");
/*     */     
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\contentInitializer\CastableDescriptionGenerator.class
