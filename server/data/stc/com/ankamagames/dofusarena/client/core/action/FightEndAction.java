...
/*     */ import com.ankamagames.dofusarena.client.network.protocol.message.game.serverToClient.fight.EndFightMessage.TeamMateResultInformations;
...
/*  73 */       Iterator localIterator2; TeamMate teamMate; for (Iterator localIterator1 = looserTeamMateIds.iterator(); localIterator1.hasNext(); 
/*  74 */           localIterator2.hasNext())
/*     */       {
/*  73 */         EndFightMessage.TeamMateResultInformations teamMateResultInformations = (EndFightMessage.TeamMateResultInformations)localIterator1.next();
/*  74 */         localIterator2 = teams.iterator(); continue;team = (FightingTeam)localIterator2.next();
/*  75 */         teamMate = team.getTeamMateById(teamMateResultInformations.getId());
/*  76 */         if (teamMate != null) {
...
/*  90 */       for (FightingTeam<Fighter> team = winnerTeamMateIds.iterator(); team.hasNext(); 
/*  91 */           teamMate.hasNext())
/*     */       {
/*  90 */         EndFightMessage.TeamMateResultInformations teamMateResultInformations = (EndFightMessage.TeamMateResultInformations)team.next();
/*  91 */         teamMate = teams.iterator(); continue;Object team = (FightingTeam)teamMate.next();
/*  92 */         TeamMate teamMate = ((FightingTeam)team).getTeamMateById(teamMateResultInformations.getId());
/*  93 */         if (teamMate != null) {
...
/*     */       
/*     */ 
/* 115 */       DofusArenaGameEntity.getInstance().pushFrame(UIFightResultFrame.getInstance());
/*     */       
/*     */ 
...
/* 137 */     DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(msg);
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\action\FightEndAction.class
