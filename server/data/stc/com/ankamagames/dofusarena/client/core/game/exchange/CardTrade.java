...
/*  39 */   public static final String[] FIELDS = {
/*  40 */     "exchangeId", 
/*     */     
...
/*     */   {
/* 136 */     Coach coach = DofusArenaGameEntity.getInstance().getLocalCoach();
/* 137 */     byte index = getIndexByUser(coach);
/*     */     
/* 139 */     if (this.m_usersExchangeList[0] != null) {
/* 140 */       for (CoachCard card : this.m_usersExchangeList[0].values())
/*     */       {
/* 142 */         if (index == 0) {
/* 143 */           coach.getCardInventories().updateInventoryQuantity(card.getUniqueId(), (short)-card.getQuantity());
/*     */         } else {
/*     */           try
/*     */           {
/* 147 */             coach.getCardInventories().addToInventory(card.getClone());
...
/*     */       {
/* 160 */         if (index == 1) {
/* 161 */           coach.getCardInventories().updateInventoryQuantity(card.getUniqueId(), (short)-card.getQuantity());
/*     */         } else {
/*     */           try
/*     */           {
/* 165 */             coach.getCardInventories().addToInventory(card.getClone());
/*     */           } catch (ContentAlreadyPresentException e) {
...
/* 210 */         ArrayList<CoachCard> localList = new ArrayList();
...
/* 223 */         ArrayList<CoachCard> localList = new ArrayList();
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\exchange\CardTrade.class
