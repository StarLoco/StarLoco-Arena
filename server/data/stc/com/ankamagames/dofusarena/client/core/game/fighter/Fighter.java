...
/*  126 */   public static final String[] FIELDS = {
/*  127 */     "name", 
/*  128 */     "breedId", 
/*  129 */     "sex", 
/*  130 */     "skinIndex", 
...
/*      */ 
/*      */ 
/*  182 */   private static final HashMap<FighterCharacteristicType, String[]> CHARACTERISTIC_FILEDS_CORRELATION = new HashMap();
/*      */   
/*  184 */   static { CHARACTERISTIC_FILEDS_CORRELATION.put(FighterCharacteristicType.HP, new String[] { "healthPoints" });
...
/*      */   
/*  207 */   private static final String[] UPDATED_FILEDS_WITH_CARRING_STATE = { "spells", "usableFighterCards", "coachSpells" };
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  228 */   protected final ArrayList<Fighter> m_childs = new ArrayList();
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  238 */   private boolean m_actived = false;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*  256 */     this.m_spellInventory = new StackInventory((short)6, SpellManager.getInstance(), new SpellInventoryChecker(this), true, false, false);
/*  257 */     this.m_spellInventory.addObserver(this);
/*  258 */     this.m_equipmentInventory = new ArrayInventory(FighterCardManager.getInstance(), new FighterCardInventoryChecker(this), (short)6, false);
/*  259 */     this.m_equipmentInventory.addObserver(this);
...
/*      */   {
/*  380 */     this.m_look = (getBaseGfx() + "_" + String.valueOf(lookId));
/*  381 */     updateActorGfx();
/*      */   }
/*      */   
/*      */ 
...
/*      */     }
/*      */     
/*      */     CloseCombatValidity castValidity;
...
/*  621 */         return "";
/*      */       }
/*  623 */       castValidity = fight.getCloseCombatValidity(this, null);
...
/*  633 */         return "";
/*      */       }
/*  635 */       if (fight.getCloseCombatValidity(this, null) == CloseCombatValidity.OK) return Boolean.valueOf(true); return Boolean.valueOf(false);
/*      */     }
/*      */     
/*  638 */     if (fieldName.equals("spells")) {
/*  639 */       ArrayList<Spell> spells = new ArrayList();
...
/*  646 */       ArrayList<FighterCard> usableFighterCards = new ArrayList();
...
/*  670 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.HP));
/*      */     }
/*  672 */     if (fieldName.equals("actionPoints")) {
/*  673 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.AP));
/*      */     }
/*  675 */     if (fieldName.equals("maxActionPoints")) {
/*  676 */       return Integer.valueOf(getCharacteristic(FighterCharacteristicType.AP).max());
/*      */     }
/*  678 */     if (fieldName.equals("movePoints")) {
/*  679 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.MP));
/*      */     }
/*  681 */     if (fieldName.equals("maxMovePoints")) {
/*  682 */       return Integer.valueOf(getCharacteristic(FighterCharacteristicType.MP).max());
/*      */     }
/*  684 */     if (fieldName.equals("initiativePoints")) {
/*  685 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.INIT));
/*      */     }
/*      */     
/*  688 */     if (fieldName.equals("resFirePercent")) {
/*  689 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.RES_FIRE_PERCENT) + getCharacteristicValue(FighterCharacteristicType.RES_IN_PERCENT));
/*      */     }
/*  691 */     if (fieldName.equals("resWaterPercent")) {
/*  692 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.RES_WATER_PERCENT) + getCharacteristicValue(FighterCharacteristicType.RES_IN_PERCENT));
/*      */     }
/*  694 */     if (fieldName.equals("resEarthPercent")) {
/*  695 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.RES_EARTH_PERCENT) + getCharacteristicValue(FighterCharacteristicType.RES_IN_PERCENT));
/*      */     }
/*  697 */     if (fieldName.equals("resWindPercent")) {
/*  698 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.RES_WIND_PERCENT) + getCharacteristicValue(FighterCharacteristicType.RES_IN_PERCENT));
/*      */     }
/*      */     
/*  701 */     if (fieldName.equals("dmgFirePercent")) {
/*  702 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.DMG_FIRE_PERCENT) + getCharacteristicValue(FighterCharacteristicType.DMG_IN_PERCENT));
/*      */     }
/*  704 */     if (fieldName.equals("dmgWaterPercent")) {
/*  705 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.DMG_WATER_PERCENT) + getCharacteristicValue(FighterCharacteristicType.DMG_IN_PERCENT));
/*      */     }
/*  707 */     if (fieldName.equals("dmgEarthPercent")) {
/*  708 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.DMG_EARTH_PERCENT) + getCharacteristicValue(FighterCharacteristicType.DMG_IN_PERCENT));
/*      */     }
/*  710 */     if (fieldName.equals("dmgWindPercent")) {
/*  711 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.DMG_WIND_PERCENT) + getCharacteristicValue(FighterCharacteristicType.DMG_IN_PERCENT));
/*      */     }
/*      */     
/*  714 */     if (fieldName.equals("rangeBonus")) {
/*  715 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.RANGE));
/*      */     }
/*  717 */     if (fieldName.equals("healBonus")) {
/*  718 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.HEAL));
/*      */     }
/*  720 */     if (fieldName.equals("criticalHitBonus")) {
/*  721 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.CRITICAL_RATE));
/*      */     }
/*  723 */     if (fieldName.equals("criticalMissMalus")) {
/*  724 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.FUMBLE_RATE));
/*      */     }
/*  726 */     if (fieldName.equals("summonsCount")) {
/*  727 */       return Integer.valueOf(getCharacteristicValue(FighterCharacteristicType.NB_SUMMONS));
/*      */     }
/*      */     
...
/*  813 */       getActor().carry(((Fighter)carriedFighter).getActor());
/*      */       
...
/*  893 */       return String.valueOf(this.m_breed.getId()) + String.valueOf(this.m_sex);
/*      */     }
/*  895 */     return "";
/*      */   }
/*      */   
...
/*  993 */       getCurrentFight().addFighterDuringFight(summoning);
/*      */     }
/*      */     
/*      */ 
/*  997 */     NetFightActorsFrame.addMobile(summoning.getActor());
...
/*      */       case CLEARED: 
/*      */       case ITEM_ADDED: 
/* 1079 */         InventoryItemModifiedEvent modifiedEvent = (InventoryItemModifiedEvent)event;
/* 1080 */         getActor().applyEquipment((FighterCard)modifiedEvent.getConcernedItem());
/* 1081 */         applyCardEffects((FighterCard)modifiedEvent.getConcernedItem());
/* 1082 */         if (!(modifiedEvent.getConcernedItem() instanceof UsableFighterCard)) break;
...
/* 1091 */         InventoryItemModifiedEvent modifiedEvent = (InventoryItemModifiedEvent)event;
/* 1092 */         getActor().unapplyEquipment((FighterCard)modifiedEvent.getConcernedItem());
/* 1093 */         unapplyCardEffects((FighterCard)modifiedEvent.getConcernedItem());
/* 1094 */         break;
/*      */       
/*      */ 
...
/*      */       case ITEM_ADDED_AT: 
/*      */       case ITEM_QUANTITY_MODIFIED: 
/* 1111 */         InventoryItemModifiedEvent modifiedEvent = (InventoryItemModifiedEvent)event;
...
/*      */   {
/* 1128 */     String[] fields = (String[])CHARACTERISTIC_FILEDS_CORRELATION.get(charac.getType());
/* 1129 */     if (fields != null) { String[] arrayOfString1;
/* 1130 */       int j = (arrayOfString1 = fields).length; for (int i = 0; i < j; i++) { String field = arrayOfString1[i];
...
/*      */   {
/* 1142 */     if (prop == null) { return;
/*      */     }
/* 1144 */     switch (prop) {
/*      */     case INVISIBLE: 
/* 1146 */       Fight fight = (Fight)getCurrentFight();
/* 1147 */       if ((fight == null) || (this.m_actor == null)) {
/* 1148 */         return;
/*      */       }
/*      */       
/* 1151 */       if (fight.isLocalCoachFighter(this)) {
/* 1152 */         if (getProperties().isActiveProperty(prop)) {
/* 1153 */           this.m_actor.setAlpha(0.4F);
/*      */         } else {
...
/* 1160 */         this.m_actor.setVisible(!getProperties().isActiveProperty(prop));
/*      */       }
/*      */       
/*      */ 
/*      */ 
...
/*      */   {
/* 1176 */     this.m_currentFight = ((AbstractFight)fight);
/* 1177 */     super.onJoinFight(this.m_currentFight);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\fighter\Fighter.class
