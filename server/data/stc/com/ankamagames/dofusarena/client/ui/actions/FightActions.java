...
/*     */   
/*     */   public static void setReadyForPlacement(com.ankamagames.xulor.event.Event event)
/*     */   {
/*  44 */     UIMessage message = new UIMessage();
/*  45 */     message.setId(18009);
/*  46 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   public static void setReadyForObservation(com.ankamagames.xulor.event.Event event)
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public static void setReadyForAction(com.ankamagames.xulor.event.Event event)
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public static void giveUpFight(com.ankamagames.xulor.event.Event event)
/*     */   {
/*  77 */     UIMessage message = new UIMessage();
/*  78 */     message.setId(18000);
/*  79 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void openCloseFighterInformations(com.ankamagames.xulor.event.Event event, Fighter fighter)
/*     */   {
/*  89 */     UIFighterMessage message = new UIFighterMessage();
/*  90 */     message.setFighter(fighter);
/*  91 */     message.setId(18012);
/*  92 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void openCloseEventCard(com.ankamagames.xulor.event.Event event, com.ankamagames.dofusarena.client.core.game.event.Event eventCard)
/*     */   {
/* 102 */     UIFightEventCardMessage message = new UIFightEventCardMessage();
/* 103 */     message.setEvent(eventCard);
/* 104 */     message.setId(18015);
/* 105 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void fighterEndsTurn(com.ankamagames.xulor.event.Event event, Fighter fighter)
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public static void fighterSetSouthEastDirection(com.ankamagames.xulor.event.Event event, Fighter fighter)
/*     */   {
/* 128 */     UIFighterMessage message = new UIFighterMessage();
/* 129 */     message.setFighter(fighter);
/* 130 */     message.setId(18002);
/* 131 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void fighterSetSouthWestDirection(com.ankamagames.xulor.event.Event event, Fighter fighter)
/*     */   {
/* 141 */     UIFighterMessage message = new UIFighterMessage();
/* 142 */     message.setFighter(fighter);
/* 143 */     message.setId(18003);
/* 144 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void fighterSetNorthWestDirection(com.ankamagames.xulor.event.Event event, Fighter fighter)
/*     */   {
/* 154 */     UIFighterMessage message = new UIFighterMessage();
/* 155 */     message.setFighter(fighter);
/* 156 */     message.setId(18004);
/* 157 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void fighterSetNorthEastDirection(com.ankamagames.xulor.event.Event event, Fighter fighter)
/*     */   {
/* 167 */     UIFighterMessage message = new UIFighterMessage();
/* 168 */     message.setFighter(fighter);
/* 169 */     message.setId(18005);
/* 170 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     } else {
/* 187 */       openCloseSpellInfos(event, spell);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 203 */       Worker.getInstance().pushMessage(message);
/*     */     } else {
/* 205 */       openCloseFighterCardInfos(event, fighterCard);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void fighterSelectCloseCombat(com.ankamagames.xulor.event.Event event, Fighter fighter)
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public static void openCloseSpellInfos(com.ankamagames.xulor.event.Event event, Spell spell)
/*     */   {
/* 228 */     UIFighterSpellMessage message = new UIFighterSpellMessage();
/* 229 */     message.setSpell(spell);
/* 230 */     message.setId(18013);
/* 231 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public static void openCloseFighterCardInfos(com.ankamagames.xulor.event.Event event, FighterCard fighterCard)
/*     */   {
/* 241 */     UIFighterCardMessage message = new UIFighterCardMessage();
/* 242 */     message.setFighterCard(fighterCard);
/* 243 */     message.setId(18014);
/* 244 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 258 */       Worker.getInstance().pushMessage(message);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 284 */       Worker.getInstance().pushMessage(message);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 310 */       Worker.getInstance().pushMessage(message);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 322 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 335 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 347 */     Worker.getInstance().pushMessage(message);
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\ui\actions\FightActions.class
