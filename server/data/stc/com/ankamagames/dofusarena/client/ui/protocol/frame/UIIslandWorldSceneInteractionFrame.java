...
/*     */     {
/*     */     case 30000: 
/*  73 */       UIWorldSceneMouseReleasedMessage msg = (UIWorldSceneMouseReleasedMessage)message;
/*     */       
...
/*     */           
/*     */ 
/*  88 */           PathFindResult pathResult = WorldSceneInteractionUtils.getPathSolutionFromMouseCoordinates(DofusArenaClientInstance.getInstance().getWorldScene(), localCoach, msg.getMouseX(), 
...
/*  96 */             DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */             
...
/*     */         {
/* 110 */           final Mobile mobile = (Mobile)hitMobiles.get(0);
/*     */           
/*     */ 
...
/* 129 */                   popupMenu.addButton(DofusArenaTranslator.getInstance().getString("chat.addToFriendList", new Object[0]), null, new MouseClickListener() {
...
/* 133 */                       DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */                     }
/* 135 */                   }, true);
/*     */                 } else {
/* 137 */                   popupMenu.addButton(DofusArenaTranslator.getInstance().getString("chat.removeFromFriendList", new Object[0]), null, new MouseClickListener() {
/*     */                     public void run(MouseClickEvent event) {
/* 139 */                       RemoveFriendMessage netMessage = new RemoveFriendMessage();
/* 140 */                       netMessage.setFriendName(coach.getName());
/* 141 */                       DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */                     }
/* 143 */                   }, true);
/*     */                 }
/*     */               }
...
/* 151 */                   popupMenu.addButton(DofusArenaTranslator.getInstance().getString("chat.addToIgnoreList", new Object[0]), null, new MouseClickListener() {
/*     */                     public void run(MouseClickEvent event) {
/* 153 */                       AddIgnoreMessage netMessage = new AddIgnoreMessage();
/* 154 */                       netMessage.setIgnoreName(coach.getName());
/* 155 */                       DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */                     }
/* 157 */                   }, true);
/*     */                 } else {
/* 159 */                   popupMenu.addButton(DofusArenaTranslator.getInstance().getString("chat.removeFromIgnoreList", new Object[0]), null, new MouseClickListener() {
/*     */                     public void run(MouseClickEvent event) {
/* 161 */                       RemoveIgnoreMessage netMessage = new RemoveIgnoreMessage();
/* 162 */                       netMessage.setIgnoreName(coach.getName());
/* 163 */                       DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */                     }
/* 165 */                   }, true);
/*     */                 }
/*     */               }
...
/* 171 */               popupMenu.addButton(DofusArenaTranslator.getInstance().getString("fightInvitation.training", new Object[0]), null, new MouseClickListener() {
/*     */                 public void run(MouseClickEvent event) {
...
/* 176 */                   DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */                 }
/* 178 */               }, true);
/*     */               
/*     */ 
/* 181 */               popupMenu.addButton(DofusArenaTranslator.getInstance().getString("fightInvitation.trainingWithBet", new Object[0]), null, new MouseClickListener() {
/*     */                 public void run(MouseClickEvent event) {
...
/* 187 */                   DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */                 }
/* 189 */               }, true);
/*     */               
/*     */ 
/* 192 */               popupMenu.addSeparator();
/* 193 */               popupMenu.addButton(DofusArenaTranslator.getInstance().getString("exchange.invitation", new Object[0]), null, new MouseClickListener() {
/*     */                 public void run(MouseClickEvent event) {
...
/* 197 */                   DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
/*     */                 }
/* 199 */               }, true);
/*     */             }
/*     */             
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\ui\protocol\frame\UIIslandWorldSceneInteractionFrame.class
