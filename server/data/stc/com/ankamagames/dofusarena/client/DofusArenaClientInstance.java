...
/*     */     
/*     */ 
/* 103 */     setNetworkEntityFactory(new ObjectFactory()
/*     */     {
/*     */       public NetworkEntity makeObject() {
/* 106 */         return new DofusArenaNetworkEntity(DofusArenaGameEntity.getInstance());
/*     */       }
/* 108 */     });
/* 109 */     setClientMessageDecoder(new DofusArenaMessageDecoder());
/* 110 */     setNetworkEventHandler(new DofusArenaNetworkEventsHandler());
/*     */     
/*     */ 
...
/*     */   {
/* 148 */     setGamePreferences(new DofusArenaGamePreferences(preferenceStore));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 217 */       getGameFrame().getGlInitializer().getRenderer().pushKeyboardController(shortcutManager, false);
/*     */     } catch (Exception e) {
...
/* 225 */     LuaManager.getInstance().addDefaultLibraries(new JavaFunctionsLibrary[0]);
/*     */     
/*     */ 
...
/*     */   {
/* 245 */     registerContentInitializer(ConsoleLoader.getInstance());
/* 246 */     registerContentInitializer(ChatInitializer.getInstance());
/*     */     
/* 248 */     registerContentInitializer(SpellLoader.getInstance());
/* 249 */     registerContentInitializer(EventLoader.getInstance());
/* 250 */     registerContentInitializer(StaticEffectLoader.getInstance());
/* 251 */     registerContentInitializer(SummoningLoader.getInstance());
/* 252 */     registerContentInitializer(CardLoader.getInstance());
/* 253 */     registerContentInitializer(FightDefinitionLoader.getInstance());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   public void start()
/*     */   {
/* 272 */     DofusArenaGameEntity.getInstance().pushFrame(UIAuthentificationFrame.getInstance());
/*     */     
/*     */ 
...
/* 282 */       ProxyGroup.extractProxyGroupsFromProperties(DofusArenaConfiguration.getInstance(), "proxyGroup", "proxyAddresses").toArray());
/*     */     
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected void initXulor()
/*     */     throws Exception
/*     */   {
/* 361 */     super.initXulor();
/*     */     
/*     */ 
/* 364 */     Xulor.getInstance().setBinding(FengguiBinding.getInstance());
/*     */     
/*     */ 
/* 367 */     Xulor.getInstance().setShortcutManager(ShortcutManager.getInstance());
/*     */     
/*     */ 
/* 370 */     Xulor.getInstance().setTranslator(DofusArenaTranslator.getInstance());
/*     */     
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected XulorScene createXulorScene()
/*     */     throws Exception
/*     */   {
...
/*     */ 
/*     */ 
/*     */   protected void initXulorScene(XulorScene xulorScene)
/*     */     throws Exception
/*     */   {}
/*     */   
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected GameWorldScene createWorldScene()
/*     */     throws Exception
/*     */   {
/* 419 */     return new DofusArenaWorldScene(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   protected void initWorldScene(AleaWorldScene worldScene)
/*     */     throws Exception
/*     */   {
...
/* 434 */     getGameFrame().getGlInitializer().getRenderer().addRendererEventsHandler(engineConfig);
/*     */     try
/*     */     {
/* 437 */       WorldElementManager.getInstance().setCustomElementFactory(DofusArenaCustomElementFactory.getInstance());
...
/* 443 */       accessor.setCustomElementHandler(DofusArenaCustomElementProcessor.getInstance());
/* 444 */       WorldManager.getInstance().setDocumentAccessor(accessor);
...
/* 452 */       m_logger.error("Erreur à l'initialisation de la worldScene", e);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 526 */     Xulor.getInstance().msgBox(DofusArenaTranslator.getInstance().getString("error.loading", new Object[0]) + contentLoader.getName(), 66);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 550 */     JOptionPane.showMessageDialog(getGameFrame(), text, "Error", 0);
/* 551 */     super.onInitialisationError(obj, message);
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\DofusArenaClientInstance.class
