...
/*     */   {
/*  44 */     int TEAM_COUNT = 2;
/*  45 */     this.m_teamStartPoints = new ArrayList(2);
/*  46 */     for (int i = 0; i < 2; i++) {
/*  47 */       this.m_teamStartPoints.add(new ElementSelection(getLayerName(i), com.ankamagames.dofusarena.client.DofusArenaClientConstants.TEAM_COLOR[i], TEXTURE));
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*  69 */       int j = (arrayOfObject1 = objectMaps).length; for (int i = 0; i < j; i++) { Object map = arrayOfObject1[i];
...
/*     */   {
/* 165 */     if (cells != null) { int i;
/* 166 */       for (Iterator localIterator = this.m_teamStartPoints.iterator(); localIterator.hasNext(); 
/*     */           
/* 168 */           i < cells.length)
/*     */       {
/* 166 */         ElementSelection teamStartPointDisplayer = (ElementSelection)localIterator.next();
/*     */         
/* 168 */         i = 0; continue;
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\alea\highlightingCells\StartPointManager.class
