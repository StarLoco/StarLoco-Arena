...
/*    */   {
/* 32 */     if (args.size() == 3) {
/* 33 */       String fileName = (String)args.get(2);
/* 34 */       if (fileName != null) {
/*    */         try {
/* 36 */           String scriptPath = DofusArenaConfiguration.getInstance().getString("scriptPath");
/* 37 */           int id = LuaManager.getInstance().runScript(scriptPath + fileName + ".lua");
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\console\command\debug\script\RunCommand\class.class
