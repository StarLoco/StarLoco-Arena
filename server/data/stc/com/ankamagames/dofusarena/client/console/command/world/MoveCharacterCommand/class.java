...
/*    */     
/* 61 */     short altitude = worldCell.getArrivalAltitude(localCoach, from.getZ(), direction, defaultParameters);
/* 62 */     if (altitude == Integer.MIN_VALUE) {
/* 63 */       return;
/*    */     }
/* 65 */     boolean valid = worldCell.getMovementAcrossValidity(localCoach, (short)(int)localCoach.getAltitude(), localCoach.getDirection(), altitude, direction, defaultParameters);
/* 66 */     if (valid) {
...
/* 71 */       DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage(netMessage);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\console\command\world\MoveCharacterCommand\class.class
