...
/*    */ import com.ankamagames.xulor.core.renderer.XStringCondition;
...
/* 37 */     registerTag("Data", com.ankamagames.xulor.core.impl.XData.class);
/* 38 */     registerTag("Item", XItem.class);
/* 39 */     registerTag("ItemCondition", XItemCondition.class);
/* 40 */     registerTag("ListCondition", com.ankamagames.xulor.core.renderer.XListCondition.class);
/* 41 */     registerTag("And", XAndCondition.class);
/* 42 */     registerTag("Or", com.ankamagames.xulor.core.renderer.XOrCondition.class);
/* 43 */     registerTag("Not", XNotCondition.class);
/* 44 */     registerTag("Condition", XConditionResult.class);
/* 45 */     registerTag("isEqual", com.ankamagames.xulor.core.renderer.XEqualCondition.class);
/* 46 */     registerTag("isGreater", XGreaterCondition.class);
/* 47 */     registerTag("isLess", XLessCondition.class);
/* 48 */     registerTag("isNull", com.ankamagames.xulor.core.renderer.XNullCondition.class);
...
/* 54 */     registerTag("ToolTip", com.ankamagames.xulor.core.impl.XToolTip.class);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\XulorTagLibrary.class
