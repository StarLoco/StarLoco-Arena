...
/*     */   
/*  26 */   protected Map<String, Factory> m_tags = new HashMap();
/*     */   
/*     */ 
/*     */ 
/*     */   public TagLibrary()
...
/*     */   {
/*  77 */     return (Factory)this.m_tags.get(name.toLowerCase());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*  85 */     Iterator it = this.m_tags.values().iterator();
/*  86 */     while ((it != null) && (it.hasNext())) {
/*  87 */       Factory f = (Factory)it.next();
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\TagLibrary.class
