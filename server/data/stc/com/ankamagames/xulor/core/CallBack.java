...
/*  59 */     String[] arrayOfString1; int j = (arrayOfString1 = this.m_funcs).length; for (int i = 0; i < j; i++) { String func = arrayOfString1[i];
/*  60 */       Matcher matcher = m_funcPattern.matcher(func);
/*  61 */       if (matcher.matches())
/*     */       {
/*     */ 
/*  64 */         String packageName = matcher.group(2);
/*  65 */         String methodName = matcher.group(3);
/*  66 */         String parametersString = matcher.group(5);
/*     */         String[] parameters;
/*  68 */         String[] parameters; if (parametersString != null) {
...
/*     */   {
/*  90 */     List<Class> parameterTypes = new ArrayList();
...
/*  98 */       Method[] methods = actionClass.getMethods();
/*  99 */       Method[] arrayOfMethod1; int j = (arrayOfMethod1 = methods).length; for (int i = 0; i < j; i++) { Method method = arrayOfMethod1[i];
...
/* 104 */             for (int i = 0; i < methodParameterTypes.length; i++) {
/* 105 */               isValid = methodParameterTypes[i].isAssignableFrom((Class)parameterTypes.get(i));
/* 106 */               if (!isValid) {
/*     */                 break;
/*     */               }
/*     */             }
...
/*     */         }
/*     */       }
/* 122 */       m_logger.error("La méthode '" + (packageName != null ? packageName + ":" : "") + methodName + "(" + typeArrayToString(parameterTypes) + ")' est inconnue !");
/*     */     }
/* 124 */     return null;
/*     */   }
/*     */   
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\CallBack.class
