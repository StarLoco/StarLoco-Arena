...
/*     */   
/*  29 */   protected boolean m_static = true;
/*     */   
/*  31 */   protected ElementMap m_elementMap = null;
/*     */   
/*  33 */   protected IElement m_parent = null;
/*  34 */   protected Vector<IElement> m_children = new Vector();
/*  35 */   protected IItemRenderable m_renderableParent = null;
/*  36 */   protected ArrayList<Property> m_properties = new ArrayList();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  94 */     if (!this.m_static) {
/*  95 */       storePreferences();
/*  96 */       Xulor.getInstance().getPreferenceStore().removePreferencePropertyChangedListener(this);
/*     */     }
/*     */     
...
/* 191 */       return (IElement[])this.m_children.toArray(new IElement[this.m_children.size()]);
/*     */     }
/* 193 */     return new XElement[0];
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 244 */     int j = (arrayOfIElement = getChildren()).length; for (int i = 0; i < j; i++) { IElement elem = arrayOfIElement[i];
/* 245 */       if ((elem instanceof IComponent)) {
...
/*     */   {
/* 307 */     IElement[] components = getChildren();
/* 308 */     IElement[] arrayOfIElement1; int j = (arrayOfIElement1 = components).length; for (int i = 0; i < j; i++) { IElement c = arrayOfIElement1[i];
...
/* 317 */     element.setElementMap(this.m_elementMap);
/* 318 */     IElement[] arrayOfIElement; int j = (arrayOfIElement = getChildren()).length; for (int i = 0; i < j; i++) { IElement child = arrayOfIElement[i];
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\impl\XElement.class
