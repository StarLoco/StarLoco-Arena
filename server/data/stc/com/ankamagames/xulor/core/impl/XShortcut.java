...
/*  29 */   private boolean m_alreadyBuilt = false;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/*  52 */     if ((!this.m_alreadyBuilt) && (this.m_parent != null) && ((this.m_parent instanceof IListenerManager))) {
/*  53 */       if (Xulor.getInstance().getShortcutManager() != null) {
/*  54 */         Xulor.getInstance().getShortcutManager().setShortcutTrigger(this.m_shortcut, new ActionListener((IObservable)this.m_parent, this.m_action));
/*     */       } else {
...
/*  87 */     super.copyElementData(shortcut);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\impl\XShortcut.class
