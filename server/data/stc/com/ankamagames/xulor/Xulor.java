...
/*      */   
/*  117 */   private static final Binding DEFAULT_BINDING = FengguiBinding.getInstance();
/*      */   
...
/*      */ 
/*      */ 
/*  124 */   private final ArrayList<XulorLoadUnload> m_loadUnloadDocuments = new ArrayList();
/*  125 */   private final ArrayList<XulorUnload> m_timedUnloadDocuments = new ArrayList();
/*      */   
/*      */ 
/*      */ 
/*      */ 
/*  130 */   private final ArrayList<IElement> m_elementsNeedingLayout = new ArrayList();
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  145 */   private final HashMap<String, IElement> m_loadedElements = new HashMap();
/*      */   
/*      */ 
/*      */ 
/*      */ 
/*  150 */   private final ArrayList<String> m_loadedModals = new ArrayList();
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  203 */   private boolean m_needToRebuildUI = false;
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */   public Xulor()
/*      */   {
/*  227 */     this.m_actionClasses = new HashMap();
...
/*      */ 
/*      */ 
/*      */   public void loadTheme(URI uri, URI directory)
/*      */     throws Exception
/*      */   {
...
/*      */   {
/*  535 */     IElement element = (IElement)this.m_loadedElements.get(id);
...
/*      */   {
/*  545 */     IElement element = (IElement)this.m_loadedElements.get(id);
...
/*      */   {
/*  597 */     return load(id, resource, Integer.MAX_VALUE, options, modalLevel);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  632 */     return loadInto(null, resource, container, elementMap, null, Integer.MAX_VALUE, options, modalLevel);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */         }
/*      */         
/*  746 */         if ((options & 0x8) != 8L)
/*      */         {
/*  748 */           this.m_needToRebuildUI = true;
/*      */         }
/*      */         
/*  751 */         if ((options & 0x100) == 256L)
/*      */         {
/*  753 */           newElement.setStatic(false);
/*  754 */           newElement.loadPreferences();
/*  755 */           this.m_preferenceStore.addPreferencePropertyChangedListener(newElement);
/*      */         }
/*      */       }
/*      */     }
/*      */     
...
/*  783 */       IElement element = (IElement)this.m_loadedElements.remove(id);
/*  784 */       if (element != null) {
...
/*  811 */       ModalManager.getInstance().removeElement((IElement)this.m_loadedElements.get(id));
/*      */     }
...
/*      */           
/*  878 */           this.m_loadUnloadDocuments.add(new XulorInsert(messageBox, this.m_msgBoxRootContainer, id, loadOptions));
/*      */         }
/*      */         
...
/*      */           
/*      */ 
/*  919 */           this.m_msgBoxRootContainer.add(popupMenu);
/*      */           
/*      */ 
...
/*      */ 
/*      */ 
/*      */   private IElement insert(URL url, IElement container)
/*      */     throws Exception
/*      */   {
...
/* 1211 */     IElement element = (IElement)this.m_loadedElements.get(id);
...
/* 1231 */       size = this.m_timedUnloadDocuments.size();
/* 1232 */       for (int i = 0; i < size; i++) {
/* 1233 */         XulorUnload unload = (XulorUnload)this.m_timedUnloadDocuments.get(i);
...
/* 1241 */         XulorLoadUnload loadUnload = (XulorLoadUnload)this.m_loadUnloadDocuments.remove(0);
/* 1242 */         if ((loadUnload instanceof XulorUnload)) {
/* 1243 */           XulorUnload unload = (XulorUnload)loadUnload;
/* 1244 */           if (unload.isAll()) {
/* 1245 */             unloadAllId();
/*      */           } else {
/* 1247 */             unloadId(unload.getId());
/*      */           }
/* 1249 */         } else if ((loadUnload instanceof XulorLoad)) {
...
/*      */           }
/* 1254 */           loadInto(doc.getId(), doc.getDocumentUrl(), doc.getParent(), doc.getElementMap(), doc.getCurrentDirectory(), doc.getOptions(), doc.getLevel());
/* 1255 */         } else if ((loadUnload instanceof XulorInsert)) {
/* 1256 */           XulorInsert doc = (XulorInsert)loadUnload;
/* 1257 */           doc.m_parent.add(doc.m_element);
/* 1258 */           if ((doc.m_options & 0x40) == 64L) {
/* 1259 */             ModalManager.getInstance().addModalElement(doc.m_element);
/* 1260 */             this.m_loadedModals.add(doc.m_id);
/*      */           }
/* 1262 */           if ((doc.m_options & 0x80) == 128L) {
/* 1263 */             ModalManager.getInstance().addPseudoModalElement(doc.m_element);
/* 1264 */             this.m_loadedModals.add(doc.m_id);
/*      */           }
/* 1266 */           this.m_loadedElements.put(doc.m_id, doc.m_element);
/* 1267 */         } else if ((loadUnload instanceof XulorLoadMouseImage)) {
...
/* 1273 */           MouseImageManager.getInstance().show();
/* 1274 */         } else if ((loadUnload instanceof XulorUnloadMouseImage)) {
...
/* 1334 */     ArrayList<String> elementIds = new ArrayList();
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\Xulor.class
