...
/* 47 */       m_logger.error("actionTrigger est nul.");
/* 48 */       return; }
/* 49 */     if ((this.m_actionTrigger.equalsIgnoreCase("click")) && (this.m_element.isEnabled())) {
/* 50 */       MouseClickEvent event = new MouseClickEvent(this.m_element, 0, 0, 1, MouseButtons.BUTTON1);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\event\listener\ActionListener.class
