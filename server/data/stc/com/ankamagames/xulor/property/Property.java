...
/*  31 */   private final ArrayList<PropertyClient> m_clients = new ArrayList();
/*     */   
/*  33 */   private ConcurrentLinkedQueue<AsynchronousPropertyChange> m_asynchronousPropertyChanges = new ConcurrentLinkedQueue();
/*  34 */   private ArrayList<PropertyClient> m_modifiedClients = new ArrayList();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 176 */     AsynchronousPropertyChange change = (AsynchronousPropertyChange)this.m_asynchronousPropertyChanges.poll();
...
/*     */         }
/*     */       }
/* 194 */       change = (AsynchronousPropertyChange)this.m_asynchronousPropertyChanges.poll();
/*     */     }
...
/* 248 */       ArrayList<PropertyClient> toRemove = new ArrayList();
...
/* 384 */           setToCastValue(client, fieldValue);
/*     */         } else {
...
/* 443 */         this.m_clients.toArray(clients);
/* 444 */         PropertyClient[] arrayOfPropertyClient1; int j = (arrayOfPropertyClient1 = clients).length; for (int i = 0; i < j; i++) { PropertyClient client = arrayOfPropertyClient1[i];
...
/* 458 */       for (Iterator localIterator = this.m_clients.iterator(); localIterator.hasNext();) { client = (PropertyClient)localIterator.next();
...
/*     */       
/* 530 */       String[] fields = fieldProvider.getFields();
/* 531 */       String[] arrayOfString1; int j = (arrayOfString1 = fields).length; for (int i = 0; i < j; i++) { String field = arrayOfString1[i];
/* 532 */         if (field != null)
/*     */         {
/*     */ 
...
/* 545 */             for (int i = this.m_clients.size() - 1; i >= 0; i--) {
/* 546 */               PropertyClient client = (PropertyClient)this.m_clients.get(i);
...
/*     */     
/* 587 */     synchronized (this.m_clients) { PropertyClient propertyClient;
/* 588 */       if (this.m_clients.size() != 0) {
/* 589 */         propertyClient = (PropertyClient)this.m_clients.get(this.m_clients.size() - 1);
/*     */       } else {
/*     */         return;
/*     */       }
/*     */     }
...
/* 606 */           PropertyClient pc = (PropertyClient)this.m_clients.get(i);
...
/*     */ 
/*     */ 
/* 645 */   public String toString() { return "Property name=" + this.m_name + " value=" + this.m_value; }
/*     */   
/*     */   public static enum PropertySetMethod {
/* 648 */     SET,  APPEND,  PREPEND;
/*     */   }
/*     */   
...
/*     */     
/* 656 */     public AsynchronousPropertyChange(PropertyClient client, Object value, Property.PropertySetMethod method) { this.m_client = client;
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\property\Property.class
