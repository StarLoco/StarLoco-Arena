...
/*  31 */   private boolean m_multiline = false;
/*  32 */   private boolean m_password = false;
...
/*  38 */   private boolean m_maxCharactersInit = false;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/*  46 */     System.out.println("<texteditor text=\"" + this.m_text + "\" multiline=\"" + this.m_multiline + "\" password=\"" + this.m_password + "\">");
...
/*     */       }
/*  71 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_textEditor, this);
/*     */     }
...
/*     */   {
/* 217 */     if (f) {
/* 218 */       FocusManager.getInstance().gainFocus(this);
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 236 */     this.m_text = (text + this.m_text);
...
/* 313 */     XComponent.applyThemeAttributes(textEditor, element.getAttributes());
/* 314 */     XSpacingAppearance.setAppearance(textEditor, element);
/* 315 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 316 */     for (ThemeAppearance app : appearances) {
/* 317 */       if (app != null) {
/* 318 */         XDecoratorAppearance.setAppearance(textEditor, app);
/* 319 */         if ((app instanceof ThemeTextEditorAppearance)) {
/* 320 */           XTextEditorAppearance.setAppearance(textEditor, (ThemeTextEditorAppearance)app);
/*     */         }
/*     */       }
/*     */     }
/* 324 */     XObservableComponent.setAppearance(textEditor);
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XTextEditor.class
