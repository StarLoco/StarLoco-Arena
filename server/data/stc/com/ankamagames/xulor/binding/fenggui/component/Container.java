...
/*     */   extends org.fenggui.Container
/*     */   implements NonBlocking
/*     */ {
/*  48 */   private com.ankamagames.xulor.util.Dimension wishedSize = null;
/*  49 */   private boolean m_visible = true;
/*  50 */   private boolean m_nonBlocking = true;
/*  51 */   private ArrayList<IWidget> m_notUsedInLayout = new ArrayList();
/*  52 */   private boolean m_enabled = true;
/*     */   
/*  54 */   private ArrayList<IActivationListener> activationHook = new ArrayList(0);
/*  55 */   private ArrayList<IMouseEnteredListener> mouseEnteredHook = new ArrayList(0);
/*  56 */   private ArrayList<IMouseMovedListener> mouseMovedHook = new ArrayList(0);
/*  57 */   private ArrayList<IMouseExitedListener> mouseExitedHook = new ArrayList(0);
/*  58 */   private ArrayList<IMousePressedListener> mousePressedHook = new ArrayList(0);
/*  59 */   private ArrayList<IMouseReleasedListener> mouseReleasedHook = new ArrayList(0);
/*  60 */   private ArrayList<IFocusListener> focusGainedHook = new ArrayList(0);
/*  61 */   private ArrayList<IMouseDraggedListener> mouseDraggedHook = new ArrayList(0);
/*  62 */   private ArrayList<IMouseWheelListener> mouseWheeledHook = new ArrayList(0);
/*  63 */   private ArrayList<IKeyPressedListener> keyPressedHook = new ArrayList(0);
/*  64 */   private ArrayList<IKeyReleasedListener> keyReleasedHook = new ArrayList(0);
/*     */   
/*     */   public Container()
/*     */   {
...
/*     */     extends org.fenggui.Container.ContainerAppearance
/*     */   {
...
/*     */         {
/*  94 */           IWidget c = (IWidget)notifyList.get(i);
...
/*     */             {
/* 102 */               if (!(this.container.getParent() instanceof ScrollContainer))
/*     */               {
...
/* 168 */     IWidget found = this.m_nonBlocking ? null : this;
/*     */     
...
/*     */ 
/*     */ 
/*     */   public com.ankamagames.xulor.util.Dimension getWishedSize()
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public void setWishedSize(com.ankamagames.xulor.util.Dimension wishedSize)
/*     */   {
...
/* 233 */     org.fenggui.util.Dimension min = getAppearance().getMinSizeHint();
...
/*     */     
/* 255 */     ActivationEvent e = new ActivationEvent(this, enabled);
/*     */     
...
/*     */   {
/* 408 */     if ((this.mouseMovedHook.isEmpty()) || (!this.m_enabled)) { return;
/*     */     }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\Container.class
