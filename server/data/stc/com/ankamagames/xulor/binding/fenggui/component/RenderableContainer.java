...
/*     */   
/*  43 */   private ArrayList<ItemRenderer> m_renderers = new ArrayList();
/*     */   
...
/*     */   
/*  53 */   private boolean m_itemNeedToBeApplied = false;
/*     */   
/*  55 */   private DragNDropListener m_dragNDropListener = null;
/*     */   
/*  57 */   private final ArrayList<ItemOutListener> m_itemOutListeners = new ArrayList();
/*     */   
/*  59 */   private final ArrayList<ItemOverListener> m_itemOverListeners = new ArrayList();
/*     */   
/*  61 */   private boolean m_needRendering = true;
/*     */   
...
/*     */   {
/*  79 */     this.m_children = new ArrayList();
/*  80 */     this.m_collection = collection;
/*     */     
/*  82 */     setLayoutManager(new RowLayout(true));
/*     */     
...
/* 177 */     mouseEntered(new MouseEnteredEvent(this, this));
/*     */   }
/*     */   
/*     */   public void fireMouseExited() {
/* 181 */     mouseExited(new MouseExitedEvent(this, this));
/*     */   }
/*     */   
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\RenderableContainer.class
