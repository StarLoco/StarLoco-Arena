...
/*  42 */   private boolean m_show = false;
/*  43 */   private IEventListener m_currentHideListener = null;
/*  44 */   private ArrayList<IMenuClosedListener> m_mcl = new ArrayList();
/*  45 */   private Alignment m_hotSpotPosition = Alignment.NORTH_WEST;
/*     */   private int m_wishedX;
/*     */   private int m_wishedY;
/*     */   
/*     */   public PopupMenu() {
/*  50 */     this.m_appearance = new PopupMenuAppearance(this);
/*  51 */     this.m_widgets = new ArrayList();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 144 */       this.m_widgets.remove(toRemove);
/* 145 */       toRemove.removedFromWidgetTree();
/*     */     }
/*     */   }
/*     */   
...
/* 158 */         if (((e instanceof MouseReleasedEvent)) || ((e instanceof ButtonPressedEvent))) {
...
/*     */     
/* 253 */     while ((w != null) && (!w.isTraversable())) { w = getNextWidget(w);
/*     */     }
/* 255 */     return w;
/*     */   }
/*     */   
...
/*     */     
/* 268 */     while ((w != null) && (!w.isTraversable())) { w = getPreviousWidget(w);
/*     */     }
/* 270 */     return w;
/*     */   }
/*     */   
...
/*     */     {
/* 357 */       int minWidth = 0;int minHeight = 0;
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\PopupMenu.class
