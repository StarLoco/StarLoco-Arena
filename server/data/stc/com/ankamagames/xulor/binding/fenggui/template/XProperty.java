...
/*     */   
/*  29 */   private boolean m_local = false;
/*  30 */   private boolean m_localInit = false;
/*  31 */   private String m_name = null;
/*  32 */   private String m_attribute = null;
/*  33 */   private String m_field = null;
/*  34 */   private boolean m_layoutOnChange = false;
...
/*     */ 
/*     */ 
/*  88 */       if (this.m_forms != null) { Form[] arrayOfForm;
/*  89 */         int j = (arrayOfForm = this.m_forms).length; for (int i = 0; i < j; i++) { Form form = arrayOfForm[i];
/*  90 */           form.addProperty(this.m_property);
/*     */         }
...
/* 212 */     copyElementData(fp);
/* 213 */     return fp;
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XProperty.class
