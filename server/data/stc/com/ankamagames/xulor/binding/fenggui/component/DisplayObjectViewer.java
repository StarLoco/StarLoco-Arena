...
/*     */     
/*  42 */     public void setup(GL gl) { gl.glBlendFunc(770, 771);
/*  43 */       gl.glEnable(3042);
/*     */     }
/*     */   }
/*     */   
...
/*     */   
/*  55 */   private boolean m_linkageChanged = false;
/*  56 */   private boolean m_descriptorLibraryChanged = false;
/*     */   
...
/*  77 */           addChild(DisplayObjectViewer.this.m_displayObject.getMesh());
/*     */         }
/*     */         
/*     */ 
/*     */ 
...
/* 114 */             DescriptorLibraryManager.getInstance().tagResourceInUse(DisplayObjectViewer.this.m_descriptorLibrary.getParent());
/*     */           }
...
/* 137 */               DisplayObjectViewer.this.m_displayObject = descriptor.createInstance(DisplayObjectViewer.this.m_descriptorLibrary);
/*     */               
/*     */ 
...
/*     */               
/*     */ 
/* 146 */               AnimationManager.getInstance().addAnimatedObject(this, DisplayObjectViewer.this.m_displayObject);
/*     */             } else {
...
/* 171 */     scene.setCamera(new Ortho2DScrollCamera());
/*     */     
/*     */ 
/* 174 */     scene.setPreRenderStates(new ScenePreRenderStates(null));
/* 175 */     scene.setPostRenderStates(new ScenePostRenderStates(null));
/*     */     
/*     */ 
/* 178 */     setScene(scene);
/*     */     
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\DisplayObjectViewer.class
