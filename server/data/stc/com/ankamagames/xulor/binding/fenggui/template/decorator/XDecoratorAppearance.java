...
/*  42 */   private ArrayList<IDecorator> m_decorators = new ArrayList();
/*     */   
...
/*  88 */     elem.m_decorators = ((ArrayList)elem.m_decorators.clone());
...
/* 104 */             theme.add(((XBorder)decorator).toThemeBorder());
/* 105 */           } else if ((decorator instanceof XBackground)) {
/* 106 */             theme.add(((XBackground)decorator).toThemeBackground());
/*     */           }
/*     */         }
/*     */       }
/*     */     }
...
/* 120 */           app.add(theme.getState(), background);
/*     */         }
/* 122 */       } else if ((element instanceof ThemeBorder)) {
...
/* 134 */       return XGradientBackground.getGradientBackground((ThemeGradientBackground)theme);
/* 135 */     if ((theme instanceof ThemePlainBackground))
/* 136 */       return XPlainBackground.getPlainBackground((ThemePlainBackground)theme);
/* 137 */     if ((theme instanceof ThemePixmapBackground)) {
/* 138 */       return XPixmapBackground.getPixmapBackground((ThemePixmapBackground)theme);
/*     */     }
/* 140 */     return null;
/*     */   }
/*     */   
...
/* 145 */       return XBevelBorder.getBevelBorder((ThemeBevelBorder)theme);
/* 146 */     if ((theme instanceof ThemePixmapBorder))
/* 147 */       return XPixmapBorder.getPixmapBorder((ThemePixmapBorder)theme);
/* 148 */     if ((theme instanceof ThemePixmapBorder16))
/* 149 */       return XPixmapBorder16.getPixmapBorder16((ThemePixmapBorder16)theme);
/* 150 */     if ((theme instanceof ThemePlainBorder))
/* 151 */       return XPlainBorder.getPlainBorder((ThemePlainBorder)theme);
/* 152 */     if ((theme instanceof ThemeRoundedBorder))
/* 153 */       return XRoundedBorder.getRoundedBorder((ThemeRoundedBorder)theme);
/* 154 */     if ((theme instanceof ThemeTitledBorder)) {
/* 155 */       return XTitledBorder.getTitledBorder((ThemeTitledBorder)theme);
/*     */     }
/* 157 */     return null;
/*     */   }
/*     */   
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\decorator\XDecoratorAppearance.class
