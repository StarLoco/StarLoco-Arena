...
/*     */   {
/*  46 */     System.out.println("<displayObjectPreview>");
...
/*  66 */         this.m_parent.addWidget(this);
/*  67 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_displayObjectViewer, this);
/*     */     }
...
/*     */   {
/* 111 */     return this.m_displayObjectViewer;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 121 */       return this.m_displayObjectViewer.getDescriptorLibrary();
/*     */     }
/* 123 */     return this.m_descriptorLibrary;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 275 */     XComponent.applyThemeAttributes(dov, element.getAttributes());
/* 276 */     XSpacingAppearance.setAppearance(dov, element);
/* 277 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 278 */     for (ThemeAppearance app : appearances) {
/* 279 */       if (app != null) {
/* 280 */         XDecoratorAppearance.setAppearance(dov, app);
/* 281 */         if ((app instanceof ThemeDisplayObjectViewerAppearance)) {
/* 282 */           XDisplayObjectViewerAppearance.setAppearance(dov, (ThemeDisplayObjectViewerAppearance)app);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XDisplayObjectViewer.class
