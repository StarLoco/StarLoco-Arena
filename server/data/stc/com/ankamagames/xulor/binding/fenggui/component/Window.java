...
/*     */ 
/*     */ public class Window
/*     */   extends org.fenggui.composites.Window
/*     */   implements NonBlocking
/*     */ {
/*  31 */   private static Logger m_logger = Logger.getLogger(Window.class);
/*     */   
/*  33 */   private boolean m_positionReadFromWindowAttributes = false;
/*     */   
/*  35 */   private boolean m_displayTitleBar = true;
/*  36 */   private boolean m_resizable = true;
/*  37 */   private boolean m_movable = true;
/*  38 */   private boolean m_pack = false;
/*  39 */   private String m_id = null;
/*  40 */   private boolean m_showResizeCursor = false;
/*  41 */   private boolean m_nonBlocking = false;
/*     */   
...
/*     */   {
/*  79 */     setLayoutManager(new BorderLayout());
/*     */     
/*  81 */     Container c = new Container();
/*  82 */     c.setNonBlocking(false);
/*  83 */     this.content = c;
/*     */     
/*  85 */     ((Container)this.content).setLayoutData(BorderLayoutData.CENTER);
/*  86 */     ((Container)this.content).setKeyTraversalRoot(true);
/*  87 */     addWidget(this.content);
/*     */     
/*  89 */     c = new Container();
/*  90 */     c.setNonBlocking(false);
/*  91 */     this.titleBar = c;
/*  92 */     this.titleBar.setLayoutData(BorderLayoutData.NORTH);
/*  93 */     buildTitleBar(closeBtn, maximizeBtn, minimizeBtn);
/*     */     
/*     */ 
/*  96 */     addWidget(this.titleBar);
/*     */     
/*     */ 
/*  99 */     setSize(100, 120);
/*     */   }
...
/*     */   {
/* 113 */     this.titleBar.setLayoutManager(new RowLayout(true));
/*     */     
/* 115 */     Label l = new Label();
/* 116 */     l.setNonBlocking(true);
/* 117 */     this.title = l;
/* 118 */     this.titleBar.addWidget(this.title);
...
/*     */     
/* 228 */     IWidget ret = this.m_nonBlocking ? null : this;
/*     */     
/*     */ 
...
/* 284 */       this.m_movePoints = new ArrayList();
/*     */     }
...
/*     */   }
/*     */   
/*     */   class WindowMovePointDnDListenerImpl implements IDragAndDropListener
/*     */   {
/* 346 */     int oldX = 0;
/* 347 */     int oldY = 0;
/*     */     
/*     */     WindowMovePointDnDListenerImpl() {}
/*     */     
/* 351 */     public void select(int x, int y) { this.oldX = x;
/* 352 */       this.oldY = y;
/*     */     }
/*     */     
...
/*     */         }
/* 363 */         int titleBarHeight = Window.access$0(Window.this).contains(Window.access$1(Window.this)) ? Window.access$1(Window.this).getHeight() : 50;
/*     */         
...
/*     */   }
/*     */   
/*     */   class WindowResizePointDnDListenerImpl implements IDragAndDropListener
/*     */   {
/* 398 */     int oldX = 0;
/* 399 */     int oldY = 0;
/*     */     
/* 401 */     Alignment type = null;
/*     */     
/*     */     WindowResizePointDnDListenerImpl() {}
/*     */     
/*     */     public void select(int x, int y) {}
/*     */     
/* 407 */     public void drag(int x, int y) { int flagX = 0;
/* 408 */       int flagY = 0;
/*     */       
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\Window.class
