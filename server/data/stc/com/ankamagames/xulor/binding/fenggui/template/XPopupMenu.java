...
/*     */ import com.ankamagames.xulor.binding.fenggui.component.PopupMenu.PopupMenuAppearance;
...
/*  47 */   private ArrayList<XComponent> m_components = new ArrayList();
/*  48 */   private boolean m_show = false;
...
/*  67 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_popupMenu, this);
/*     */     }
/*     */     
/*  70 */     applyTheme();
/*     */   }
...
/*  77 */           this.m_popupMenu.addButton((Button)component.getWidget());
/*  78 */         } else if ((component instanceof XLabel)) {
/*  79 */           this.m_popupMenu.addLabel((Label)component.getWidget());
/*  80 */         } else if ((component instanceof XSeparator)) {
/*  81 */           this.m_popupMenu.addWidget((Separator)component.getWidget());
/*     */         }
/*     */       }
/*     */       
/*  85 */       this.m_popupMenu.addMenuClosedListener(new IMenuClosedListener() {
/*     */         public void menuClosed(MenuClosedEvent menuClosedEvent) {
/*  87 */           Xulor.getInstance().unload(XPopupMenu.access$0(XPopupMenu.this));
/*     */         }
/*     */       });
/*     */       
...
/* 150 */     button.setOnClick(new MouseClickListener() {
/*     */       public void run(MouseClickEvent event) {
/* 152 */         Xulor.getInstance().unload(XPopupMenu.access$0(XPopupMenu.this));
/*     */       }
/* 154 */     });
...
/* 257 */     XComponent.applyThemeAttributes(popupMenu, element.getAttributes());
/* 258 */     XSpacingAppearance.setAppearance(popupMenu, element);
/* 259 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 260 */     for (ThemeAppearance app : appearances) {
/* 261 */       if (app != null) {
/* 262 */         XDecoratorAppearance.setAppearance(popupMenu, app);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XPopupMenu.class
