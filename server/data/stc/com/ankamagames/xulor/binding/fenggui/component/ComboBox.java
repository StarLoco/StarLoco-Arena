...
/*     */   extends ObservableWidget implements IBasicContainer
/*     */ {
/*     */   private ComboBoxAppearance m_appearance;
/*     */   private Button m_button;
/*     */   private RenderableContainer m_renderable;
/*     */   private List m_list;
/*  33 */   private boolean m_listIsBeingDisplayed = false;
/*  34 */   private Item[] m_items = null;
/*  35 */   private final ArrayList<SelectionChangedListener> m_selectionChangedListeners = new ArrayList();
...
/*     */   
/*     */   public ComboBox() {
/*  42 */     this.m_appearance = new ComboBoxAppearance(this);
...
/*  58 */       this.m_list.setParent(getDisplay());
...
/*  79 */         getDisplay().removeWidget(this.m_list);
/*     */       }
...
/* 110 */           if (!sb.getAppearance().insideMargin(mpe.getLocalX(sb), mpe.getLocalY(sb)))
/*     */           {
...
/* 223 */         this.m_list.setParent(getDisplay());
/*     */       }
...
/*     */       } else {
/* 313 */         this.m_renderable.setItemValue(null);
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/*     */   {
/* 347 */     return getParent().getNextTraversableWidget(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 356 */     return getParent().getPreviousTraversableWidget(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 365 */     return getParent().getNextWidget(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 374 */     return getParent().getPreviousWidget(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 453 */     int x = displayX;int y = displayY;
/*     */     
/*     */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\ComboBox.class
