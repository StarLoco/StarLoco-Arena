...
/* 177 */     XComponent.applyThemeAttributes(widget, element.getAttributes());
/* 178 */     XSpacingAppearance.setAppearance(widget, element);
/* 179 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 180 */     for (ThemeAppearance app : appearances) {
/* 181 */       if (app != null) {
/* 182 */         XDecoratorAppearance.setAppearance(widget, app);
/* 183 */         if ((app instanceof ThemeLabelAppearance)) {
/* 184 */           XLabelAppearance.setAppearance(widget, (ThemeLabelAppearance)app);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XObservableLabelComponent.class
