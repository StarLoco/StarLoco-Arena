...
/*     */ import com.ankamagames.xulor.binding.fenggui.component.ComboBox.ComboBoxAppearance;
...
/*     */   
/*  34 */   private ArrayList<SelectionChangedListener> m_scl = new ArrayList();
...
/*     */   {
/*  62 */     System.out.println("<combobox>");
/*  63 */     IElement[] arrayOfIElement; int j = (arrayOfIElement = getChildren()).length; for (int i = 0; i < j; i++) { IElement c = arrayOfIElement[i];
/*  64 */       c.buildXML();
/*     */     }
...
/*     */       
/*  83 */       if (this.m_parent != null) this.m_parent.addWidget(this);
/*  84 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_comboBox, this);
/*     */     }
/*     */     IElement[] arrayOfIElement;
/*  87 */     int j = (arrayOfIElement = getChildren()).length; for (int i = 0; i < j; i++) { IElement c = arrayOfIElement[i];
/*  88 */       c.buildGUI();
/*     */     }
/*     */     
/*  91 */     applyTheme();
...
/*     */     
/* 143 */     if (content != null) {
/* 144 */       Item[] items = new Item[content.length];
...
/* 239 */     XComponent.applyThemeAttributes(comboBox, element.getAttributes());
/* 240 */     XSpacingAppearance.setAppearance(comboBox, element);
/* 241 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 242 */     for (ThemeAppearance app : appearances) {
/* 243 */       if (app != null) {
/* 244 */         XDecoratorAppearance.setAppearance(comboBox, app);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XComboBoxPlus.class
