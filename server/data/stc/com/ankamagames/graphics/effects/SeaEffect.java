...
/*     */     
/*  34 */     public SeaEffectContext(Effect effect) { super(); }
/*  35 */     private ArrayList<Mesh2D> m_adjency = new ArrayList();
/*     */     
...
/*     */   public SeaEffect() {
/*  90 */     this.m_name = "sea";
/*  91 */     this.m_waves = new ArrayList(256);
...
/*     */     try
/*     */     {
/* 120 */       ShaderManager.getInstance().enableVertexShader(this.m_vs);
...
/* 198 */       GLObject s = this.m_mirror.getScene();
/* 199 */       if (s != null) {
...
/*     */         
/* 214 */         Mesh2D r = (Mesh2D)s.getFirstChild();
/* 215 */         while (r != null) {
/* 216 */           if (r == m) {
/*     */             break;
/*     */           }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\effects\SeaEffect.class
