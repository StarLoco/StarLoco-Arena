...
/* 24 */     super("depth", "", 8);
/*    */     
/* 26 */     String fileName = ShaderManager.getInstance().getShadersBaseDirectory() + "depth/vs_";
/* 27 */     if (textureRectSupported) {
/* 28 */       fileName = fileName + "rect.cg";
/*    */     } else {
/* 30 */       fileName = fileName + "2D.cg";
/*    */     }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\effects\shaders\DepthVertexShader.class
