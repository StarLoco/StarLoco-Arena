...
/* 25 */     super("mirror", "", 8);
/*    */     
/* 27 */     String fileName = ShaderManager.getInstance().getShadersBaseDirectory() + "water/vs_";
/* 28 */     if (textureRectSupported) {
/* 29 */       fileName = fileName + "rect.cg";
/*    */     } else {
/* 31 */       fileName = fileName + "2D.cg";
/*    */     }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\effects\shaders\WaterVertexShader.class
