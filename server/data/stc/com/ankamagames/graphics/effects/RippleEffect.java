...
/*     */   public RippleEffect()
/*     */   {
/*  36 */     this.m_name = "water";
/*  37 */     this.m_requirements = new EffectRequirement(6153, 6162, 1);
/*     */     
...
/*     */     
/*  42 */     this.m_waterVs = new WaterVertexShader(textureRectSupported, numTextureUnits);
/*  43 */     this.m_waterPs = new WaterPixelShader(textureRectSupported, numTextureUnits);
/*  44 */     this.m_depthVs = new DepthVertexShader(textureRectSupported, numTextureUnits);
/*  45 */     this.m_depthPs = new DepthPixelShader(textureRectSupported, numTextureUnits);
/*     */     
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\effects\RippleEffect.class
