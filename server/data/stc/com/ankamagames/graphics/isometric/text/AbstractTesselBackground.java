...
/*     */ 
/*     */ 
/* 159 */   public static final float[] DEFAULT_BACKGROUND_COLOR = { 1.0F, 1.0F, 1.0F, 0.7F };
/* 160 */   private float[] m_backgroundColor4f = DEFAULT_BACKGROUND_COLOR;
/*     */   
/*     */ 
/*     */ 
/*     */ 
/* 165 */   public static final float[] DEFAULT_BORDER_COLOR = { 0.06F, 0.04F, 0.03F, 0.4F };
...
/* 254 */     glu.gluTessBeginContour(tobj);
/* 255 */     double[][] arrayOfDouble; int j = (arrayOfDouble = this.m_vertices).length; for (int i = 0; i < j; i++) { double[] vertex = arrayOfDouble[i];
/* 256 */       glu.gluTessVertex(tobj, vertex, 0, vertex);
/*     */     }
...
/* 265 */     gl.glBegin(2);
/* 266 */     j = (arrayOfDouble = this.m_vertices).length; for (i = 0; i < j; i++) { double[] vertex = arrayOfDouble[i];
/* 267 */       gl.glVertex2dv(vertex, 0);
/*     */     }
/* 269 */     gl.glEnd();
/*     */     
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\isometric\text\AbstractTesselBackground.class
