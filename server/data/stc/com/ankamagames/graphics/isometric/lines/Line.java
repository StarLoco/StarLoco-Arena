...
/* 19 */   private List<SegmentMesh> m_meshes = new ArrayList();
...
/*    */     }
/* 37 */     ((List)this.m_segments.get(handle)).add(segment);
/* 38 */     this.m_meshes.add(new SegmentMesh());
/*    */   }
/*    */   
/*    */   public List<Segment> getSegments(long handle) {
/* 42 */     return (List)this.m_segments.get(handle);
/*    */   }
/*    */   
/*    */   public int getId() {
/* 46 */     return this.m_id;
...
/* 54 */     return (SegmentMesh)this.m_meshIterator.next();
/*    */   }
/*    */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\isometric\lines\Line.class
