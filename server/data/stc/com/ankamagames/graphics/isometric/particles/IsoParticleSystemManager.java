...
/*     */   }
/*     */   
/*  29 */   private Map<Integer, IsoParticleSystem> m_particleSystems = new ConcurrentHashMap();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/*  84 */     IsoParticleSystem particleSystem = (IsoParticleSystem)this.m_particleSystems.get(Integer.valueOf(id));
/*     */     
...
/*     */     {
/* 125 */       IsoParticleSystem system = (IsoParticleSystem)it.next();
/*     */       
...
/* 134 */           system.prepareParticlesBeforeRendering(scene, centerScreenIsoWorldX, centerScreenIsoWorldY);
/* 135 */         } else if (distance > PARTICLE_SYSTEM_MIN_CELL_COUNT_FOR_DESTROY)
/*     */         {
/* 137 */           system.kill();
/*     */         }
/*     */       }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\isometric\particles\IsoParticleSystemManager.class
