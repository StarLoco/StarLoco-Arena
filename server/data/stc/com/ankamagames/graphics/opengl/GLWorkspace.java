...
/*     */   {
/*  30 */     super(caps);
/*  31 */     this.m_animator = new Animator(this);
...
/* 148 */         removeGLEventListener(this.m_renderer);
/* 149 */         removeMouseListener(this.m_renderer);
/* 150 */         removeMouseMotionListener(this.m_renderer);
/* 151 */         removeKeyListener(this.m_renderer);
/*     */       }
/* 153 */       this.m_renderer = renderer;
/* 154 */       addGLEventListener(this.m_renderer);
/* 155 */       addMouseListener(this.m_renderer);
/* 156 */       addMouseMotionListener(this.m_renderer);
/* 157 */       addMouseWheelListener(this.m_renderer);
/* 158 */       addKeyListener(this.m_renderer);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\opengl\GLWorkspace.class
