...
/*     */     
/*  62 */     this.m_renderList = new ArrayList();
/*  63 */     this.m_clearList = new ArrayList();
...
/*     */   {
/* 128 */     List<FieldSourceController> sources = (List)this.m_sources.get(hash);
/* 129 */     if (sources == null) {
/* 130 */       sources = new ArrayList();
...
/*     */   {
/* 145 */     ArrayList<FieldSourceController> sources = (ArrayList)this.m_sources.get(hash);
/* 146 */     if (sources == null) {
/* 147 */       return false;
/*     */     }
...
/*     */   {
/* 158 */     ArrayList<FieldSourceController> sources = (ArrayList)this.m_sources.get(e.getCurrentHashValue());
/* 159 */     if (sources == null) {
/* 160 */       return false;
/*     */     }
...
/*     */     {
/*     */       ArrayList<FieldSourceController> sources;
...
/*     */         {
/* 282 */           sources = (ArrayList)this.m_sources.get(this.m_areas.get(i));
/*     */           
/* 284 */           if (sources != null) {
...
/* 335 */           r = rightPosition.mul(1.0F / rightDistance);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\sounds\group\field\FieldGroup.class
