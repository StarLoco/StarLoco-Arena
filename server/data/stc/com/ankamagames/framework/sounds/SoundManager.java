...
/*  50 */   private float[] m_listenerOrientation = { 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.0F };
/*     */   
/*     */   private ObservedListener m_listener;
/*     */   
/*     */   private boolean m_initialized;
/*  55 */   private final HashMap<String, SoundBankItem> m_soundBank = new HashMap();
...
/*  64 */     this.m_groups = new ArrayList();
...
/*     */       
/* 126 */       this.m_sourcePoolIn = new ArrayList();
/* 127 */       this.m_sourcePoolOut = new ArrayList();
/*     */       
/* 129 */       for (int i = 0; i < this.m_nbSources; i++) {
...
/*     */       }
/*     */       
/* 140 */       this.m_bufferPoolIn = new ArrayList();
/* 141 */       this.m_bufferPoolOut = new ArrayList();
/*     */       
/* 143 */       for (int i = 0; i < this.m_nbBuffers; i++) {
...
/* 218 */       return null;
/*     */     }
/* 220 */     Source source = (Source)this.m_sourcePoolIn.remove(0);
...
/* 251 */       return null;
/*     */     }
/* 253 */     Buffer buffer = (Buffer)this.m_bufferPoolIn.remove(0);
...
/* 348 */               AudioSourceGroup group = (AudioSourceGroup)this.m_groups.get(i);
/*     */               try {
...
/*     */     {
/* 379 */       SoundBankItem item = (SoundBankItem)this.m_soundBank.get(referenceName);
/* 380 */       if (item != null)
...
/* 405 */     getInstance().addGroup(group);
/*     */     
...
/*     */     {
/*     */       for (;;) {
/* 416 */         Thread.sleep(1000L);
/*     */       }
/* 418 */     } catch (InterruptedException e) { e.printStackTrace();
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\sounds\SoundManager.class
