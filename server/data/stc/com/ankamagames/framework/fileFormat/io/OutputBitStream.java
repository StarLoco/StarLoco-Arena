...
/*  29 */   private boolean m_compressed = false;
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   public void writeBooleanBit(boolean value)
/*     */     throws IOException
/*     */   {
/* 199 */     writeUnsignedBits(value ? 1 : 0, 1);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 232 */     buffer[0] = ((byte)(int)(longBits >> 32));
/* 233 */     buffer[1] = ((byte)(int)(longBits >> 40));
/* 234 */     buffer[2] = ((byte)(int)(longBits >> 48));
/* 235 */     buffer[3] = ((byte)(int)(longBits >> 56));
/* 236 */     buffer[4] = ((byte)(int)longBits);
/* 237 */     buffer[5] = ((byte)(int)(longBits >> 8));
/* 238 */     buffer[6] = ((byte)(int)(longBits >> 16));
/* 239 */     buffer[7] = ((byte)(int)(longBits >> 24));
...
/*     */ 
/*     */ 
/*     */   public void writeFP32(double value)
/*     */     throws IOException
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public void writeFPBits(double value, int nBits)
/*     */     throws IOException
/*     */   {
/* 282 */     long fpBits = (value * 65536.0D);
...
/* 311 */     int sign = Math.abs((bits32 & 0x80000000) >> 31);
...
/*     */ 
/*     */ 
/*     */   public void writeSI8(byte value)
/*     */     throws IOException
/*     */   {
/* 380 */     align();
/* 381 */     this.m_stream.write(value);
/* 382 */     this.m_offset += 1L;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 446 */     align();
/* 447 */     this.m_stream.write((int)(value & 0xFF));
/* 448 */     this.m_stream.write((int)(value >> 8));
/* 449 */     this.m_stream.write((int)(value >> 16));
/* 450 */     this.m_stream.write((int)(value >> 24));
...
/*     */ 
/*     */ 
/*     */   public void writeUI8(short value)
/*     */     throws IOException
/*     */   {
/* 464 */     align();
/* 465 */     this.m_stream.write(value);
/* 466 */     this.m_offset += 1L;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\fileFormat\io\OutputBitStream.class
