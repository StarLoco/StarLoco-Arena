...
/*     */   {
/*     */     public static AlphaBitmapData read1(InputBitStream inStream, int dataLength)
/*     */       throws IOException
/*     */     {
...
/*     */ 
/*     */ 
/*     */     public static AlphaBitmapData read2(InputBitStream inStream)
/*     */       throws IOException
/*     */     {
...
/*     */ 
/*     */ 
/*  65 */   private boolean m_alphaPremultiplied = false;
/*     */   
...
/*     */ 
/*     */ 
/*     */   public AlphaBitmapData(InputBitStream stream)
/*     */     throws IOException
/*     */   {
/* 104 */     read(stream);
/*     */   }
...
/*     */ 
/*     */ 
/*     */   public void read(InputBitStream inStream)
/*     */     throws IOException
/*     */   {
/* 227 */     short version = inStream.readUI8();
/*     */     
/* 229 */     if (version != 1) {
/* 230 */       new Exception("Version incorrecte:" + version + " courante:" + 1).printStackTrace();
/*     */     }
/*     */     
...
/*     */   public int hashCode()
/*     */   {
/* 341 */     if (!$assertionsDisabled) throw new AssertionError("Pas d'insertion possible en tant que clef dans une HashMap/HashTable");
/* 342 */     return super.hashCode();
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\image\AlphaBitmapData.class
