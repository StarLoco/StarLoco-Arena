...
/*    */   {
/* 40 */     this.m_reader = new TagDocumentReader(null, SBATagDecoder.getInstance(), m_documentFactory);
/*    */   }
/*    */   
/*    */ 
/*    */ 
...
/*    */ 
/*    */ 
/*    */   public SBADocument getDocument(String fileName)
/*    */     throws Exception
/*    */   {
...
/*    */ 
/*    */ 
/*    */   public SBADocument getDocument(File file)
/*    */     throws Exception
/*    */   {
/* 69 */     SBADocument doc = getDocument(new FileInputStream(file));
/* 70 */     if (doc.getVersion() != 3) {
/* 71 */       System.out.println("Le fichier " + file.getName() + " n'est pas a jour (version: " + doc.getVersion() + " courante: " + 2);
/*    */     }
/* 73 */     return doc;
/*    */   }
/*    */   
/*    */   public SBADocument getDocument(InputStream istream) throws Exception {
/* 77 */     this.m_reader.create(istream, SBATagDecoder.getInstance(), m_documentFactory);
/*    */     
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\sba\SBADocumentManager.class
