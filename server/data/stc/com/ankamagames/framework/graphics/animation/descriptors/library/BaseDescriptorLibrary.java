...
/*     */ 
/*     */ 
/*  76 */   private boolean m_managed = true;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 115 */     super(new ResourceFactoryDescriptor[] {new ResourceFactoryDescriptor(2, new ResourceFactory()new ContextFactory
/*     */     {
/*     */       public BitmapDescriptor makeObject()
/*     */       {
/*  86 */         return new BitmapDescriptor();
/*     */       }
/*  88 */     }, new ContextFactory() {
/*     */       public DisplayObjectDescriptor.DisplayObjectDescriptorContext makeObject() {
/*  90 */         return new DisplayObjectDescriptor.DisplayObjectDescriptorContext();
/*     */       }
/*     */       
/*     */ 
/*  94 */     }), new ResourceFactoryDescriptor(3, new ResourceFactory()
/*     */     
/*     */ 
/*     */ 
/*  98 */       new ContextFactory {
/*     */         public BitmapSequenceDescriptor makeObject() {
/*  96 */           return new BitmapSequenceDescriptor();
/*     */         }
/*  98 */       }, new ContextFactory() {
/*     */         public DisplayObjectDescriptor.DisplayObjectDescriptorContext makeObject() {
/* 100 */           return new DisplayObjectDescriptor.DisplayObjectDescriptorContext();
/*     */         }
/*     */         
/*     */ 
/* 104 */       }), new ResourceFactoryDescriptor(4, new ResourceFactory()
/*     */       
/*     */ 
/*     */ 
/* 108 */       new ContextFactory {
/*     */         public MovieClipDescriptor makeObject() {
/* 106 */           return new MovieClipDescriptor();
/*     */         }
/* 108 */       }, new ContextFactory() {
/*     */         public DisplayObjectDescriptor.DisplayObjectDescriptorContext makeObject() {
/* 110 */           return new DisplayObjectDescriptor.DisplayObjectDescriptorContext();
/*     */ 
/*     */         }
/*     */         
/*     */ 
...
/* 240 */       if (tag != null) {
/* 241 */         descriptor = createDescriptor(tag);
...
/* 253 */       tagResourceInUse(descriptor);
/*     */     }
...
/* 274 */       if (tag != null) {
/* 275 */         descriptor = createDescriptor(tag);
/*     */       } else {
...
/* 282 */       tagResourceInUse(descriptor);
/*     */     }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\animation\descriptors\library\BaseDescriptorLibrary.class
