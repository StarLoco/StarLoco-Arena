...
/*  42 */   private ArrayList<GLRenderable> m_scenes = new ArrayList();
/*     */   
/*  44 */   private final Object m_renderablesToInitMutex = new Object();
/*  45 */   private ArrayList<GLRenderable> m_renderablesToInitialize = new ArrayList();
/*     */   
/*     */   private int m_timer;
/*     */   
/*     */   private GL m_gl;
...
/*     */   
/*     */ 
/*  88 */   private boolean m_showDebugInfosOnDisplay = false;
...
/*  99 */     this.m_timer = 0;
/*     */     
/* 101 */     this.m_mouseControllers = new ArrayList();
/* 102 */     this.m_keyboardControllers = new ArrayList();
/*     */     
/* 104 */     this.m_doubleBuffering = true;
/* 105 */     this.m_syncWait = true;
/*     */     
/* 107 */     this.m_rendererHandlers = new ArrayList();
/*     */     
/* 109 */     this.m_resourceManagers = new ArrayList();
/* 110 */     this.m_resourceManagersToAdd = new ArrayList();
/* 111 */     this.m_resourceManagersToRemove = new ArrayList();
/*     */   }
/*     */   
...
/*     */           
/* 326 */           for (int i = 0; i < this.m_resourceManagersToRemove.size(); i++) {
/* 327 */             this.m_resourceManagers.remove(this.m_resourceManagersToRemove.get(i));
/*     */           }
/* 329 */           this.m_resourceManagersToRemove.clear();
/*     */           
/* 331 */           for (int i = 0; i < this.m_resourceManagersToAdd.size(); i++) {
/* 332 */             this.m_resourceManagers.add((BaseResourceManager)this.m_resourceManagersToAdd.get(i));
/*     */           }
/* 334 */           this.m_resourceManagersToAdd.clear();
/*     */           
/* 336 */           for (int i = 0; i < this.m_resourceManagers.size(); i++) {
...
/* 349 */             for (int i = 0; i < this.m_renderablesToInitialize.size(); i++) {
/* 350 */               GLRenderable renderable = (GLRenderable)this.m_renderablesToInitialize.get(i);
...
/*     */           
/* 377 */           for (int i = 0; i < this.m_scenes.size(); i++) {
/* 378 */             ((GLRenderable)this.m_scenes.get(i)).processGeometry(this.m_gl);
/*     */           }
/* 380 */           for (int i = 0; i < this.m_scenes.size(); i++) {
...
/* 416 */             for (int i = 0; i < this.m_scenes.size(); i++) {
/* 417 */               y -= 15;
/* 418 */               this.m_textRenderer.draw("Scene " + sceneIndex++ + " : " + ((GLRenderable)this.m_scenes.get(i)).toString(), x + 5, y);
/*     */             }
/*     */             
...
/*     */         try {
/* 430 */           Thread.sleep(Math.max(1.0F, neededTime - effectiveTime));
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\opengl\Renderer.class
