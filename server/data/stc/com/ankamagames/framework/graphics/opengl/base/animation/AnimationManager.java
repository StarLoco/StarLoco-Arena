...
/*     */     extends TimedObject
/*     */   {
/*  35 */     protected ArrayList<AnimatedObject> m_animatedObjects = new ArrayList();
/*     */     
...
/*  96 */           AnimatedObject animatedObject = (AnimatedObject)iterator.next();
...
/* 104 */             if (mesh != null) {
/* 105 */               this.m_scene.removeChild(mesh);
/*     */             }
/*     */             
/*     */ 
...
/*     */   
/* 137 */   protected List<AnimatedSceneData> m_animatedSceneDatasToAdd = new ArrayList();
/* 138 */   protected List<Scene> m_animatedSceneDatasToRemove = new ArrayList();
/*     */   
/*     */ 
/*     */ 
/*     */   protected AnimationManager()
/*     */   {
/* 144 */     this.m_animatedSceneDatas = new HashMap();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 195 */     for (int i = 0; i < this.m_animatedSceneDatasToRemove.size(); i++) {
/* 196 */       this.m_animatedSceneDatas.remove(this.m_animatedSceneDatasToRemove.get(i));
/*     */     }
/* 198 */     this.m_animatedSceneDatasToRemove.clear();
/*     */     
/* 200 */     for (int i = 0; i < this.m_animatedSceneDatasToAdd.size(); i++) {
/* 201 */       this.m_animatedSceneDatas.put(((AnimatedSceneData)this.m_animatedSceneDatasToAdd.get(i)).getScene(), (AnimatedSceneData)this.m_animatedSceneDatasToAdd.get(i));
/*     */     }
...
/*     */   {
/* 209 */     AnimatedSceneData sceneData = (AnimatedSceneData)this.m_animatedSceneDatas.get(scene);
...
/*     */   {
/* 221 */     AnimatedSceneData sceneData = (AnimatedSceneData)this.m_animatedSceneDatas.get(scene);
...
/*     */   {
/* 233 */     AnimatedSceneData sceneData = (AnimatedSceneData)this.m_animatedSceneDatas.get(scene);
...
/*     */   {
/* 243 */     AnimatedSceneData sceneData = (AnimatedSceneData)this.m_animatedSceneDatas.get(scene);
...
/*     */   {
/* 254 */     AnimatedSceneData sceneData = (AnimatedSceneData)this.m_animatedSceneDatas.get(scene);
...
/*     */   {
/* 263 */     AnimatedSceneData sceneData = (AnimatedSceneData)this.m_animatedSceneDatas.get(scene);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\opengl\base\animation\AnimationManager.class
