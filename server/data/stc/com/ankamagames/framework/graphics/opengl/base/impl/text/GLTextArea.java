...
/*     */ 
/*     */ 
/*  70 */   public static final float[] DEFAULT_TEXT_COLOR = { 0.0F, 0.0F, 0.0F, 1.0F };
...
/*     */ 
/*     */ 
/*  88 */   private List<String> m_lines = new ArrayList();
/*  89 */   private int m_lineSpacing = 0;
/*     */   
/*     */   private TextRenderer m_renderer;
/*     */   
/*  93 */   private boolean m_needToReflow = true;
/*  94 */   private boolean m_needToSetColor = true;
/*     */   
...
/* 364 */       String line = (String)this.m_lines.get(i);
/* 365 */       if (line != null) {
...
/*     */     
/*     */ 
/* 400 */     FontRenderContext frc = this.m_renderer.getFontRenderContext();
/* 401 */     String[] arrayOfString1; int j = (arrayOfString1 = paragraphs).length; for (int i = 0; i < j; i++) { String paragraph = arrayOfString1[i];
/* 402 */       if (paragraph.length() != 0) {
/* 403 */         Map attrs = new HashMap();
/* 404 */         attrs.put(TextAttribute.FONT, this.m_renderer.getFont());
/* 405 */         AttributedString str = new AttributedString(paragraph, attrs);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\opengl\base\impl\text\GLTextArea.class
