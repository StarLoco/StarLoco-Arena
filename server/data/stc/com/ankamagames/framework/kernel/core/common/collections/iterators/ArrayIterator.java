...
/* 53 */       this.m_nextIndex += 1;
/*    */     }
/*    */     else {
/* 56 */       for (this.m_nextIndex += 1; (this.m_nextIndex < this.m_arrayLength) && (this.m_array[this.m_nextIndex] == null); this.m_nextIndex += 1) {}
/*    */     }
/*    */   }
/*    */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\core\common\collections\iterators\ArrayIterator.class
