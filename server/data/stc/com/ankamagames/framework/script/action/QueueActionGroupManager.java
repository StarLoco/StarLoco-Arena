...
/*     */   
/*     */ 
/*  29 */   private LinkedList<ActionGroup> m_executingActionGroups = new LinkedList();
/*     */   
/*  31 */   private boolean m_actionInExecution = false;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  83 */       ActionGroup group = (ActionGroup)this.m_executingActionGroups.getFirst();
/*     */       
...
/* 107 */     if (this.m_executingActionGroups.size() > 0) { Iterator localIterator2;
/* 108 */       for (localIterator1 = this.m_executingActionGroups.iterator(); localIterator1.hasNext(); 
/*     */           
/*     */ 
/* 111 */           localIterator2.hasNext())
/*     */       {
/* 108 */         ActionGroup group = (ActionGroup)localIterator1.next();
/* 109 */         m_logger.info("Executing Action Group (" + group.getActions().size() + " actions)");
/*     */         
/* 111 */         localIterator2 = group.getActions().iterator(); continue;Action action = (Action)localIterator2.next();
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\script\action\QueueActionGroupManager.class
