...
/* 75 */       return new EmptyIterable();
/*    */     }
/* 77 */     List<T> targets = new LinkedList();
/*    */     
/* 79 */     for (Iterator<T> it = provider.getPossibleTargets(); it.hasNext();) {
/* 80 */       T target = (Target)it.next();
/* 81 */       switch (filter.getTargetValidity(target, applicant)) {
/*    */       case INVALID: 
/* 83 */         targets.add(target);
/* 84 */         break;
/*    */       case VALID_IF_IN_AOE: 
/* 86 */         Point3 applicantPosition = applicant == null ? null : applicant.getPosition();
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\ai\targetfinder\TargetFinder.class
