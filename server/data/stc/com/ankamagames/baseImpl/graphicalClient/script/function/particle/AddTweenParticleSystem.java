...
/*    */     ParabolicTween tween;
/* 81 */     if (timeCoef < 0.0D) {
/* 82 */       tween = new ParabolicTween(system, destX, destY, destZ, angle);
/*    */     } else {
/* 84 */       tween = new ParabolicTween(system, destX, destY, destZ, angle, timeCoef);
/*    */     }
/* 86 */     IsoParticleSystemManager.getInstance().addParticleSystem(system);
/* 87 */     TweenManager.getInstance().addTween(tween);
/*    */     
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphicalClient\script\function\particle\AddTweenParticleSystem.class
