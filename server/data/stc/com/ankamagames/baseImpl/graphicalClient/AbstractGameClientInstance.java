...
/*  94 */   private final List<ContentInitializer> m_contentInitializers = new ArrayList();
...
/* 195 */       setGamePreferences(new GamePreferences(getPreferenceStore()));
/*     */     }
...
/*     */     throws Exception
/*     */   {
/* 264 */     Xulor.getInstance().setPreferenceStore(getPreferenceStore());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected abstract XulorScene createXulorScene()
/*     */     throws Exception;
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected abstract void initXulorScene(XulorScene paramXulorScene)
/*     */     throws Exception;
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected abstract GameWorldScene createWorldScene()
/*     */     throws Exception;
/*     */   
/*     */ 
/*     */ 
...
/* 302 */       this.m_worldScene.setPreRenderStates(new DefaultScenePreRenderStates());
/* 303 */       this.m_worldScene.setPostRenderStates(new DefaultScenePostRenderStates());
/*     */     } else {
...
/*     */ 
/*     */ 
/*     */   protected void initSound(String soundDeviceName, int nbSources, int nbBuffers, float musicVolume, boolean musicMute)
/*     */     throws Exception
/*     */   {
...
/* 325 */       SoundManager.getInstance().addGroup(musics);
...
/*     */ 
/*     */ 
/*     */   protected boolean initVideo(int screenWidth, int screenHeight, int screenBpp, boolean bDoubleBuffering, boolean bVSync, boolean bFullScreen, int frameRate)
/*     */     throws Exception
/*     */   {
...
/*     */         } catch (Exception e) {
/* 388 */           JOptionPane.showMessageDialog(AbstractGameClientInstance.this.getGameFrame(), e.getMessage() + " (" + e.getClass().getName() + ")");
/*     */         }
...
/* 404 */       renderer.pushScene(this.m_xulorScene, true);
/* 405 */       renderer.pushMouseController(this.m_xulorScene, true);
/* 406 */       renderer.pushKeyboardController(this.m_xulorScene, false);
/*     */     }
/*     */     
/*     */ 
/* 410 */     this.m_worldScene = createWorldScene();
/* 411 */     initWorldScene(this.m_worldScene);
/* 412 */     if (this.m_worldScene != null) {
/* 413 */       renderer.pushScene(this.m_worldScene, false);
/* 414 */       renderer.pushMouseController(this.m_worldScene, false);
/* 415 */       renderer.pushKeyboardController(this.m_worldScene, false);
/*     */     }
/*     */     
/* 418 */     return true;
/*     */   }
...
/* 471 */       ContentInitializer contentLoader = (ContentInitializer)this.m_contentInitializers.get(this.m_currentContentInitializerIndex);
...
/*     */     try
/*     */     {
/* 496 */       ContentInitializer contentLoader = (ContentInitializer)this.m_contentInitializers.get(this.m_currentContentInitializerIndex + 2);
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphicalClient\AbstractGameClientInstance.class
