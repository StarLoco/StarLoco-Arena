...
/*     */   }
/*     */   
/*  96 */   public TeintElement getTeintElement() { return this.m_teintElement; }
/*     */   
...
/* 160 */       int elementId = this.m_streamBuffer.getInt();
...
/*     */       {
/*     */       case 2: 
/* 167 */         GraphicalElement graphicalElement = new GraphicalElement(elementId);
/* 168 */         this.m_graphicalElements.put(elementId, graphicalElement);
/* 169 */         newElement = graphicalElement;
/* 170 */         break;
/*     */       
/*     */       case 3: 
/* 173 */         this.m_teintElement = new TeintElement(elementId);
/* 174 */         newElement = this.m_teintElement;
/* 175 */         break;
/*     */       
/*     */       case 4: 
/* 178 */         this.m_offsetElement = new OffsetElement(elementId);
/* 179 */         newElement = this.m_offsetElement;
/* 180 */         break;
/*     */       
/*     */       case 6: 
/* 183 */         this.m_groupElement = new GroupElement(elementId);
/* 184 */         newElement = this.m_groupElement;
/* 185 */         break;
/*     */       
/*     */       case 8: 
/* 188 */         this.m_levelUnpiledElement = new LevelUnpiledElement(elementId);
/* 189 */         newElement = this.m_levelUnpiledElement;
/* 190 */         break;
/*     */       
/*     */       case 9: 
/* 193 */         this.m_particleElement = new ParticleElement(elementId);
/* 194 */         newElement = this.m_particleElement;
/* 195 */         break;
/*     */       
/*     */       case 10: 
/* 198 */         this.m_brightnessElement = new BrightnessElement(elementId);
/* 199 */         newElement = this.m_brightnessElement;
/* 200 */         break;
/*     */       case 5: case 7: 
/*     */       default: 
/* 203 */         if (this.m_customElementFactory != null) {
/* 204 */           newElement = this.m_customElementFactory.createElement(elementId, elementType);
/* 205 */           if ((newElement instanceof GraphicalElement)) {
/* 206 */             this.m_graphicalElements.put(elementId, (GraphicalElement)newElement);
/*     */           }
/*     */         }
/*     */         
/* 210 */         if (newElement == null)
/*     */         {
/* 212 */           newElement = new UnknownElement(elementId);
/*     */         }
/* 214 */         this.m_customElements.put(elementId, newElement);
/*     */       }
/*     */       
/*     */       
/*     */ 
/* 219 */       newElement.read(this.m_streamBuffer);
/* 220 */       addElement(newElement);
/*     */     }
/*     */     
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\WorldElementManager.class
