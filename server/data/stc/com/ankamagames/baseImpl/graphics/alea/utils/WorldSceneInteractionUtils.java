...
/*     */ 
/*     */ 
/*     */   public static enum PathSolutionCriterions
/*     */   {
/*  37 */     SMALLEST, 
/*     */     
/*  39 */     NEAREST_UP_FACE;
...
/*     */ 
/*     */ 
/*     */     case NEAREST_UP_FACE: 
/*  59 */       ArrayList<DisplayedElement> hitElements = worldScene.getDisplayedElementsUnderMousePoint(mouseX, mouseY, null);
/*     */       
/*  61 */       hitElements.size();
/*     */       
/*     */ 
...
/*     */ 
/*     */     case SMALLEST: 
/*  71 */       ArrayList<DisplayedElement> hitElements = worldScene.getDisplayedElementsUnderMousePoint(mouseX, mouseY, DisplayedElementComparator.MOUSE_DISTANCE_COMPARATOR);
/*     */       
...
/*     */         {
/*  78 */           DisplayedElement displayedElement = (DisplayedElement)hitElements.get(displayElementIndex);
...
/*  92 */           PathFindResult currentPathResult = pathFinder.compute(pathMobile, WorldManager.getInstance(), from, to, pathFindParameters);
...
/* 125 */         Mobile mobile = (Mobile)hitMobiles.get(0);
/* 126 */         if (mobile != null) {
...
/*     */     
/* 136 */     DisplayedElement elt = (hitElements != null) && (hitElements.size() != 0) ? (DisplayedElement)hitElements.get(0) : null;
/* 137 */     return elt != null ? elt.getCoordinates() : null;
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\utils\WorldSceneInteractionUtils.class
