...
/*     */     int m;
/* 113 */     int typeSize; for (int levelIndex = 0; levelIndex < levelCount; levelIndex++) {
...
/* 120 */         int elementId = this.m_streamBuffer.getInt();
...
/*     */           }
/*     */           
/* 144 */           byte[] savedParam = new byte[byteParam.position()];
...
/*     */           
/*     */           case 2: 
/* 225 */             GraphicalElement graphicalElement = (GraphicalElement)element.getElement();
/*     */             
/* 227 */             boolean elementPiled = graphicalElement.getStateProperties(element.getState()).isPiled();
/* 228 */             byte elementAltitude = elementPiled ? currentAltitude : levelAltitude;
/* 229 */             float elementHeight = graphicalElement.getStateProperties(element.getState()).getHeight();
/*     */             
/* 231 */             float elementTopAltitude = elementAltitude + elementHeight;
/* 232 */             float zCellOrderAltitude = minOrderPossibleAltitude > elementTopAltitude ? minOrderPossibleAltitude + possibleAltitudePad : elementTopAltitude;
/*     */             
/* 234 */             element.addPrecalculatedInformations(level, elementAltitude, currentBrightness, currentTeint, zCellOrderAltitude);
...
/*     */             }
/* 241 */             minOrderPossibleAltitude = zCellOrderAltitude;
/*     */             
/* 243 */             break;
/*     */           
/*     */           case 6: 
...
/*     */             {
/* 284 */               this.m_customElementHandler.onReadCell(cell, element, levels);
/*     */             }
/*     */             
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\WorldMapDocumentAccessor.class
