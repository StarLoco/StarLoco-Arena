...
/* 123 */       m_logger.error(ExceptionFormatter.toString(e));
/* 124 */       bError = true;
/*     */     } catch (ContentAlreadyPresentException e) {
/* 126 */       m_logger.error(ExceptionFormatter.toString(e));
/* 127 */       bError = true;
/*     */     } catch (PositionAlreadyUsedException e) {
/* 129 */       m_logger.error(ExceptionFormatter.toString(e));
/* 130 */       bError = true;
/*     */     }
/*     */     
/* 133 */     return !bError;
...
/* 203 */     notifyObservers(InventoryItemModifiedEvent.checkOutAddEvent(this, item, idx));
/*     */     
/* 205 */     return true;
/*     */   }
/*     */   
...
/*     */ 
/*     */ 
/*     */   public boolean addAt(ContentType item, short position)
/*     */     throws InventoryCapacityReachedException, ContentAlreadyPresentException, PositionAlreadyUsedException
/*     */   {
/* 227 */     if (item == null) {
...
/* 248 */     notifyObservers(InventoryItemModifiedEvent.checkOutAddEvent(this, item, position));
/* 249 */     return true;
/*     */   }
/*     */   
/*     */ 
...
/* 296 */       notifyObservers(InventoryItemModifiedEvent.checkOutRemoveEvent(this, item, idx));
/* 297 */       return true;
/*     */     }
/* 299 */     return false;
/*     */   }
...
/* 321 */       notifyObservers(InventoryItemModifiedEvent.checkOutRemoveEvent(this, item, idx));
/* 322 */       item.release();
/* 323 */       return true;
/*     */     }
/* 325 */     return false;
...
/* 343 */     notifyObservers(InventoryItemModifiedEvent.checkOutRemoveEvent(this, item, position));
/* 344 */     return true;
/*     */   }
/*     */   
/*     */ 
...
/* 365 */     notifyObservers(InventoryItemModifiedEvent.checkOutRemoveEvent(this, item, position));
/* 366 */     item.release();
/* 367 */     return true;
/*     */   }
/*     */   
...
/* 401 */           this.m_contents[idx] == null ? "" : new StringBuilder("(id : ").append(this.m_contents[idx].getUniqueId()).append(")").toString()));
...
/* 409 */       notifyObservers(InventoryItemModifiedEvent.checkOutRemoveEvent(this, contentToReturn, idx));
...
/* 421 */           this.m_contents[idx] == null ? "" : new StringBuilder("(id : ").append(this.m_contents[idx].getUniqueId()).append(")").toString()));
...
/* 426 */         return false;
/* 427 */       notifyObservers(InventoryItemModifiedEvent.checkOutRemoveEvent(this, this.m_contents[idx], idx));
...
/*     */   {
/* 440 */     return new ArrayIterator(this.m_contents, false);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*     */     InventoryContent[] arrayOfInventoryContent;
/*     */     
/*     */ 
/* 470 */     int j = (arrayOfInventoryContent = this.m_contents).length; for (int i = 0; i < j; i++) { ContentType item = arrayOfInventoryContent[i];
...
/* 496 */     return this.m_contents[idx];
/*     */   }
/*     */   
/*     */   @Nullable
/*     */   public ContentType getFirstWithReferenceId(int referenceId) { InventoryContent[] arrayOfInventoryContent;
/* 501 */     int j = (arrayOfInventoryContent = this.m_contents).length; for (int i = 0; i < j; i++) { ContentType item = arrayOfInventoryContent[i];
...
/* 521 */     if (itemsCount > 0)
/* 522 */       notifyObservers(InventoryClearedEvent.checkOut(this));
...
/* 534 */     if (itemsCount > 0)
/* 535 */       notifyObservers(InventoryClearedEvent.checkOut(this));
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\inventory\ArrayInventory.class
