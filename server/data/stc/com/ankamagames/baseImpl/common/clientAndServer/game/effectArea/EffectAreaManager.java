...
/*     */   {
/*  39 */     this.m_activeEffectArea = new HashMap();
/*  40 */     this.m_effectAreaList = new ArrayList();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     try
/*     */     {
/*  55 */       EffectAreaManager manager = (EffectAreaManager)m_pool.borrowObject();
...
/*     */   {
/* 115 */     return (Iterable)this.m_activeEffectArea.values();
/*     */   }
/*     */   
/*     */   public BasicEffectArea getActiveEffectAreaWithId(long id) {
/* 119 */     return (BasicEffectArea)this.m_activeEffectArea.get(Long.valueOf(id));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 156 */     List<BasicEffectArea> areaOwned = new ArrayList();
...
/*     */   {
/* 191 */     ArrayList<BasicEffectArea> areaAlreadyIn = new ArrayList();
/*     */     
...
/*     */       }
/*     */     }
/* 198 */     ArrayList<BasicEffectArea> areaIn = new ArrayList();
/* 199 */     Object areaOut = new ArrayList();
...
/*     */         }
/*     */       }
/* 206 */       else if (areaAlreadyIn.contains(area)) {
/* 207 */         ((ArrayList)areaOut).add(area);
/*     */       }
/*     */     }
/*     */     
/*     */ 
/* 212 */     for (BasicEffectArea area : areaIn) {
/* 213 */       area.triggers(1, applicant);
/*     */     }
/*     */     
/* 216 */     for (BasicEffectArea area : (ArrayList)areaOut) {
/* 217 */       area.triggers(2, applicant);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\effectArea\EffectAreaManager.class
