...
/* 106 */       FighterTurnTimeEvent<F> ftte = (FighterTurnTimeEvent)getFirstTimeEvent();
...
/* 127 */       FighterTurnTimeEvent<F> ftte = (FighterTurnTimeEvent)getFirstTimeEvent();
...
/* 185 */     for (F fighter : this.m_orderedFigthers) {
/* 186 */       tu.increment();
/* 187 */       pushFighterTimeEvent(fighter, tu);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 220 */     for (TimeEvent<TurnBasedTimeUnit, TurnBasedTimeInterval> te : this.m_timeline)
/*     */     {
/* 222 */       if (((TurnBasedTimeUnit)te.when()).compareTo(tu) > 0) {
/* 223 */         TurnBasedTimeInterval ti = TurnBasedTimeInterval.checkOut(0, 1);
/* 224 */         te.shiftStart((TurnBasedTimeUnit)te.when(), ti);
/* 225 */         ti.release();
/* 226 */       } else if (((TurnBasedTimeUnit)te.when()).compareTo(tu) == 0)
/*     */       {
/*     */ 
/* 229 */         if (te.getPriority() == 0) {
/* 230 */           TurnBasedTimeInterval ti = TurnBasedTimeInterval.checkOut(0, 1);
/* 231 */           te.shiftStart((TurnBasedTimeUnit)te.when(), ti);
/* 232 */           ti.release();
/*     */         }
/*     */       }
/*     */     }
...
/*     */       
/*     */       TurnBasedTimeInterval ti;
/* 251 */       for (TimeEvent<TurnBasedTimeUnit, TurnBasedTimeInterval> te : this.m_timeline) {
...
/*     */         }
/* 258 */         if (decalage) {
/* 259 */           ti = TurnBasedTimeInterval.checkOut(0, -1);
/* 260 */           te.shiftStart((TurnBasedTimeUnit)te.when(), ti);
/* 261 */           ti.release();
/*     */         }
/*     */       }
/*     */       
/*     */ 
/*     */ 
/* 267 */       Filter<TimeEvent<TurnBasedTimeUnit, TurnBasedTimeInterval>> filter = new TimeEventRelatedToEffectUserFilter(fighter, fighter == getCurrentFighter());
/* 268 */       for (TimeEvent te : filter(filter)) {
...
/*     */     case 107: 
/* 304 */       FighterTurnTimeEvent<F> ftte = (FighterTurnTimeEvent)te;
/* 305 */       startFighterTurn(ftte.getTurnBasedFighter());
...
/*     */     
/*     */     case 108: 
/* 317 */       EffectAreaActivationTimeEvent eaate = (EffectAreaActivationTimeEvent)te;
...
/*     */     case 107: 
/* 335 */       FighterTurnTimeEvent<F> ftte = (FighterTurnTimeEvent)te;
/* 336 */       endFighterTurn(ftte.getTurnBasedFighter());
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\time\TurnBased\TurnBasedTimeline.class
