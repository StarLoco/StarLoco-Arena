...
/*     */ {
/*  19 */   public static final String[] FORBIDDEN_NAMES = {
/*  20 */     "KAM", "TOT", "BO", "MANU", "LICHEN", "YAMATO", "XYO", "BEK", "GM", "MJ", "MOD" };
/*     */   
/*     */ 
/*  23 */   public static final String[] NAMES_STARTING_WITH = {
/*  24 */     "KAM-", "TOT-", "BO-", "MANU-", "LICHEN", "YAMATO", "BEK-", "MODER" };
/*     */   
/*     */ 
/*  27 */   public static final String[] WORDS_EQUALS = {
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */ 
/*  39 */   public static final String[] WORDS_CONTAINING = {
/*     */   
/*  41 */     "HTTP", "WWW", "FTP", 
/*     */     
/*     */ 
...
/*  79 */   public static final String[] m_charReplacement = { "&", "~", "#", "@", "£", "¤", "µ", "%", "§", "?", "!" };
/*     */   
/*     */   static {
/*  82 */     String p = "";
...
/*  84 */       if (i > 0)
/*  85 */         p = p + "|";
/*  86 */       p = p + WORDS_CONTAINING[i];
/*     */     }
/*  88 */     String s = "((\\S*(" + p + ")\\S*)|(([^a-zA-Z0-9]|\\A)(";
/*  89 */     for (int i = 0; i < WORDS_EQUALS.length; i++) {
/*  90 */       if (i > 0)
/*  91 */         s = s + "|";
/*  92 */       s = s + WORDS_EQUALS[i];
/*     */     }
/*  94 */     s = s + ")([^a-zA-Z0-9]|\\z)))";
/*  95 */     p = ".*(" + p + ").*";
/*     */     
...
/*     */     
/* 100 */     for (int i = 0; i < FORBIDDEN_NAMES.length; i++)
/* 101 */       p = p + "|" + FORBIDDEN_NAMES[i];
/* 102 */     if (NAMES_STARTING_WITH.length > 0) {
/* 103 */       p = p + "|(";
/* 104 */       for (int i = 0; i < NAMES_STARTING_WITH.length; i++) {
/* 105 */         if (i > 0)
/* 106 */           p = p + "|";
/* 107 */         p = p + NAMES_STARTING_WITH[i];
/*     */       }
/* 109 */       p = p + ").*";
/*     */     }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\utils\WordsModerator.class
