...
/* 68 */       ret = ret + this.m_longValue + " (as int)";
/* 69 */     } else if (this.m_type == StatisticType.TYPE_LONG) {
/* 70 */       ret = ret + this.m_longValue + " (as long)";
/* 71 */     } else if (this.m_type == StatisticType.TYPE_FLOAT) {
/* 72 */       ret = ret + this.m_floatValue + " (as float)";
/*    */     }
/* 74 */     return ret;
/*    */   }
/*    */ }
...
/* Location:              C:\Users\flore\Desktop\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\statistics\StatisticsEntry.class
