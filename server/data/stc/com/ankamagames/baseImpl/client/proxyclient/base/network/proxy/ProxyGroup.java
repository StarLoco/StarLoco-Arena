...
/*  31 */     this.m_name = name;
/*  32 */     this.m_proxyAddresses = new ArrayList();
/*  33 */     this.m_usableProxyAddresses = new ArrayList();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*  75 */       return (ProxyAddress)this.m_usableProxyAddresses.remove(index);
/*     */     }
/*  77 */     return null;
/*     */   }
/*     */   
...
/*     */   {
/*  84 */     this.m_usableProxyAddresses = new ArrayList();
...
/*     */   {
/* 114 */     ArrayList<ProxyGroup> proxyGroups = new ArrayList();
/*     */     
/*     */     try
/*     */     {
...
/*     */       {
/*     */ 
/* 126 */         ProxyGroup univers = new ProxyGroup(i + 1, (String)universNames.get(i));
/*     */         
/*     */ 
/* 129 */         if (i < proxiesDefinitions.size()) {
/* 130 */           String[] proxyAddresses = (String[])proxiesDefinitions.get(i);
