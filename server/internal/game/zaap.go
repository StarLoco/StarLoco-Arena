...
// exists and a coach can be resolved to a clan. TODO(clan): when clans land, map
// clanID -> worldId and make the destination a dynamic lookup rather than this
// static map. Every clan world ships exactly one Zaap (world 102 has two); the
// full instanceId/cell/alt/payload table is recorded in docs/OVERWORLD-MAP.md
// under "Clan island Zaaps (for the future clan system)".
//
