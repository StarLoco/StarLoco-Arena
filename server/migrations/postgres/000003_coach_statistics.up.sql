...
ALTER TABLE coachs
    ...
    ADD COLUMN stat_fights INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN stat_wins INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN stat_losses INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN consecutive_wins INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN time_in_fight_secs BIGINT NOT NULL DEFAULT 0,
    ADD COLUMN total_play_time_secs BIGINT NOT NULL DEFAULT 0;
