...
class azv_0
extends uc_1 {
    public azv_0(LuaState luaState) {
        super(luaState);
    }
    ...
    public LX[] Q() {
        return new LX[]{new LX("dialogName", aos_1.elS, false), new LX("widgetId", aos_1.elS, false), new LX("enabled", aos_1.elV, false)};
    }
