...
public class aBK
extends uc_1 {
    private static final Logger a = Logger.getLogger(aBK.class);

    public aBK(LuaState luaState) {
        super(luaState);
    }
    ...
    protected void c(int n2) {
        ...
        if (bd_1.Is().bb(l2) != null) {
            jX.a(string, jJArray, new amd_0[0]);
        }
        bd_1.Is().b(new gh_2(this, l2, jX, string, jJArray));
    }
}
