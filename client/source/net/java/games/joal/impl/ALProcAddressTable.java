...
/*     */ 
/*     */ 
/*     */ public class ALProcAddressTable
/*     */ {
...
/* 145 */     String str = "_addressof_" + paramString;
/*     */     try {
/* 147 */       Field field = getClass().getField(str);
/* 148 */       return field.getLong(this);
/* 149 */     } catch (Exception exception) {
/*     */ 
/*     */       
/* 152 */       throw new RuntimeException("WARNING: Address query failed for \"" + paramString + "\"; it's either statically linked or is not a known " + "function", exception);
/*     */     } 
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\net\java\games\joal\impl\ALProcAddressTable.class
