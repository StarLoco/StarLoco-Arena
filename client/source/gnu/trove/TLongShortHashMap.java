...
/*     */   
/*     */   public Object clone() {
/* 114 */     TLongShortHashMap m = (TLongShortHashMap)super.clone();
/* 115 */     m._values = (short[])this._values.clone();
/* 116 */     return m;
/*     */   }
/*     */ 
/*     */ 
...
/* 123 */     return new TLongShortIterator(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 137 */     this._values = new short[capacity];
/* 138 */     return capacity;
/*     */   }
/*     */ 
/*     */ 
...
/* 248 */     if (!(other instanceof TLongShortHashMap)) {
/* 249 */       return false;
/*     */     }
/* 251 */     TLongShortHashMap that = (TLongShortHashMap)other;
...
/* 272 */       this.h += TLongShortHashMap.this._hashingStrategy.computeHashCode(key) ^ HashFunctions.hash(value);
/* 273 */       return true;
/*     */     }
/*     */     
...
/* 317 */     short[] vals = new short[size()];
/* 318 */     short[] v = this._values;
...
/* 493 */     return adjustValue(key, (short)1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 506 */       return false;
/*     */     }
/* 508 */     this._values[index] = (short)(this._values[index] + amount);
/* 509 */     return true;
/*     */   }
/*     */ 
/*     */ 
...
/* 529 */     if (index < 0) {
/* 530 */       index = -index - 1;
/* 531 */       newValue = this._values[index] = (short)(this._values[index] + adjust_amount);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\gnu\trove\TLongShortHashMap.class
