...
/*     */   
/*     */   public Object clone() {
/* 114 */     TIntIntHashMap m = (TIntIntHashMap)super.clone();
...
/* 123 */     return new TIntIntIterator(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 248 */     if (!(other instanceof TIntIntHashMap)) {
/* 249 */       return false;
/*     */     }
/* 251 */     TIntIntHashMap that = (TIntIntHashMap)other;
...
/* 272 */       this.h += TIntIntHashMap.this._hashingStrategy.computeHashCode(key) ^ HashFunctions.hash(value);
/* 273 */       return true;
/*     */     }
/*     */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\gnu\trove\TIntIntHashMap.class
