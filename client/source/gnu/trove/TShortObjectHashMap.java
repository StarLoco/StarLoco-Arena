...
/* 114 */     TShortObjectHashMap<V> m = (TShortObjectHashMap<V>)super.clone();
...
/* 123 */     return new TShortObjectIterator<V>(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 248 */     if (!(other instanceof TShortObjectHashMap)) {
/* 249 */       return false;
/*     */     }
/* 251 */     TShortObjectHashMap that = (TShortObjectHashMap)other;
...
/* 272 */       this.h += TShortObjectHashMap.this._hashingStrategy.computeHashCode(key) ^ HashFunctions.hash(value);
/* 273 */       return true;
/*     */     }
/*     */     
...
/*     */   
/*     */   public short[] keys() {
/* 335 */     short[] keys = new short[size()];
/* 336 */     short[] k = this._set;
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\gnu\trove\TShortObjectHashMap.class
