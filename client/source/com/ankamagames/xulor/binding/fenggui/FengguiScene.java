...
/*     */       }
/* 164 */       IBasicContainer iBasicContainer = widget.getParent();
/*     */     } 
/*     */ 
/*     */     
/* 168 */     return -1;
...
/* 179 */     if (element == null || !(element.getEncapsulatedObject() instanceof org.fenggui.Widget)) {
/* 180 */       return false;
/*     */     }
/*     */ 
/*     */ 
...
/*     */       
/* 260 */       RootContainer rootContainer = new RootContainer(RootContainer.RootContainerLevel.BOTTOM);
/* 261 */       rootContainer.setLayoutManager((LayoutManager)new StaticLayoutPlus());
/* 262 */       rootContainer.setSize(this.m_display.getWidth(), this.m_display.getHeight());
/* 263 */       rootContainer.setXY(0, 0);
/* 264 */       this.m_display.addWidget((IWidget)rootContainer);
/* 265 */       this.m_rootContainer = (IElement)new XInstanciatedContainer((Container)rootContainer);
/*     */       
/* 267 */       rootContainer = new RootContainer(RootContainer.RootContainerLevel.TOP);
/* 268 */       rootContainer.setLayoutManager((LayoutManager)new StaticLayoutPlus());
/* 269 */       rootContainer.setSize(this.m_display.getWidth(), this.m_display.getHeight());
/* 270 */       rootContainer.setXY(0, 0);
/* 271 */       this.m_display.addWidget((IWidget)rootContainer);
/* 272 */       this.m_onTopRootContainer = (IElement)new XInstanciatedContainer((Container)rootContainer);
/*     */       
/* 274 */       rootContainer = new RootContainer(RootContainer.RootContainerLevel.MSGBOX);
/* 275 */       rootContainer.setLayoutManager((LayoutManager)new StaticLayoutPlus());
/* 276 */       rootContainer.setSize(this.m_display.getWidth(), this.m_display.getHeight());
/* 277 */       rootContainer.setXY(0, 0);
/* 278 */       this.m_display.addWidget((IWidget)rootContainer);
/* 279 */       this.m_msgBoxRootContainer = (IElement)new XInstanciatedContainer((Container)rootContainer);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 295 */     this.m_display = new Display((Binding)new JOGLNoResizeBinding(canvas));
/*     */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\FengguiScene.class
