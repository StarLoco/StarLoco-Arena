...
/*  38 */     System.out.println("<button text=\"" + this.m_text + "\" image=\"" + this.m_pixmap + "\">"); byte b; int i; IElement[] arrayOfIElement1;
/*  39 */     for (i = (arrayOfIElement1 = components).length, b = 0; b < i; ) { IElement c = arrayOfIElement1[b];
/*  40 */       c.buildXML(); b++; }
/*     */     
...
/*     */ 
/*     */       
/*  67 */       if (this.m_parent != null) this.m_parent.addWidget((IElement)this);
/*     */       
/*  69 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_button, (IElement)this);
/*     */     }  byte b; int i;
/*     */     IElement[] arrayOfIElement;
/*  72 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement c = arrayOfIElement[b];
/*  73 */       c.buildGUI();
/*     */       b++; }
/*     */     
/*  76 */     applyTheme();
...
/* 125 */     return (Widget)this.m_button;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 154 */     copyElementData((IElement)elem);
/* 155 */     return (IElement)elem;
/*     */   }
/*     */   
...
/* 164 */     XComponent.applyThemeAttributes((Widget)button, element.getAttributes());
/* 165 */     XSpacingAppearance.setAppearance((StandardWidget)button, element);
/* 166 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 167 */     for (ThemeAppearance app : appearances) {
/* 168 */       if (app != null) {
/* 169 */         XDecoratorAppearance.setAppearance((StandardWidget)button, app);
/* 170 */         if (app instanceof ThemeLabelAppearance) {
/* 171 */           XLabelAppearance.setAppearance((StandardWidget)button, (ThemeLabelAppearance)app);
/*     */         }
/*     */       } 
/*     */     } 
/* 175 */     XObservableComponent.setAppearance((ObservableWidget)button);
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XButton.class
