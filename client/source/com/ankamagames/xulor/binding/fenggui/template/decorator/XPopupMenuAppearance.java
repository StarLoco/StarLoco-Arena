...
/*     */       
/*  59 */       if (theme == null) {
/*  60 */         ThemeWindowAppearance themeWindowAppearance = new ThemeWindowAppearance();
/*  61 */         themeWindowAppearance.setState(this.m_state);
/*  62 */         element.addThemeAppearance((ThemeAppearance)themeWindowAppearance);
/*     */       } 
/*     */       
...
/* 125 */     copyThemeAppearanceAttributes((ThemeAppearance)app);
/*     */   }
/*     */ 
/*     */   
...
/* 132 */     return (ThemeAppearance)app;
/*     */   }
/*     */   
...
/* 146 */         XLabel.applyLabelTheme((Label)widget, labelElement); continue;
/* 147 */       }  if (widget instanceof Button && buttonElement != null) {
/* 148 */         XButton.applyButtonTheme((Button)widget, buttonElement); continue;
/* 149 */       }  if (widget instanceof com.ankamagames.xulor.binding.fenggui.component.Separator && separatorElement != null)
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\decorator\XPopupMenuAppearance.class
