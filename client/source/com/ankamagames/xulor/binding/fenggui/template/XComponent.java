...
/*     */   protected boolean m_shrinkable = true;
/*  40 */   protected Dimension m_minSize = null;
/*     */   
/*     */   protected boolean m_usedInLayout = true;
/*     */   
/*     */   private boolean m_nonBlocking = false;
/*     */   
/*     */   private boolean m_nonBlockingInit = false;
/*     */   
/*     */   protected int m_x;
/*     */   protected int m_y;
/*     */   protected int m_width;
/*     */   protected int m_height;
/*     */   protected boolean m_xInit = false;
/*     */   protected boolean m_yInit = false;
/*     */   protected boolean m_heightInit = false;
/*     */   protected boolean m_widthInit = false;
/*  56 */   protected ThemeElement m_themeElement = null;
/*     */   protected boolean m_themeNeedToBeApplied = true;
...
/*     */   
/*     */   private boolean m_expandableInit = false, m_shrinkableInit = false;
/*     */   
/*     */   private boolean m_usedInLayoutInit = false;
...
/*     */   
/*     */   protected boolean m_addedToWidgetTree = false;
/*     */   
...
/* 262 */     if (widget != null && 
/* 263 */       widget.getParent() instanceof Container) {
/* 264 */       ((Container)widget.getParent()).setUsedInLayout((IWidget)widget, layouted);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */       return;
/*     */     }
/* 314 */     int minWidth = 10, minHeight = 10;
...
/*     */       }
/* 359 */       String themeClass = String.valueOf(getTag()) + newStyle;
/*     */       
...
/* 365 */         newStyle = "";
/*     */       }
/* 367 */       String themeClass = String.valueOf(getTag()) + newStyle;
...
/* 474 */         widget.getParent() instanceof Container) {
/* 475 */         ((Container)widget.getParent()).setUsedInLayout((IWidget)widget, this.m_usedInLayout);
/*     */       }
/*     */ 
/*     */       
...
/* 623 */       if (parent instanceof Container) {
/* 624 */         ((Container)parent).removeWidget((IWidget)widget);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 676 */       XComponent element = (XComponent)this.m_parent.getChild((IElement)this);
/* 677 */       if (element == null) {
/*     */         return;
/*     */       }
/* 680 */       Widget widget = element.getWidget();
/* 681 */       if (widget != null) {
/* 682 */         Container cont = (Container)widget.getParent();
/* 683 */         if (container != null) {
/* 684 */           cont.removeWidget((IWidget)element.getWidget());
/*     */         }
/*     */       } 
/* 687 */       if (element != null) {
/* 688 */         while (!(container instanceof com.ankamagames.xulor.template.IContainer)) {
/* 689 */           container = container.getParent();
/*     */         }
/* 691 */         container.add((IElement)element);
/*     */         
/* 693 */         if (container.getEncapsulatedObject() != null)
/* 694 */           container.addWidget((IElement)element); 
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XComponent.class
