...
/*  42 */     System.out.println("<progressbar>"); byte b; int i; IElement[] arrayOfIElement;
/*  43 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement c = arrayOfIElement[b];
/*  44 */       c.buildXML(); b++; }
/*     */     
...
/*     */       
/*  61 */       if (this.m_parent != null) this.m_parent.addWidget((IElement)this);
/*     */       
/*  63 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_progressBar, (IElement)this);
/*     */     }  byte b; int i;
/*     */     IElement[] arrayOfIElement;
/*  66 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement c = arrayOfIElement[b];
/*  67 */       c.buildGUI();
/*     */       b++; }
/*     */     
/*  70 */     applyTheme();
...
/* 147 */     return (Widget)this.m_progressBar;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 174 */     copyElementData((IElement)elem);
/* 175 */     return (IElement)elem;
/*     */   }
/*     */   
...
/* 184 */     XComponent.applyThemeAttributes((Widget)progressBar, element.getAttributes());
/* 185 */     XSpacingAppearance.setAppearance((StandardWidget)progressBar, element);
/* 186 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 187 */     for (ThemeAppearance app : appearances) {
/* 188 */       if (app != null) {
/* 189 */         XDecoratorAppearance.setAppearance((StandardWidget)progressBar, app);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XProgressBar.class
