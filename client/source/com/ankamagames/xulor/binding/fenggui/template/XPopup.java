...
/*     */       }
/*  44 */       if (elem != null) {
/*  45 */         this.m_popup.setClientWidget((IWidget)((XComponent)elem).getWidget());
/*     */       }
/*     */       
/*  48 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_popup, (IElement)this);
/*     */     }  byte b; int i;
/*     */     IElement[] arrayOfIElement;
/*  51 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement c = arrayOfIElement[b];
/*  52 */       c.buildGUI(); b++; }
/*     */     
/*  54 */     applyTheme();
/*     */   }
...
/* 158 */     return (IElement)popup;
/*     */   }
/*     */   
/*     */   protected void copyElementData(XPopup popup) {
/* 162 */     copyElementData(popup);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XPopup.class
