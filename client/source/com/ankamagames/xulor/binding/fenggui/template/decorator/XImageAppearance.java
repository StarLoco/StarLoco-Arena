...
/*  87 */     if (pixmap != null) {
/*  88 */       app.add((Switch)new SetPixmapSwitch(theme.getState(), pixmap));
/*     */     }
/*     */     
/*  91 */     Alignment alignment = FengguiConstant.toFengguiAlignment(theme.getAlignment());
/*  92 */     if (alignment != null) {
/*  93 */       app.add((Switch)new AlignmentSwitch(theme.getState(), alignment));
/*     */     }
/*     */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\decorator\XImageAppearance.class
