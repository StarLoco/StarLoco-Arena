...
/*     */   
/*  42 */   private ArrayList<SelectionChangedListener> m_scl = new ArrayList<SelectionChangedListener>();
/*     */   
...
/*  58 */     System.out.println("<checkbox text=\"" + this.m_text + "\"selected=\"" + this.m_selected + "\">"); byte b; int i; IElement[] arrayOfIElement1;
...
/*  83 */             SelectionChangedEvent event = new SelectionChangedEvent((IElement)XCheckBox.this.THIS, (ISelection)XCheckBox.this.THIS, selectionChangedEvent.isSelected(), null);
...
/*  92 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_checkbox, (IElement)this);
/*     */     }  byte b; int i;
/*     */     IElement[] arrayOfIElement;
/*  95 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement c = arrayOfIElement[b];
/*  96 */       c.buildGUI();
/*     */       b++; }
/*     */     
/*  99 */     applyTheme();
...
/* 225 */     copyElementData((IElement)elem);
/* 226 */     return (IElement)elem;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 234 */     return (Widget)this.m_checkbox;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 259 */     XComponent.applyThemeAttributes((Widget)checkbox, element.getAttributes());
/* 260 */     XSpacingAppearance.setAppearance((StandardWidget)checkbox, element);
/* 261 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 262 */     for (ThemeAppearance app : appearances) {
/* 263 */       if (app != null) {
/* 264 */         XDecoratorAppearance.setAppearance((StandardWidget)checkbox, app);
/* 265 */         if (app instanceof ThemeLabelAppearance) {
/* 266 */           XLabelAppearance.setAppearance((StandardWidget)checkbox, (ThemeLabelAppearance)app);
/*     */         }
/*     */       } 
/*     */     } 
/* 270 */     checkbox.setSelected(checkbox.isSelected());
/* 271 */     XObservableComponent.setAppearance((ObservableWidget)checkbox);
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XCheckBox.class
