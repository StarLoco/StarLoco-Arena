...
/*  42 */       ThemeDisplayObjectViewerAppearance themeDisplayObjectViewerAppearance; ThemeElement element = ((XComponent)this.m_parent).getThemeElement();
/*  43 */       if (element == null) {
/*     */         return;
/*     */       }
...
/*     */       
/*  48 */       if (theme == null) {
/*  49 */         themeDisplayObjectViewerAppearance = new ThemeDisplayObjectViewerAppearance();
/*  50 */         themeDisplayObjectViewerAppearance.setState(this.m_state);
/*  51 */         element.addThemeAppearance((ThemeAppearance)themeDisplayObjectViewerAppearance);
/*     */       } 
/*     */       
/*  54 */       applySpacingAttributes();
/*  55 */       applyDecoratorAttributes();
/*     */       
/*  57 */       if (themeDisplayObjectViewerAppearance instanceof ThemeDisplayObjectViewerAppearance) {
/*  58 */         ThemeLabelAppearance themeLabelAppearance = (ThemeLabelAppearance)themeDisplayObjectViewerAppearance;
/*     */       }
/*     */ 
/*     */       
...
/* 147 */     copyElementData((IElement)elem);
/* 148 */     return (IElement)elem;
/*     */   }
/*     */   
/*     */   protected void copyThemeAppearanceAttributes(ThemeDisplayObjectViewerAppearance app) {
/* 152 */     copyThemeAppearanceAttributes((ThemeAppearance)app);
/*     */   }
/*     */   
...
/* 158 */     return (ThemeAppearance)app;
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\decorator\XDisplayObjectViewerAppearance.class
