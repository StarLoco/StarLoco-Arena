...
/*  32 */     System.out.println("<listitem m_text=\"" + this.m_text + "\" value=\"" + this.m_value + "\"selected=\"" + this.m_selected + "\">"); byte b; int i; IElement[] arrayOfIElement;
...
/*     */       
/*  49 */       ListItem<Object> listItem = new ListItem(this.m_text, this.m_value);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  59 */         ((XAbstractList)this.m_parent).addItem(listItem); 
/*     */     }  byte b;
/*     */     int i;
...
/* 136 */     super.copyElementData((IElement)item);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 144 */     copyElementData((IElement)item);
/* 145 */     return (IElement)item;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XListItem.class
