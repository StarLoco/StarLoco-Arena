...
/*     */   protected boolean m_keepAspectRatio = true;
/*  40 */   protected Alignment m_align = null;
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   protected boolean m_scaledInit = false;
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   protected boolean m_keepAspectRatioInit = false;
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*  67 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_image, (IElement)this);
/*     */     }  byte b; int i;
/*     */     IElement[] arrayOfIElement;
/*  70 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement component = arrayOfIElement[b];
/*  71 */       component.buildGUI(); b++; }
/*     */     
/*  73 */     applyTheme();
/*     */   }
/*     */ 
...
/*     */     int i;
/*     */     IElement[] arrayOfIElement;
/* 123 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement component = arrayOfIElement[b];
...
/* 241 */     copyElementData((IElement)elem);
/* 242 */     return (IElement)elem;
/*     */   }
/*     */   
...
/* 251 */     XComponent.applyThemeAttributes((Widget)image, element.getAttributes());
/* 252 */     XSpacingAppearance.setAppearance((StandardWidget)image, element);
/* 253 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 254 */     for (ThemeAppearance app : appearances) {
/* 255 */       if (app != null) {
/* 256 */         XDecoratorAppearance.setAppearance((StandardWidget)image, app);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XImage.class
