...
/*     */   
/*     */   private boolean m_selectedInit = false;
/*  43 */   private ArrayList<SelectionChangedListener> m_scl = new ArrayList<SelectionChangedListener>();
/*     */   
...
/*  58 */     System.out.println("<radiobutton text=\"" + this.m_text + "\" value=\"" + this.m_value + "\" radioId=\"" + this.m_groupId + "\">"); byte b; int i; IElement[] arrayOfIElement;
...
/*  82 */             SelectionChangedEvent event = new SelectionChangedEvent((IElement)XRadioButton.this.THIS, (ISelection)new Togglable(selectionChangedEvent.getToggableWidget()), selectionChangedEvent.isSelected(), null);
...
/*     */       
/*  89 */       if (this.m_parent != null) this.m_parent.addWidget((IElement)this);
/*     */       
/*  91 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_radioButton, (IElement)this);
/*     */     }  byte b; int i;
/*     */     IElement[] arrayOfIElement;
/*  94 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement c = arrayOfIElement[b];
/*  95 */       c.buildGUI();
/*     */       b++; }
/*     */     
/*  98 */     applyTheme();
...
/* 190 */     return (Widget)this.m_radioButton;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 221 */     copyElementData((IElement)elem);
/* 222 */     return (IElement)elem;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 255 */     XComponent.applyThemeAttributes((Widget)radioButton, element.getAttributes());
/* 256 */     XSpacingAppearance.setAppearance((StandardWidget)radioButton, element);
/* 257 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 258 */     for (ThemeAppearance app : appearances) {
/* 259 */       if (app != null) {
/* 260 */         XDecoratorAppearance.setAppearance((StandardWidget)radioButton, app);
/* 261 */         if (app instanceof ThemeLabelAppearance) {
/* 262 */           XLabelAppearance.setAppearance((StandardWidget)radioButton, (ThemeLabelAppearance)app);
/*     */         }
/*     */       } 
/*     */     } 
/* 266 */     radioButton.setSelected(radioButton.isSelected());
/* 267 */     XObservableComponent.setAppearance((ObservableWidget)radioButton);
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XRadioButton.class
