...
/*  26 */   private Font m_font = null;
/*  27 */   private String m_title = null;
/*     */   
/*     */   public XTitledBorder() {
/*  30 */     this(Color.BLACK, new Font());
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/*     */   public XTitledBorder(Color c, Font font) {
/*  38 */     this.m_font = font;
...
/*  78 */     IElement[] components = getChildren(); byte b; int i;
/*     */     IElement[] arrayOfIElement1;
/*  80 */     for (i = (arrayOfIElement1 = components).length, b = 0; b < i; ) { IElement c = arrayOfIElement1[b];
/*  81 */       c.buildXML();
/*     */       b++; }
/*     */   
/*     */   }
...
/* 132 */     return (Border)this.m_titledBorder;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 161 */     copyElementData((IElement)elem);
/* 162 */     return (IElement)elem;
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 170 */     TitledBorder border = new TitledBorder(Font.getDefaultFont(), 
/* 171 */         theme.getTitle(), 
...
/* 187 */     return (ThemeBorder)border;
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\decorator\XTitledBorder.class
