...
/*  47 */           if (color != null) {
/*  48 */             TextStyle textStyle = new TextStyle(FengguiConstant.toFengguiFont(font), new Color(color.getRed(), color.getGreen(), color.getBlue()));
...
/*  68 */     System.out.println("<textview text=\"" + this.m_text + "\">"); byte b; int i; IElement[] arrayOfIElement;
...
/*     */       
/*  92 */       if (this.m_parent != null) this.m_parent.addWidget((IElement)this);
/*     */       
/*  94 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_textView, (IElement)this);
/*     */     }  byte b; int i;
/*     */     IElement[] arrayOfIElement;
/*  97 */     for (i = (arrayOfIElement = getChildren()).length, b = 0; b < i; ) { IElement c = arrayOfIElement[b];
/*  98 */       c.buildGUI();
/*     */       b++; }
/*     */     
/* 101 */     applyTheme();
...
/* 198 */     copyElementData((IElement)elem);
/* 199 */     return (IElement)elem;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 209 */     return (Widget)this.m_textView;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 228 */     XComponent.applyThemeAttributes((Widget)textView, element.getAttributes());
/* 229 */     XSpacingAppearance.setAppearance((StandardWidget)textView, element);
/* 230 */     ArrayList<ThemeAppearance> appearances = element.getAppearances();
/* 231 */     for (ThemeAppearance app : appearances) {
/* 232 */       if (app != null) {
/* 233 */         XDecoratorAppearance.setAppearance((StandardWidget)textView, app);
...
/*     */             } 
/*     */           } 
/* 243 */           XTextViewAppearance.setAppearance((TextView)textView, (ThemeTextViewAppearance)app);
/*     */         } 
/*     */       } 
/*     */     } 
/*     */     
/* 248 */     XObservableComponent.setAppearance((ObservableWidget)textView);
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XTextView.class
