...
/*  65 */       this.m_container = (Container)this.m_dragNDropContainer;
/*     */       
/*  67 */       applyAllAttributes();
/*     */       
/*  69 */       if (this.m_parent != null) this.m_parent.addWidget((IElement)this); 
/*  70 */       Xulor.getInstance().getEnvironment().putElementByWidget(this.m_dragNDropContainer, (IElement)this);
/*     */     }  byte b; int i;
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\template\XDNDContainer.class
