...
/*     */   
/*  44 */   private ArrayList<IElement> m_template = new ArrayList<IElement>();
/*  45 */   private ArrayList<XItem> m_items = new ArrayList<XItem>();
/*     */   private boolean m_neverRendered = true;
/*  47 */   private IElement m_dragNDropable = null;
/*  48 */   private String m_name = "default";
/*     */   private ResultProvider m_condition;
/*  50 */   private ArrayList<IProperty> m_properties = new ArrayList<IProperty>();
/*     */   
/*  52 */   private ArrayList<IActivationListener> m_al = new ArrayList<IActivationListener>();
/*  53 */   private ArrayList<IMouseClickListener> m_mcl = new ArrayList<IMouseClickListener>();
/*  54 */   private ArrayList<IMouseDoubleClickListener> m_mdcl = new ArrayList<IMouseDoubleClickListener>();
/*  55 */   private ArrayList<IFocusListener> m_fl = new ArrayList<IFocusListener>();
/*  56 */   private ArrayList<IKeyPressedListener> m_kpl = new ArrayList<IKeyPressedListener>();
/*  57 */   private ArrayList<IKeyReleasedListener> m_krl = new ArrayList<IKeyReleasedListener>();
/*  58 */   private ArrayList<IMouseDraggedListener> m_mdl = new ArrayList<IMouseDraggedListener>();
/*  59 */   private ArrayList<IMouseEnteredListener> m_mel = new ArrayList<IMouseEnteredListener>();
/*  60 */   private ArrayList<IMouseExitedListener> m_mexl = new ArrayList<IMouseExitedListener>();
/*  61 */   private ArrayList<IMouseMovedListener> m_mml = new ArrayList<IMouseMovedListener>();
/*  62 */   private ArrayList<IMousePressedListener> m_mpl = new ArrayList<IMousePressedListener>();
/*  63 */   private ArrayList<IMouseReleasedListener> m_mrl = new ArrayList<IMouseReleasedListener>();
/*  64 */   private ArrayList<IMouseWheelListener> m_mwl = new ArrayList<IMouseWheelListener>();
/*  65 */   private ArrayList<ItemOutListener> m_iol = new ArrayList<ItemOutListener>();
/*  66 */   private ArrayList<ItemOverListener> m_iovl = new ArrayList<ItemOverListener>();
/*  67 */   private ArrayList<ItemClickListener> m_icl = new ArrayList<ItemClickListener>();
/*  68 */   private ArrayList<ItemDoubleClickListener> m_idcl = new ArrayList<ItemDoubleClickListener>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 300 */     ArrayList<XElement> itemElements = new ArrayList<XElement>();
/* 301 */     this.m_dragNDropable = null;
/* 302 */     XRenderableContainer xRenderableContainer = renderable.getXRenderableContainer();
/*     */ 
/*     */     
...
/*     */       {
/*     */         
/* 314 */         property.removePropertyClient((IElement)xRenderableContainer);
/*     */       }
/* 316 */       iProperty.addPropertyClient((IElement)xRenderableContainer);
/*     */     } 
/*     */     
/* 319 */     addListeners(xRenderableContainer);
/*     */     
...
/* 325 */       renderable.addChild((IWidget)element.getEncapsulatedObject());
/*     */     } 
/*     */     
...
/*     */     } 
/*     */     
/* 333 */     renderable.setRenderableChildren(itemElements.<XElement>toArray(new XElement[0]));
...
/* 358 */       xDNDContainer = (XDNDContainer)element;
/*     */     } 
/*     */     
/* 361 */     if (element instanceof IComponent && xDNDContainer != null) {
/* 362 */       ((IComponent)element).setDragAndDropParent((IDragNDropable)xDNDContainer);
/*     */     }
/*     */     
/* 365 */     if (element instanceof IComponent)
/* 366 */       element.setRenderableParent(renderable);  byte b;
/*     */     int i;
/*     */     IElement[] arrayOfIElement;
/* 369 */     for (i = (arrayOfIElement = element.getChildren()).length, b = 0; b < i; ) { IElement child = arrayOfIElement[b];
/* 370 */       addElementAndItem(child, itemElements, renderable, (IDragNDropable)xDNDContainer, map);
/*     */       b++; }
/*     */   
/*     */   }
/*     */ 
...
/*     */     }
/*     */     
/* 386 */     XElement xElement = element;
/* 387 */     if (xElement != null) {
/* 388 */       DefaultFactory defaultFactory = new DefaultFactory(xElement.getClass());
/* 389 */       Method method = defaultFactory.guessSetter(attribute);
/*     */       try {
/* 391 */         MethodUtil.castInvokeWithItem(method, xElement, item, field, resultProvider);
/*     */       }
...
/*     */           return;
/*     */         }
/* 411 */         XItem xItem = this.m_items.get(i);
/* 412 */         if (xItem != null) {
/* 413 */           if (item != null) {
/*     */ 
/*     */ 
...
/* 451 */         if (itemFieldName != null) {
/* 452 */           byte b; int i; String[] arrayOfString; for (i = (arrayOfString = fields).length, b = 0; b < i; ) { String field = arrayOfString[b];
/* 453 */             if (itemFieldName.equalsIgnoreCase(field)) {
/* 454 */               contains = true; break;
/*     */             } 
/*     */             b++; }
/*     */         
/*     */         } else {
...
/* 566 */       renderer.add((IElement)properties);
/*     */     }
/* 568 */     copyElementData((IElement)renderer);
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\ItemRenderer.class
