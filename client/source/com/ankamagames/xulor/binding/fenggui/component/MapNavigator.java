...
/*  60 */   private final ArrayList<HitTestableMesh2D> m_meshes = new ArrayList<HitTestableMesh2D>();
/*  61 */   private final HashMap<String, BaseTexture> m_textures = new HashMap<String, BaseTexture>();
...
/*     */                 
/*  96 */                 HitTestableMesh2D point = MapNavigator.this.m_meshes.get(i);
/*     */                 
/*  98 */                 if (MapNavigator.this.haveToDisplay(xScreenItem, yScreenItem)) {
/*  99 */                   float width = 3.0F, height = 3.0F;
...
/*     */     
/* 126 */     this.m_scene.setPreRenderStates((GLRenderStates)new MapNavigatorScenePreRenderStates(null));
/* 127 */     this.m_scene.setPostRenderStates((GLRenderStates)new MapNavigatorScenePostRenderStates(null));
/*     */     
/* 129 */     this.m_scene.setInstancesInitialized(true);
/* 130 */     this.m_scene.setLoaded(true);
/* 131 */     this.m_scene.setCamera((GLMatrix)new Ortho2DScrollCamera());
/*     */ 
/*     */     
/* 134 */     setScene((Scene)this.m_scene);
/*     */   }
/*     */   
...
/*     */     
/* 242 */     this.m_scene.setCellHeight(43.0D * this.m_zoom * (this.m_isoMap ? true : 2));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 283 */     int startIndex = (items != null) ? items.length : 0; int i;
/* 284 */     for (i = startIndex; i < this.m_meshes.size(); i++) {
/* 285 */       ((HitTestableMesh2D)this.m_meshes.get(i)).release();
/* 286 */       this.m_meshes.remove(i);
/*     */     } 
/*     */ 
/*     */     
/* 290 */     for (i = this.m_meshes.size(); i < startIndex; i++) {
...
/* 302 */     BaseTexture texture = this.m_textures.get(path);
/* 303 */     if (texture == null) {
...
/*     */   }
/*     */   
/*     */   private class MapNavigatorScenePreRenderStates extends DefaultScenePreRenderStates {
/*     */     public void setup(GL gl) {
/* 317 */       super.setup(gl);
/* 318 */       gl.glEnable(5890);
/*     */     }
/*     */     private MapNavigatorScenePreRenderStates() {} }
...
/* 369 */         Xulor.getInstance().showTooltip(this.m_items[j].getValue().toString(), tooltipX, tooltipY, 2147483647, xOffset, yOffset);
/*     */         
/* 371 */         tooltip = true;
/*     */       } 
/* 373 */       j++;
...
/* 398 */         mcl.run((MouseClickEvent)new MapPointClickEvent((IComponent)Xulor.getInstance().getEnvironment().getElementByWidget(this), 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\MapNavigator.class
