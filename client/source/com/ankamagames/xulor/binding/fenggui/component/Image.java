...
/*     */   
/*     */   public Image() {
/*  40 */     this.m_appearance = new ImageAppearance((IWidget)this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public Image(String file, boolean scaled) throws IOException {
/*  54 */     this.m_scaled = scaled;
/*  55 */     setImage(file);
/*  56 */     this.m_appearance = new ImageAppearance((IWidget)this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  64 */     setPixmap(pixmap);
/*  65 */     this.m_appearance = new ImageAppearance((IWidget)this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 185 */           if (Image.this.m_keepAspectRatio) {
/*     */             int width, height;
/* 187 */             if (getContentWidth() != 0 && Image.this.m_pixmap.getWidth() != 0 && getContentHeight() != 0 && Image.this.m_pixmap.getHeight() != 0) {
...
/* 190 */               if (pixmapRatio == widgetRatio) {
/* 191 */                 width = getContentWidth();
/* 192 */                 height = getContentHeight();
/* 193 */               } else if (pixmapRatio > widgetRatio) {
/* 194 */                 width = getContentWidth();
/* 195 */                 height = (int)(width / pixmapRatio);
/*     */               } else {
/* 197 */                 height = getContentHeight();
/* 198 */                 width = (int)(height * pixmapRatio);
/*     */               } 
/*     */             } else {
/* 201 */               width = getContentWidth();
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\Image.class
