...
/*  35 */   private ArrayList<IMenuClosedListener> m_mcl = new ArrayList<IMenuClosedListener>();
...
/*  52 */           if ((e instanceof org.fenggui.event.mouse.MouseReleasedEvent || e instanceof org.fenggui.event.ButtonPressedEvent) && System.currentTimeMillis() - Popup.this.m_startTime > 100L) {
/*  53 */             Popup.this.hide();
/*     */           }
/*     */         }
/*     */       };
...
/*  71 */       display.addWidget((IWidget)this);
/*     */     }
/*  73 */     layout();
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/*     */   public Container.ContainerAppearance getAppearance() {
...
/* 218 */       int minWidth = 0, minHeight = 0;
/* 219 */       for (IWidget w : Popup.this.notifyList) {
...
/* 234 */         for (IWidget w : Popup.this.notifyList) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\binding\fenggui\component\Popup.class
