...
/*     */ 
/*     */   
/*  38 */   protected ArrayList<ShortcutGroup> m_shortcutGroups = new ArrayList<ShortcutGroup>();
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   public void loadFromXMLFile(String XMLFileName) throws Exception {
/* 105 */     XMLDocumentAccessor xMLDocumentAccessor = XMLDocumentAccessor.getInstance();
/* 106 */     DocumentContainer document = xMLDocumentAccessor.getNewDocumentContainer();
/*     */ 
/*     */     
/* 109 */     m_logger.info("Loading shortcuts file.");
/*     */ 
/*     */     
/* 112 */     xMLDocumentAccessor.open(XMLFileName);
/* 113 */     xMLDocumentAccessor.read(document);
/* 114 */     xMLDocumentAccessor.close();
/*     */ 
/*     */     
...
/* 133 */     for (DocumentEntry groupDoc : groupEntries) {
...
/*     */ 
/*     */       
/* 159 */       for (DocumentEntry d : shortcutsEntries) {
/*     */         
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\shortcuts\AbstractShortcutManager.class
