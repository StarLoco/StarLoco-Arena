...
/* 119 */     if (primitive.equals(boolean.class))
/* 120 */       return Boolean.class; 
/* 121 */     if (primitive.equals(double.class))
/* 122 */       return Double.class; 
/* 123 */     if (primitive.equals(float.class))
/* 124 */       return Float.class; 
/* 125 */     if (primitive.equals(short.class))
/* 126 */       return Short.class; 
/* 127 */     if (primitive.equals(int.class))
/* 128 */       return Integer.class; 
/* 129 */     if (primitive.equals(long.class))
/* 130 */       return Long.class; 
/* 131 */     if (primitive.equals(char.class))
/* 132 */       return Character.class; 
/* 133 */     if (primitive.equals(byte.class))
/* 134 */       return Byte.class; 
/* 135 */     if (primitive.equals(void.class)) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulo\\util\PrimitiveConverter.class
