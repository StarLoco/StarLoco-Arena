...
/*  74 */       for (int j = 0; j < parameters.size(); j++) {
/*  75 */         sb.append(parameters.get(j));
/*  76 */         if (j == parameters.size() - 1)
/*  77 */           break;  sb.append(", ");
/*     */       } 
...
/*     */ 
/*     */   
/*     */   public static void castInvokeWithItem(Factory factory, String attributeName, Object invoker, Item item, String field, ResultProvider resultProvider) throws Exception {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulo\\util\MethodUtil.class
