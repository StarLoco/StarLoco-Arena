...
/*     */   
/*     */   public static void format(IMessageBox messageBox, MessageBoxControler controler, String message, String title, int options) throws Exception {
...
/*     */ 
/*     */   
/*     */   private static IButton addButton(IButton modelButton, final MessageBoxControler controler, IContainer container, final int type) {
...
/* 136 */       button.setOnClick((IMouseClickListener)new MouseClickListener()
/*     */           {
/*     */             public void run(MouseClickEvent event) {
/* 139 */               controler.messageBoxClosed(type);
/*     */               
/* 141 */               Xulor.getInstance().unload(controler.getMessageBoxId());
/*     */             }
/*     */           });
/*     */ 
/*     */       
/* 146 */       container.add((IElement)button);
/*     */     }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\messagebox\MessageBoxFormater.class
