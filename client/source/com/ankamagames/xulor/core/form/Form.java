...
/*     */   
/*     */   public Form() {
/*  37 */     this.m_properties = new HashMap<String, Property>();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  66 */     return this.m_properties.get(name);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 134 */     Xulor.getInstance().getEnvironment().openForm(String.valueOf(this.m_elementMap.getId()) + "." + this.m_id, this); byte b; int i; IElement[] arrayOfIElement1;
/* 135 */     for (i = (arrayOfIElement1 = components).length, b = 0; b < i; ) { IElement c = arrayOfIElement1[b];
/* 136 */       c.buildGUI(); b++; }
/*     */     
/* 138 */     Xulor.getInstance().getEnvironment().closeForm(String.valueOf(this.m_elementMap.getId()) + "." + this.m_id);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 169 */     form.m_properties = (HashMap<String, Property>)this.m_properties.clone();
...
/* 179 */     copyElementData((IElement)form);
/* 180 */     return (IElement)form;
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\form\Form.class
