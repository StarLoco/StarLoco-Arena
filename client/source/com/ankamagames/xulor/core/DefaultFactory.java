...
/*  30 */   private final ArrayList<Method> m_setters = new ArrayList<Method>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  35 */   private final ArrayList<Method> m_getters = new ArrayList<Method>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  40 */   private final ArrayList<Method> m_prependers = new ArrayList<Method>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  45 */   private final ArrayList<Method> m_appenders = new ArrayList<Method>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  55 */   protected Class[] m_parameterPriority = new Class[] { Object.class, String.class, float.class, double.class, boolean.class, char.class, long.class, byte.class, int.class };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 141 */     return this.m_template.newInstance();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 153 */     Constructor[] ctors = (Constructor[])this.m_template.getConstructors();
...
/* 157 */         return ctors[i].newInstance(new Object[] { parameter });
/*     */       }
/*     */     } 
/* 160 */     return this.m_template.newInstance();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public T newInstance(Object[] parameter) throws InstantiationException, IllegalAccessException, InvocationTargetException {
/* 170 */     if (parameter != null) {
/* 171 */       Class[] pTypes = new Class[parameter.length];
/* 172 */       Constructor[] constructors = (Constructor[])this.m_template.getConstructors();
/* 173 */       Constructor<T> ctor = null;
/*     */       
/*     */       int i;
/*     */       
/* 177 */       for (i = 0; i < pTypes.length; i++) {
...
/*     */ 
/*     */       
/* 184 */       for (i = 0; ctor == null && i < constructors.length; i++) {
...
/* 233 */     Iterator<Method> it = this.m_setters.iterator();
/* 234 */     while (it != null && it.hasNext()) {
/* 235 */       Method m = it.next();
...
/* 341 */     Iterator<Method> it = methodsList.iterator();
/* 342 */     while (it != null && it.hasNext()) {
/* 343 */       Method m = it.next();
...
/* 363 */     Iterator<Method> it = methodsList.iterator();
/* 364 */     name = (String.valueOf(accessorId) + name).toLowerCase();
/* 365 */     while (it != null && it.hasNext()) {
/* 366 */       Method m = it.next();
...
/* 385 */     Iterator<Method> it = methodsList.iterator();
/* 386 */     name = (String.valueOf(accessorId) + name).toLowerCase();
/* 387 */     while (it != null && it.hasNext()) {
/* 388 */       Method m = it.next();
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\xulor\core\DefaultFactory.class
