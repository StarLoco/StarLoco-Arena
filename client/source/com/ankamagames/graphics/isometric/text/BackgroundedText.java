...
/*     */ 
/*     */   
/*     */   private boolean m_drawZoneActivated = false;
/*     */ 
/*     */ 
/*     */   
/*     */   public BackgroundedText(Font font) {
/*  68 */     this(font, false, (String)null, (DrawedBackground)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  78 */     this(font, antialiased, (String)null, (DrawedBackground)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  88 */     this(font, antialiased, text, (DrawedBackground)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  98 */     this(font, false, text, (DrawedBackground)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 200 */     float leftMargin = ((this.m_background != null) ? this.m_background.getLeftMargin() : false);
/* 201 */     float rightMargin = ((this.m_background != null) ? this.m_background.getRightMargin() : false);
/* 202 */     float topMargin = ((this.m_background != null) ? this.m_background.getTopMargin() : false);
/* 203 */     float bottomMargin = ((this.m_background != null) ? this.m_background.getBottomMargin() : false);
/*     */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\isometric\text\BackgroundedText.class
