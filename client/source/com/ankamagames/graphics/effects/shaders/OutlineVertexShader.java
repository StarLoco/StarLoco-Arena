...
/* 25 */     super("outline", "", 8);
/*    */     
/* 27 */     String fileName = String.valueOf(ShaderManager.getInstance().getShadersBaseDirectory()) + "outline/vs_";
/*    */     
/* 29 */     if (textureRectSupported) {
/* 30 */       fileName = String.valueOf(fileName) + "rect.cg";
/*    */     } else {
/* 32 */       fileName = String.valueOf(fileName) + "2D.cg";
/*    */     } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\graphics\effects\shaders\OutlineVertexShader.class
