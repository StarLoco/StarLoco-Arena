...
/*     */ {
/*  12 */   public static final float[] WhiteColor = new float[] { 1.0F, 1.0F, 1.0F, 1.0F };
/*  13 */   public static final float[] BlackColor = new float[] { 0.0F, 0.0F, 0.0F, 0.0F };
/*     */   
/*  15 */   protected float[] m_ambient = new float[] { 0.2F, 0.2F, 0.2F, 0.2F };
/*  16 */   protected float[] m_specular = new float[] { 0.0F, 0.0F, 0.0F, 0.0F };
/*  17 */   protected float[] m_emission = new float[] { 0.0F, 0.0F, 0.0F, 0.0F };
/*     */   
/*  19 */   protected float[] m_diffuseTopLeft = new float[] { 1.0F, 1.0F, 1.0F, 1.0F };
/*  20 */   protected float[] m_diffuseTopRight = new float[] { 0.5F, 0.5F, 0.5F, 1.0F };
/*  21 */   protected float[] m_diffuseBottomLeft = new float[] { 0.5F, 0.5F, 0.5F, 1.0F };
/*  22 */   protected float[] m_diffuseBottomRight = new float[] { 0.5F, 0.5F, 0.5F, 1.0F };
/*     */ 
/*     */   
...
/*     */   
/*     */   protected boolean m_isDefault = true;
/*     */   
/*     */   protected boolean m_ambientChanged = true;
/*     */   
/*     */   protected boolean m_diffuseChanged = true;
/*     */   
/*     */   protected boolean m_specularChanged = true;
/*     */   
/*     */   protected boolean m_emissionChanged = true;
/*     */ 
/*     */   
/*     */   public void reset() {
...
/*     */       
/*  57 */       this.m_ambient[3] = 0.2F; this.m_ambient[2] = 0.2F; this.m_ambient[1] = 0.2F; this.m_ambient[0] = 0.2F;
/*  58 */       this.m_specular[3] = 0.0F; this.m_specular[2] = 0.0F; this.m_specular[1] = 0.0F; this.m_specular[0] = 0.0F;
/*  59 */       this.m_emission[3] = 0.0F; this.m_emission[2] = 0.0F; this.m_emission[1] = 0.0F; this.m_emission[0] = 0.0F;
/*     */       
/*  61 */       this.m_diffuseTopLeft[2] = 1.0F; this.m_diffuseTopLeft[1] = 1.0F; this.m_diffuseTopLeft[0] = 1.0F; this.m_diffuseTopLeft[3] = 1.0F;
/*  62 */       this.m_diffuseTopRight[2] = 1.0F; this.m_diffuseTopRight[1] = 1.0F; this.m_diffuseTopRight[0] = 1.0F; this.m_diffuseTopRight[3] = 1.0F;
/*  63 */       this.m_diffuseBottomRight[2] = 1.0F; this.m_diffuseBottomRight[1] = 1.0F; this.m_diffuseBottomRight[0] = 1.0F; this.m_diffuseBottomRight[3] = 1.0F;
/*  64 */       this.m_diffuseBottomLeft[2] = 1.0F; this.m_diffuseBottomLeft[1] = 1.0F; this.m_diffuseBottomLeft[0] = 1.0F; this.m_diffuseBottomLeft[3] = 1.0F;
/*     */       
...
/* 252 */       this.m_ambient[0] = this.m_ambient[0] + r;
/* 253 */       this.m_ambient[1] = this.m_ambient[1] + g;
/* 254 */       this.m_ambient[2] = this.m_ambient[2] + b;
/* 255 */       this.m_ambient[3] = this.m_ambient[3] + a;
...
/* 263 */       this.m_diffuseTopLeft[0] = this.m_diffuseTopLeft[0] + r;
/* 264 */       this.m_diffuseTopLeft[1] = this.m_diffuseTopLeft[1] + g;
/* 265 */       this.m_diffuseTopLeft[2] = this.m_diffuseTopLeft[2] + b;
/* 266 */       this.m_diffuseTopLeft[3] = this.m_diffuseTopLeft[3] + a;
...
/* 274 */       this.m_diffuseBottomLeft[0] = this.m_diffuseBottomLeft[0] + r;
/* 275 */       this.m_diffuseBottomLeft[1] = this.m_diffuseBottomLeft[1] + g;
/* 276 */       this.m_diffuseBottomLeft[2] = this.m_diffuseBottomLeft[2] + b;
/* 277 */       this.m_diffuseBottomLeft[3] = this.m_diffuseBottomLeft[3] + a;
...
/* 285 */       this.m_diffuseTopRight[0] = this.m_diffuseTopRight[0] + r;
/* 286 */       this.m_diffuseTopRight[1] = this.m_diffuseTopRight[1] + g;
/* 287 */       this.m_diffuseTopRight[2] = this.m_diffuseTopRight[2] + b;
/* 288 */       this.m_diffuseTopRight[3] = this.m_diffuseTopRight[3] + a;
...
/* 296 */       this.m_diffuseBottomRight[0] = this.m_diffuseBottomRight[0] + r;
/* 297 */       this.m_diffuseBottomRight[1] = this.m_diffuseBottomRight[1] + g;
/* 298 */       this.m_diffuseBottomRight[2] = this.m_diffuseBottomRight[2] + b;
/* 299 */       this.m_diffuseBottomRight[3] = this.m_diffuseBottomRight[3] + a;
...
/* 307 */       this.m_specular[0] = this.m_specular[0] + r;
/* 308 */       this.m_specular[1] = this.m_specular[1] + g;
/* 309 */       this.m_specular[2] = this.m_specular[2] + b;
/* 310 */       this.m_specular[3] = this.m_specular[3] + a;
/* 311 */       this.m_isDefault = false;
/*     */     } 
/*     */   }
/*     */   public void addToEmission(float r, float g, float b, float a) {
/* 315 */     if (r != 0.0F || g != 0.0F || b != 0.0F || a != 0.0F) {
/* 316 */       this.m_emissionChanged = true;
/* 317 */       this.m_emission[0] = this.m_emission[0] + r;
/* 318 */       this.m_emission[1] = this.m_emission[1] + g;
/* 319 */       this.m_emission[2] = this.m_emission[2] + b;
/* 320 */       this.m_emission[3] = this.m_emission[3] + a;
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\opengl\base\material\Material.class
