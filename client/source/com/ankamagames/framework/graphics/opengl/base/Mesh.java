...
/*      */ 
/*      */   
/*   79 */   protected int m_glType = 4;
/*   80 */   protected BaseMaterial m_material = (BaseMaterial)new Material();
/*      */   
/*      */   protected boolean m_visible = true;
/*      */   protected boolean m_inheritVisibility = true;
/*      */   protected boolean m_effectEnabled = true;
/*   85 */   private ArrayList<BaseTexture> m_textures = new ArrayList<BaseTexture>();
/*   86 */   private ArrayList<BaseMaterial> m_materials = new ArrayList<BaseMaterial>();
/*   87 */   private ArrayList<GLMatrix> m_projectionMatrices = new ArrayList<GLMatrix>();
/*   88 */   private ArrayList<GLMatrix> m_modelViewMatrices = new ArrayList<GLMatrix>();
/*   89 */   private ArrayList<GLMatrix> m_textureMatrices = new ArrayList<GLMatrix>();
/*   90 */   protected ArrayList<GLObject> m_children = new ArrayList<GLObject>();
/*   91 */   private int m_childSelection = 0;
/*      */   
/*   93 */   protected GLObject m_parent = null; protected boolean m_materialChanged; protected FloatBuffer m_vertexBuffer; protected FloatBuffer m_vertexColorBuffer; protected FloatBuffer m_texCoordBuffer; protected ShortBuffer m_vertexIndexBuffer; protected int m_currentObjectIndex; private boolean m_initialized;
/*      */   private GLRenderStates m_preRenderStates;
/*      */   
/*      */   public BaseMaterial getMaterial() {
/*   97 */     return this.m_material;
/*      */   }
/*      */   private GLRenderStates m_postRenderStates; private boolean m_projectionMatrixSaved; private boolean m_modelviewMatrixSaved; private boolean m_textureMatrixSaved; private ViewPort m_viewport; private Effect m_effect; private int m_effectResult; private EffectContext m_effectContext;
/*      */   public void setMaterial(Material material) {
/*  101 */     if (this.m_material != material) {
/*  102 */       this.m_material = (BaseMaterial)material;
...
/*      */     
/*  114 */     this.m_material = (BaseMaterial)new Material();
/*  115 */     this.m_visible = true;
/*  116 */     this.m_inheritVisibility = true;
/*  117 */     this.m_effectEnabled = true;
/*      */     
/*  119 */     this.m_textures = new ArrayList<BaseTexture>();
/*  120 */     this.m_materials = new ArrayList<BaseMaterial>();
/*  121 */     this.m_projectionMatrices = new ArrayList<GLMatrix>();
/*  122 */     this.m_modelViewMatrices = new ArrayList<GLMatrix>();
/*  123 */     this.m_textureMatrices = new ArrayList<GLMatrix>();
/*  124 */     this.m_children = new ArrayList<GLObject>();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  218 */       return this.m_textures.get(0);
/*      */     }
/*  220 */     return null;
/*      */   }
/*      */   
...
/*  318 */     applyMaterial();
/*      */     int i;
/*  320 */     for (i = 0; i < this.m_textures.size(); i++) {
...
/*      */       } 
/*      */     } else {
/*  372 */       drawPrimitives(gl);
/*  373 */       for (i = 0; i < this.m_children.size(); i++) {
...
/*  484 */       return this.m_materials.remove(0);
/*      */     }
/*  486 */     return null;
/*      */   }
/*      */ 
...
/*  496 */       return this.m_materials.remove(this.m_materials.size() - 1);
/*      */     }
/*  498 */     return null;
/*      */   }
/*      */ 
...
/*  547 */       return this.m_textures.remove(0);
/*      */     }
/*  549 */     return null;
/*      */   }
/*      */ 
...
/*  559 */       return this.m_textures.remove(this.m_textures.size() - 1);
/*      */     }
/*  561 */     return null;
/*      */   }
/*      */ 
...
/*  703 */       return null;
/*      */     }
/*  705 */     return this.m_children.get(this.m_childSelection);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  714 */     this.m_childSelection++;
/*      */     
/*  716 */     if (this.m_childSelection >= this.m_children.size()) {
/*  717 */       return null;
/*      */     }
/*  719 */     return this.m_children.get(this.m_childSelection);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  729 */     this.m_childSelection--;
/*  730 */     if (this.m_childSelection < 0) {
/*  731 */       return null;
/*      */     }
/*  733 */     return this.m_children.get(this.m_childSelection);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  767 */       return this.m_children.get(index);
/*      */     }
/*  769 */     return null;
/*      */   }
/*      */ 
...
/*      */         break;
/*      */       case 5888:
/*  949 */         if (!this.m_modelViewMatrices.isEmpty()) {
...
/*      */         break;
/*      */       case 5890:
/*  957 */         if (!this.m_textureMatrices.isEmpty()) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\opengl\base\Mesh.class
