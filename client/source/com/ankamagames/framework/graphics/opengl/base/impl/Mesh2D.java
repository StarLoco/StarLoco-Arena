...
/*     */     
/*  93 */     pushMatrixBack((GLMatrix)this.m_position, 5888);
/*  94 */     pushMatrixBack((GLMatrix)this.m_rotateSkew, 5888);
/*  95 */     pushMatrixBack((GLMatrix)this.m_rotation, 5888);
/*  96 */     pushMatrixBack((GLMatrix)this.m_scaling, 5888);
/*  97 */     pushMatrixBack((GLMatrix)this.m_hotCenter, 5888);
/*     */ 
/*     */     
/* 100 */     this.m_glType = 5;
/*     */     
...
/* 253 */     Mesh2DManager.getInstance().tagResourceInUse((ManageableResource)this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 406 */     pushMatrixBack((GLMatrix)this.m_transformation, 5888);
/* 407 */     pushMatrixBack((GLMatrix)this.m_scaling, 5888);
/* 408 */     pushMatrixBack((GLMatrix)this.m_hotCenter, 5888);
/* 409 */     pushMatrixBack((GLMatrix)this.m_offset, 5888);
/*     */   }
/*     */   
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\opengl\base\impl\Mesh2D.class
