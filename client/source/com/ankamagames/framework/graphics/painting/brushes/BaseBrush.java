/*     */ package com.ankamagames.framework.graphics.painting.brushes;public class BaseBrush {
...
/*  41 */     create(radius);
/*     */   }
/*     */   protected BaseBrush(int radiusX, int radiusY) {
/*  44 */     create(radiusX, radiusY);
/*     */   }
...
/*     */     } 
/*     */   }
/*     */   public BaseBrush(int radiusX, int radiusY, List<int[]> coords) {
/*  54 */     create(radiusX, radiusY);
/*  55 */     setDatas(coords);
/*     */   }
/*     */ 
/*     */ 
...
/* 150 */       this.m_datas[coord[0] + this.m_sizeX][coord[1] + this.m_sizeY] = true;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 247 */         int x; switch (resizeStyleY) {
/*     */           case null:
/*     */           case REPEAT:
/*     */           case MIRROR:
/* 251 */             for (x = 0; x < this.m_sizeX; x++) {
...
/*     */ 
/*     */       
/* 343 */       int left = 0, right = this.m_sizeX, top = 0, bottom = this.m_sizeY;
...
/*     */       
/* 364 */       boolean[][] data = this.m_datas; int i;
/* 365 */       for (i = 0; i < this.m_sizeX; i++) {
...
/* 404 */             this.m_datas[i][j] = this.m_datas[i][j] | brush.m_datas[x][y]; 
/*     */         }  
/*     */     } 
/*     */   }
/*     */   
...
/* 434 */             this.m_datas[i][j] = this.m_datas[i][j] | brush.m_datas[x][y]; 
/*     */         }  
/*     */     } 
/*     */   }
/*     */   
...
/* 465 */             this.m_datas[i][j] = this.m_datas[i][j] & brush.m_datas[x][y];
/*     */           }
/*     */         }  
/*     */     } 
/* 469 */     this.m_optimized = false;
/*     */   }
/*     */   public void intersection(BaseBrush brush) {
/* 472 */     intersection(brush, 0, 0);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 495 */             this.m_datas[i][j] = this.m_datas[i][j] & (!brush.m_datas[x][y]);
/*     */           }
/*     */         }  
/*     */     } 
/* 499 */     this.m_optimized = false;
/*     */   }
/*     */   public void difference(BaseBrush brush) {
/* 502 */     difference(brush, 0, 0);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 511 */         this.m_datas[x][y] = !this.m_datas[x][y];
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 653 */             sb.append(' ');
/*     */           } else {
/* 655 */             sb.append(this.m_datas[x][y] ? 88 : 45);
/* 656 */           }  sb.append(")");
/*     */         } else {
/*     */           
/* 659 */           sb.append(" ");
...
/* 661 */             sb.append(' ');
/*     */           } else {
/* 663 */             sb.append(this.m_datas[x][y] ? 88 : 45);
/*     */           } 
/* 665 */           sb.append(" ");
/*     */         } 
/*     */       } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\painting\brushes\BaseBrush.class
