...
/*    */     
/* 25 */     String fileName = String.valueOf(ShaderManager.getInstance().getShadersBaseDirectory()) + "coloration/ps_";
/*    */     
/* 27 */     if (texture2D) {
/* 28 */       fileName = String.valueOf(fileName) + "2D.cg";
/*    */     } else {
/* 30 */       fileName = String.valueOf(fileName) + "rect.cg";
/*    */     } 
...
/*    */   }
/*    */   public void setAddTermColor(float[] addTerm) {
/* 58 */     CgGL.cgGLSetParameter4fv(this.m_addTerm, addTerm, 0);
/*    */   }
/*    */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\effects\shaders\ColorationPixelShader.class
