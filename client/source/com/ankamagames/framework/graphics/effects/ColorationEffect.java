...
/*     */     
/*     */     try {
/*  61 */       ShaderManager.getInstance().enablePixelShader((ShaderProgram)this.m_psRect);
/*  62 */       this.m_psRect.unbind();
/*  63 */       ShaderManager.getInstance().enablePixelShader((ShaderProgram)this.m_ps2D);
...
/*     */         }  }
/* 115 */       else { m_logger.trace("colorPS null"); }
/*     */     
/*     */     } else {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\effects\ColorationEffect.class
