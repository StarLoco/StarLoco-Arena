...
/* 34 */     this.m_reader = new TagDocumentReader(null, (TagDecoder)APSTagDecoder.getInstance(), m_documentFactory);
/*    */   }
/*    */   
...
/*    */ 
/*    */   
/*    */   public APSDocument getDocument(String fileName) throws Exception {
...
/* 67 */       System.out.println("Le fichier " + file.getName() + " n'est pas a jour (version: " + doc.getVersion() + " courante: " + '\002');
/*    */     }
/* 69 */     return doc;
/*    */   }
/*    */ 
...
/*    */ 
/*    */   
/*    */   public APSDocument getDocument(InputStream stream) throws Exception {
/* 79 */     this.m_reader.create(stream, (TagDecoder)APSTagDecoder.getInstance(), m_documentFactory);
/*    */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\aps\APSDocumentManager.class
