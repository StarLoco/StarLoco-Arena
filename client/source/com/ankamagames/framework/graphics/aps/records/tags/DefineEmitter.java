...
/*     */     
/*  75 */     this.m_tags = new ArrayList<Tag>();
/*  76 */     for (ParticleModel p : emitter.getParticlesModel()) {
/*     */       
/*  78 */       if (p instanceof ParticleBitmapModel) {
/*     */         
/*  80 */         this.m_tags.add(new DefineParticleBitmapModel((ParticleBitmapModel)p)); continue;
/*     */       } 
/*  82 */       if (p instanceof ParticleSequenceModel)
/*     */       {
...
/*  91 */         this.m_tags.add(new DefineAttractionForce((AttractionForce)affector)); continue;
/*  92 */       }  if (affector instanceof ColorFader) {
/*  93 */         this.m_tags.add(new DefineColorFader((ColorFader)affector)); continue;
/*  94 */       }  if (affector instanceof Deformer) {
/*  95 */         this.m_tags.add(new DefineDeformer((Deformer)affector)); continue;
/*  96 */       }  if (affector instanceof LinearForce) {
/*  97 */         this.m_tags.add(new DefineLinearForce((LinearForce)affector)); continue;
/*  98 */       }  if (affector instanceof FrictionalForce) {
/*  99 */         this.m_tags.add(new DefineFrictionalForce((FrictionalForce)affector)); continue;
/* 100 */       }  if (affector instanceof RotorForce) {
/* 101 */         this.m_tags.add(new DefineRotorForce((RotorForce)affector)); continue;
/* 102 */       }  if (affector instanceof DirectionFollower) {
...
/*     */     
/* 155 */     this.m_tags = new ArrayList<Tag>();
/*     */     while (true) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\aps\records\tags\DefineEmitter.class
