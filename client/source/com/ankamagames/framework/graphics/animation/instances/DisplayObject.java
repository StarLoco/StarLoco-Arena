...
/*     */ 
/*     */ public abstract class DisplayObject extends AnimatedObject implements Poolable {
...
/* 132 */       this.m_controlers = new ArrayList<AnimatedObjectControler>();
/*     */     }
...
/* 297 */         this.m_mesh.pushMatrixFront((GLMatrix)transformer.getMesh().getPositionMatrix(), 5888);
/* 298 */         if (transformer.getMesh().getTransformation() != null) {
/* 299 */           this.m_mesh.pushMatrixFront((GLMatrix)transformer.getMesh().getTransformation(), 5888);
/*     */         }
/*     */       } else {
...
/* 367 */       parent.addChild((GLObject)this.m_mesh);
...
/* 379 */       parent.removeChild((GLObject)this.m_mesh);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\animation\instances\DisplayObject.class
