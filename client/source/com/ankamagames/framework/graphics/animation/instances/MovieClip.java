...
/*     */   
/*     */   public MovieClip() {
/*  60 */     this.m_children = new ArrayList<DisplayObject>();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*  71 */     this.m_children = new ArrayList<DisplayObject>();
/*     */     
...
/*     */     
/* 108 */     this.m_children = new ArrayList<DisplayObject>();
...
/* 208 */       BaseDescriptorLibrary baseDescriptorLibrary = descriptor.getLibrary();
/*     */     } else {
...
/*     */       
/* 234 */       for (int i = frameDescr.size(); --i >= 0; ) {
/* 235 */         DisplayObject displayObject; iterator.advance();
/* 236 */         FrameDataDescriptor data = (FrameDataDescriptor)iterator.value();
/*     */         
/* 238 */         if (data.hasCharacterId()) {
/*     */           
...
/*     */         } 
/*     */         
/* 250 */         this.m_frames[frameIndex].put(data.getDepth(), displayObject);
/*     */       } 
/*     */     } else {
...
/*     */ 
/*     */           
/* 291 */           currentChild.removeMeshFrom((Mesh)this.m_mesh);
/*     */           
...
/* 330 */             currentChild.process((Mesh)this.m_mesh, deltaTime, recurs + 1);
/* 331 */             currentChild.attachMeshTo((Mesh)this.m_mesh);
/*     */             
/* 333 */             HitTestableMesh2D hitTestableMesh2D = currentChild.getMesh();
/* 334 */             if (hitTestableMesh2D.getMaterial().useSpecular() && hitTestableMesh2D.getTexture() != null) {
/* 335 */               Effect colorationEffect = EffectManager.getInstance().getEffect("coloration");
/* 336 */               hitTestableMesh2D.setEffect(colorationEffect, false);
/* 337 */               if (colorationEffect != null)
/*     */               {
/*     */                 
/* 340 */                 ((ColorationEffect.ColorationEffectContext)hitTestableMesh2D.getEffectContext()).setMesh((Mesh)hitTestableMesh2D);
/*     */               }
/*     */             }
/* 343 */             else if (hitTestableMesh2D.getEffect() != null) {
/* 344 */               hitTestableMesh2D.setEffect(null, false);
/*     */             } 
/*     */           } 
/*     */         } 
/*     */       } 
...
/*     */           }
/* 360 */           for (int j = lastFrame + 1; j <= this.m_currentFrameIndex; j++) {
/* 361 */             List<String> actions = descriptor.getActionsAt(j);
...
/*     */           }
/*     */           
/* 371 */           int frameCount = descriptor.getFrameCount(); int j;
/* 372 */           for (j = lastFrame + 1; j < frameCount; j++) {
/* 373 */             List<String> actions = descriptor.getActionsAt(j);
/* 374 */             if (actions != null && actions.size() > 0) {
/* 375 */               doAction(actions);
/*     */             }
/*     */           } 
/* 378 */           for (j = 0; j <= this.m_currentFrameIndex; j++) {
/* 379 */             List<String> actions = descriptor.getActionsAt(j);
...
/* 520 */     if (this.m_frames != null) {
/* 521 */       byte b; int i; Frame[] arrayOfFrame; for (i = (arrayOfFrame = this.m_frames).length, b = 0; b < i; ) { Frame frame = arrayOfFrame[b];
/* 522 */         if (frame != null)
/* 523 */           frame.release(); 
/*     */         b++; }
/*     */       
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\animation\instances\MovieClip.class
