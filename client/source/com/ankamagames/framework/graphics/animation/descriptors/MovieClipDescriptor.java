...
/*     */ {
/*  27 */   private static final ObjectPool m_pool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<MovieClip>() {
...
/*     */     
/*  82 */     for (Tag tag : tags) {
/*     */       short duration; PlaceObject placeObject; RemoveObject obj; ActionFlag flag; int depth; FrameDataDescriptor oldFrameDataDescr;
/*  84 */       switch (tag.getCode()) {
/*     */         
/*     */         case 1:
/*  87 */           duration = (short)((ShowFrame)tag).getDuration();
/*  88 */           if (duration != -1) {
...
/*     */         
/*     */         case 5:
/* 105 */           placeObject = (PlaceObject)tag;
/* 106 */           depth = placeObject.getDepth();
/* 107 */           oldFrameDataDescr = null;
/* 108 */           if (this.m_framesData[frame].containsDataAt(depth))
/*     */           {
/*     */             
/* 111 */             oldFrameDataDescr = this.m_framesData[frame - 1].getDataAt(depth);
/*     */           }
/* 113 */           this.m_framesData[frame].setAt(depth, new FrameDataDescriptor(placeObject, oldFrameDataDescr));
/*     */           continue;
/*     */ 
/*     */         
/*     */         case 6:
/* 118 */           obj = (RemoveObject)tag;
...
/*     */     MovieClip movieClip;
/*     */     try {
/* 159 */       movieClip = (MovieClip)m_pool.borrowObject();
...
/*     */     
/* 223 */     if (this.m_framesData != null) {
/* 224 */       byte b; int i; FrameDescriptor[] arrayOfFrameDescriptor; for (i = (arrayOfFrameDescriptor = this.m_framesData).length, b = 0; b < i; ) { FrameDescriptor frame = arrayOfFrameDescriptor[b];
/* 225 */         frame.dispose(); b++; }
/*     */       
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\animation\descriptors\MovieClipDescriptor.class
