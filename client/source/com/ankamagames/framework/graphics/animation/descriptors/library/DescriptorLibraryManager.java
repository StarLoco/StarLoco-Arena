...
/*     */ 
/*     */   
/*  40 */   private final HashMap<String, BaseDescriptorLibrary> m_descriptorLibraries = new HashMap<String, BaseDescriptorLibrary>(30);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  55 */     super(new ResourceFactory<BaseDescriptorLibrary>() { public BaseDescriptorLibrary makeObject() { return new BaseDescriptorLibrary(); } }, new ContextFactory<BaseDescriptorLibrary.BaseDescriptorLibraryContext>() { public BaseDescriptorLibrary.BaseDescriptorLibraryContext makeObject() { return new BaseDescriptorLibrary.BaseDescriptorLibraryContext(); } }, true);
/*     */     
...
/*  95 */       library = this.m_descriptorLibraries.get(fileName);
...
/* 212 */     BaseDescriptorLibrary library = this.m_descriptorLibraries.remove(libContext.getFileName());
/*     */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\animation\descriptors\library\DescriptorLibraryManager.class
