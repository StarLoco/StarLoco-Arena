...
/*     */ {
/*  28 */   private static final ObjectPool m_pool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<BitmapSequence>() {
...
/*  84 */       if (duration != -1) {
/*  85 */         this.m_frameTime[i] = this.m_frameTime[i] + ((i == 0) ? 0 : this.m_frameTime[i - 1]);
/*     */       }
...
/*     */     try {
/* 128 */       bitmapSequence = (BitmapSequence)m_pool.borrowObject();
...
/*     */     } 
/* 133 */     return (DisplayObject)bitmapSequence;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (this.m_framesData != null) {
/* 168 */       byte b; int i; BitmapDescriptor[] arrayOfBitmapDescriptor; for (i = (arrayOfBitmapDescriptor = this.m_framesData).length, b = 0; b < i; ) { BitmapDescriptor frameData = arrayOfBitmapDescriptor[b];
/* 169 */         frameData.unloadResource(null); b++; }
/*     */       
...
/* 185 */     super.onCheckIn();
/* 186 */     if (this.m_framesData != null) {
/* 187 */       byte b; int i; BitmapDescriptor[] arrayOfBitmapDescriptor; for (i = (arrayOfBitmapDescriptor = this.m_framesData).length, b = 0; b < i; ) { BitmapDescriptor frameData = arrayOfBitmapDescriptor[b];
/* 188 */         frameData.unloadResource(null); b++; }
/*     */       
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\animation\descriptors\BitmapSequenceDescriptor.class
