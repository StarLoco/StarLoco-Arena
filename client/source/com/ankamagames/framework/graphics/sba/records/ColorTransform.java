...
/* 274 */     if (color.getRedAddTerm() == this.m_redAddTerm && 
/* 275 */       color.getGreenAddTerm() == this.m_greenAddTerm && 
/* 276 */       color.getBlueAddTerm() == this.m_blueAddTerm && 
/* 277 */       color.getAlphaAddTerm() == this.m_alphaAddTerm && 
/* 278 */       color.getRedMultTerm() == this.m_redMultTerm && 
/* 279 */       color.getGreenMultTerm() == this.m_greenMultTerm && 
/* 280 */       color.getBlueMultTerm() == this.m_blueMultTerm && 
/* 281 */       color.getAlphaMultTerm() == this.m_alphaMultTerm) return true; 
/*     */     return false;
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\sba\records\ColorTransform.class
