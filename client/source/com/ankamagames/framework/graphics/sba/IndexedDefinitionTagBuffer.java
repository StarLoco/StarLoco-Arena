...
/*     */ 
/*     */   
/*  46 */   private final HashMap<String, Integer> m_linkageDictionary = new HashMap<String, Integer>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  61 */   private static final TagDecoder m_lightDecoder = (TagDecoder)new SBADefinitionTagDecoder();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  66 */   private static final TagDecoder m_decoder = (TagDecoder)new SBATagDecoder();
/*     */   
...
/* 122 */     if (linkage != null) {
/* 123 */       Integer value = this.m_linkageDictionary.get(linkage);
/* 124 */       if (value != null)
...
/*     */       
/* 176 */       m_logger.warn("Attention!! IndexedDefinitionTagBuffer version obsolète:" + this.m_version + "  courante:" + '\003');
/*     */       
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\graphics\sba\IndexedDefinitionTagBuffer.class
