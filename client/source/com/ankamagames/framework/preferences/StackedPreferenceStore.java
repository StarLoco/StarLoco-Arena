...
/*     */ {
/*  16 */   private final ArrayList<PreferenceStore> m_children = new ArrayList<PreferenceStore>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  41 */     String[] propertyList = preferenceStore.getPropertyList(); byte b; int i; String[] arrayOfString1;
/*  42 */     for (i = (arrayOfString1 = propertyList).length, b = 0; b < i; ) { String property = arrayOfString1[b];
...
/*     */ 
/*     */     
/*  58 */     String[] propertyList = preferenceStore.getPropertyList(); byte b; int i; String[] arrayOfString1;
/*  59 */     for (i = (arrayOfString1 = propertyList).length, b = 0; b < i; ) { String property = arrayOfString1[b];
...
/*  76 */         PreferenceStore preferenceStore = this.m_children.get(i);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\preferences\StackedPreferenceStore.class
