...
/*     */   
/*  24 */   private final ArrayList<MessageFrame> m_frames = new ArrayList<MessageFrame>();
/*  25 */   private final ArrayList<MessageFrame> m_framesToRemoveBefore = new ArrayList<MessageFrame>();
/*  26 */   private final ArrayList<MessageFrame> m_framesToAddBefore = new ArrayList<MessageFrame>();
/*  27 */   private final ArrayList<MessageFrame> m_framesToRemoveAfter = new ArrayList<MessageFrame>();
/*  28 */   private final ArrayList<MessageFrame> m_framesToAddAfter = new ArrayList<MessageFrame>();
/*     */ 
/*     */   
...
/*     */       } 
/* 231 */       if (frames != null)
/* 232 */         synchronized (this.m_framesToRemoveAfter) {
/* 233 */           byte b; int i; Object[] arrayOfObject; for (i = (arrayOfObject = frames).length, b = 0; b < i; ) { Object frameObject = arrayOfObject[b];
...
/* 244 */         for (MessageFrame frame : this.m_frames)
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\FrameHandler.class
