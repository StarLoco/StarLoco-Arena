...
/*     */     
/*  56 */     this.m_dataSource = (DataSource)source;
/*  57 */     this.m_channels = new ArrayList<SqlRequestChannel>();
...
/*     */       
/*  73 */       channel.setExternalName(String.valueOf(this.m_externalName) + "_" + i);
/*     */       
...
/*     */       } 
/*     */     } else {
/* 102 */       preferedChannel = this.m_channels.get(preferedChannelId);
/*     */     } 
/*     */     
...
/*     */     try {
/* 122 */       SqlRequestChannel channel = this.m_channels.get(channelIndex);
...
/* 180 */       pendingRequests[i] = ((SqlRequestChannel)this.m_channels.get(i)).getPendingRequestsCount(); byte b; int j, arrayOfInt[];
/* 181 */       for (j = (arrayOfInt = pendingRequests).length, b = 0; b < j; ) { int c = arrayOfInt[b];
/* 182 */         System.err.print(String.valueOf(c) + " - "); b++; }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\SqlDatabase.class
