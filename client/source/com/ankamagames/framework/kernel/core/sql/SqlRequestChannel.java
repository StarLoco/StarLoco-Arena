...
/*  88 */         this.m_pendingRequestsCount++;
...
/*     */ 
/*     */   
/*     */   private SqlRequest getNextRequest() throws Exception {
...
/* 123 */         this.m_pendingRequestsCount--;
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 238 */             this.m_numRaisedExceptions++;
/*     */           }
...
/* 242 */             this.m_numRaisedExceptions++;
/*     */           } 
/*     */           continue;
/*     */         } 
/* 246 */         if (this.m_connection != null && !this.m_connection.isClosed() && 
...
/* 265 */       this.m_numRaisedExceptions++;
/*     */     } 
/*     */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\core\sql\SqlRequestChannel.class
