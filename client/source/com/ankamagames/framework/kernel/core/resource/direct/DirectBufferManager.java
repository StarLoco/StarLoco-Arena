...
/*  29 */     this.m_pool = (KeyedObjectPool)new StackKeyedObjectPool(new DirectBufferFactory());
...
/* 169 */       String stats = String.valueOf(getClass().getName()) + " statistics : \n";
/* 170 */       int totalBytes = 0;
/*     */       
/* 172 */       stats = String.valueOf(stats) + "\tout=" + this.m_pool.getNumActive() + ", in=" + this.m_pool.getNumIdle();
/*     */ 
/*     */       
/* 175 */       return stats;
/*     */     } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\core\resource\direct\DirectBufferManager.class
