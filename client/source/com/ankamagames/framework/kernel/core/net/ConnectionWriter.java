...
/*  39 */     setName("ConnectionWriter");
/*  40 */     this.m_connectionValidatorPool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ConnectionValidatorPoolFactory());
/*  41 */     this.m_validators = new TLinkedList();
/*  42 */     this.m_connectionsRequestingWrite = new ArrayList<Connection>();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 101 */               Iterator<ConnectionValidator> it = this.m_validators.iterator();
/* 102 */               if (it.hasNext()) {
/* 103 */                 validator = it.next();
/* 104 */                 this.m_connectionsRequestingWrite.remove(validator.getItem());
/* 105 */                 it.remove();
/*     */               } 
/*     */             } else {
...
/* 128 */           m_logger.error(ExceptionFormatter.toString(ex)); break;
/*     */         }  }
/*     */     
/*     */     } 
