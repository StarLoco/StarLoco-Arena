...
/* 146 */       direction = Direction8.NORTH;
/* 147 */     } else if (a <= 1.9634954084936207D && a >= 1.1780972450961724D) {
/* 148 */       direction = Direction8.NORTH_EAST;
/* 149 */     } else if (a <= 1.1780972450961724D && a >= 0.39269908169872414D) {
/* 150 */       direction = Direction8.EAST;
/* 151 */     } else if (a <= 0.39269908169872414D && a >= -0.39269908169872414D) {
/* 152 */       direction = Direction8.SOUTH_EAST;
/* 153 */     } else if (a <= -0.39269908169872414D && a >= -1.1780972450961724D) {
/* 154 */       direction = Direction8.SOUTH;
/* 155 */     } else if (a <= -1.1780972450961724D && a >= -1.9634954084936207D) {
/* 156 */       direction = Direction8.SOUTH_WEST;
/* 157 */     } else if (a <= -1.9634954084936207D && a >= -2.748893571891069D) {
...
/* 184 */       direction = Direction8.NORTH_EAST;
/* 185 */     } else if (a <= 0.7853981633974483D && a >= -0.7853981633974483D) {
/* 186 */       direction = Direction8.SOUTH_EAST;
/* 187 */     } else if (a <= -0.7853981633974483D && a >= -2.356194490192345D) {
...
/*     */   
/*     */   public int hashCode() {
/* 205 */     assert false : "Il n'est pas prévu que ces objets comparables servent de clef dans une HashTable/HashMap.";
/* 206 */     return super.hashCode();
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\core\maths\Vector3i.class
