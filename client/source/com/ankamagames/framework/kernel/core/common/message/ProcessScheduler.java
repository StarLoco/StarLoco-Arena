...
/*     */   }
/*     */   
/*     */   private final ArrayList<ScheduledProcess> m_processesToReschedule;
/*     */   private final ArrayList<ScheduledProcess> m_processes;
/*     */   private final Object m_processesMutex;
/*     */   private final Object m_processesToRescheduleMutex;
/*     */   
/*     */   private ProcessScheduler() {
/*  31 */     this.m_processesToReschedule = new ArrayList<ScheduledProcess>();
/*  32 */     this.m_processes = new ArrayList<ScheduledProcess>();
/*     */     
/*  34 */     this.m_processesMutex = new Object();
/*  35 */     this.m_processesToRescheduleMutex = new Object();
/*     */   }
...
/*  64 */       while (it.hasNext()) {
/*  65 */         ScheduledProcess process = it.next();
...
/*  76 */       while (it.hasNext()) {
/*  77 */         ScheduledProcess process = it.next();
...
/*  94 */         ScheduledProcess scheduledProcess = this.m_processes.get(i);
...
/* 132 */           reschedule(this.m_processesToReschedule.get(i), referenceTime); 
...
/* 140 */         ScheduledProcess scheduledProcess = it.next();
/*     */         
...
/* 174 */           reschedule(this.m_processesToReschedule.get(i), referenceTime);
/*     */         }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\core\common\message\ProcessScheduler.class
