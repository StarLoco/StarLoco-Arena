...
/*  63 */     this.m_clockMessagePool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<ClockMessage>() { public ClockMessage makeObject() {
/*  64 */             return new ClockMessage();
/*     */           } }
/*     */       );
/*     */   }
/*     */ 
...
/*  86 */       for (SchedulerListener objListener : this.m_listeners) {
/*  87 */         SchedulerListener listener = objListener;
...
/* 116 */     listener.setup((Validable)messageHandler);
...
/* 159 */       Iterator<SchedulerListener> it = this.m_listeners.iterator();
/* 160 */       while (it.hasNext()) {
/* 161 */         SchedulerListener listener = it.next();
...
/* 194 */       Iterator<SchedulerListener> it = this.m_listeners.iterator();
/* 195 */       while (it.hasNext()) {
/* 196 */         SchedulerListener listener = it.next();
...
/* 212 */       Iterator<SchedulerListener> it = this.m_listeners.iterator();
/* 213 */       while (it.hasNext()) {
/* 214 */         SchedulerListener listener = it.next();
...
/*     */   
/*     */   public void run() {
/* 271 */     ArrayList<SchedulerListener> m_listenersToReschedule = new ArrayList<SchedulerListener>();
/*     */     
...
/* 289 */               SchedulerListener listener = it.next();
/*     */               
...
/* 297 */                     m_listenersToReschedule.add(listener);  continue;
/*     */                 } 
/* 299 */                 it.remove();
/*     */                 continue;
/*     */               } 
/* 302 */               if (m_listenersToReschedule.isEmpty()) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\kernel\core\common\message\scheduler\MessageScheduler.class
