...
/* 174 */     long longBits = (buffer[3] << 56L) + ((buffer[2] & 0xFF) << 48L) + ((buffer[1] & 0xFF) << 40L) + ((
/* 175 */       buffer[0] & 0xFF) << 32L) + ((buffer[7] & 0xFF) << 24L) + ((buffer[6] & 0xFF) << 16) + ((
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\fileFormat\io\InputBitStream.class
