...
/*     */ 
/*     */   
/*     */   protected abstract void run(int paramInt) throws LuaException;
/*     */ 
/*     */ 
/*     */   
/*     */   protected int checkParam() throws LuaException {
...
/*     */ 
/*     */   
/*     */   private int checkParamCount(int paramCountMin, int paramCountMax) throws LuaException {
/*     */     String msg;
...
/*     */     }
/* 126 */     else if (paramCountMax == Integer.MAX_VALUE) {
...
/*     */     } 
/*     */     
/* 132 */     throw new LuaException(String.valueOf(getName()) + ": nombre de paramètre incorrect " + msg);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   private boolean checkDefinitionParamType(int i, LuaScriptParameterType type) throws LuaException {
...
/* 153 */         String msg = String.format(String.valueOf(getName()) + ": mauvais type d'argument #%d: (definition: %s, fonction: %s)", new Object[] { Integer.valueOf(i), definitionType, type });
...
/*     */ 
/*     */   
/*     */   public Object[] getParams(int begin, int end) throws LuaException {
...
/*     */ 
/*     */   
/*     */   public int getParamInt(int i) throws LuaException {
/* 196 */     if (checkDefinitionParamType(i, LuaScriptParameterType.INTEGER) && 
/* 197 */       !this.L.isNumber(i + 2)) {
/* 198 */       throw new LuaException(String.valueOf(getName()) + ": Argument #" + i + " n'est pas un entier.(lu:" + this.L.typeName(i + 2) + ")");
/*     */     }
/*     */     
...
/*     */ 
/*     */   
/*     */   public double getParamDouble(int i) throws LuaException {
/* 214 */     if (checkDefinitionParamType(i, LuaScriptParameterType.NUMBER) && 
/* 215 */       this.L.isNumber(i + 2)) {
/* 216 */       return this.L.toNumber(i + 2);
/*     */     }
/*     */     
/* 219 */     throw new LuaException(String.valueOf(getName()) + ": Argument #" + i + " n'est pas un decimal.(lu:" + this.L.typeName(i + 2) + ")");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public String getParamString(int i) throws LuaException {
/* 232 */     if (checkDefinitionParamType(i, LuaScriptParameterType.STRING) && 
/* 233 */       this.L.isString(i + 2)) {
/* 234 */       return this.L.toString(i + 2);
/*     */     }
/*     */     
/* 237 */     throw new LuaException(String.valueOf(getName()) + ": Argument #" + i + " n'est pas une chaine de caractere." + this.L.typeName(i + 2) + ")");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   protected LuaScript getScriptObject(LuaState L) throws LuaException {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\framework\script\JavaFunctionEx.class
