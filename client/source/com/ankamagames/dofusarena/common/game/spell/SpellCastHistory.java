...
/*     */ {
/*  23 */   private final HashMap<AbstractSpell, Integer> m_spellsCasted = new HashMap<AbstractSpell, Integer>();
/*     */ 
/*     */ 
/*     */   
/*  27 */   private final HashMap<AbstractSpell, Integer> m_spellsCastedThisTurn = new HashMap<AbstractSpell, Integer>();
/*     */ 
/*     */ 
/*     */   
/*  31 */   private final HashMap<Long, Integer> m_spellsCastedThisTurnOnTarget = new HashMap<Long, Integer>();
/*     */ 
/*     */   
/*     */   public void reset() {
...
/*  50 */       Integer castsCount = this.m_spellsCastedThisTurn.get(spell);
...
/*  59 */       Integer castsCount = this.m_spellsCastedThisTurnOnTarget.get(Long.valueOf(hash));
...
/*  75 */       Integer lastCastTime = this.m_spellsCasted.get(spell);
...
/*  86 */       Integer castsCount = this.m_spellsCastedThisTurn.get(spell);
...
/*  94 */       Integer castsCount = this.m_spellsCastedThisTurnOnTarget.get(Long.valueOf(hash));
...
/* 104 */     return spell.getId() << 32L | HashFunctions.hash(target);
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\spell\SpellCastHistory.class
