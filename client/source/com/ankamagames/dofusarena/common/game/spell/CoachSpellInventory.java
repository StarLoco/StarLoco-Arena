...
/*    */     try {
/* 34 */       this.m_spellInventory.add((InventoryContent)spell);
/* 35 */       return true;
/* 36 */     } catch (InventoryCapacityReachedException e) {
/* 37 */       m_logger.error("impossible d'ajouter ce sort : inventaire plein");
/* 38 */     } catch (ContentAlreadyPresentException e) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\spell\CoachSpellInventory.class
