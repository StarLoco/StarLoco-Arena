...
/*     */ 
/*     */ public abstract class AbstractFight<F extends AbstractFighter> extends AbstractTurnBasedFight<F> implements EffectExecutionListener, TimeEventListener {
...
/* 122 */     super.onFighterJoinFight((BasicFighter)f);
/*     */   }
/*     */   
/*     */   public void onFighterStartTurn(F fighter) {
/* 126 */     fighter.getCharacteristic((CharacteristicType)FighterCharacteristicType.AP).toMax();
/* 127 */     fighter.getCharacteristic((CharacteristicType)FighterCharacteristicType.MP).toMax();
/* 128 */     super.onFighterStartTurn((BasicFighter)fighter);
/*     */   }
/*     */ 
/*     */   
/*     */   public void onFighterDeath(F f) {
/* 133 */     super.onFighterDeath((BasicFighter)f);
/*     */     
/* 135 */     for (Iterator<? extends EffectUser> it = getEffectUsers(); it.hasNext(); ) {
/* 136 */       EffectUser user = it.next();
/*     */       
/* 138 */       if (user.getRunningEffectManager() != null) {
/* 139 */         user.getRunningEffectManager().removeLinkedToCaster((EffectUser)f);
/*     */       }
/*     */     } 
/*     */ 
/*     */     
/* 144 */     getTimeline().removeFighter((BasicFighter)f);
/*     */   }
/*     */   
...
/*     */ 
/*     */     
/* 250 */     if (spell.getActionPoints() > fighter.getCharacteristic((CharacteristicType)FighterCharacteristicType.AP).value()) {
...
/* 261 */       int poBoost = fighter.getCharacteristicValue((CharacteristicType)FighterCharacteristicType.RANGE);
/* 262 */       int distanceMin = spell.getRangeMin();
/* 263 */       int distanceMax = spell.getRangeMax();
/*     */       
...
/*     */       }
/*     */       
/* 277 */       AbstractFighter target = (AbstractFighter)getTargetOnPosition(targetCell);
/*     */       
...
/*     */ 
/*     */       
/* 284 */       SpellCastValidity validity = fighter.getSpellCastHistory().canCastSpell(spell, getTimeline().getCurrentTableturn(), (Target)target);
/* 285 */       if (!validity.isValid()) {
/* 286 */         return validity;
/*     */       }
/*     */       
/* 289 */       if (spell.hasToTestLineOfSight()) {
/* 290 */         if (!LineOfSightUtils.check(fighter, this.m_cellInformationProvider, (LineOfSightObstacleInformationProvider)this, fighter.getPosition(), targetCell, null)) {
...
/* 294 */             if (!LineOfSightUtils.check(fighter, this.m_cellInformationProvider, (LineOfSightObstacleInformationProvider)this, headPosition, targetCell, null)) {
...
/*     */       
/* 325 */       AbstractFighter target = (AbstractFighter)getTargetOnPosition(targetCell);
/* 326 */       if (target != null) {
...
/*     */             break;
/*     */           } 
/* 333 */           switch (eff.getTargetValidator().getTargetValidity((Target)target, (Target)fighter)) {
/*     */             case VALID:
...
/* 343 */             if (sre != null && sre.getRunningEffectStatus() == RunningEffectStatus.POSITIVE) {
/* 344 */               switch (eff.getTargetValidator().getTargetValidity((Target)target.getCarriedFighter(), (Target)fighter)) {
/*     */                 case VALID:
/*     */                 case VALID_IF_IN_AOE:
...
/*     */ 
/*     */     
/* 372 */     if (card.getActionPoints() > fighter.getCharacteristic((CharacteristicType)FighterCharacteristicType.AP).value()) {
...
/*     */       }
/*     */       
/* 405 */       AbstractFighter target = (AbstractFighter)getTargetOnPosition(targetCell);
/*     */       
...
/* 413 */         if (!LineOfSightUtils.check(fighter, this.m_cellInformationProvider, (LineOfSightObstacleInformationProvider)this, fighter.getPosition(), targetCell, null)) {
...
/*     */     }
/*     */     
/* 432 */     if (b.getCloseCombatAp() > fighter.getCharacteristic((CharacteristicType)FighterCharacteristicType.AP).value()) {
...
/* 468 */       AbstractFighter abstractFighter = (AbstractFighter)it.next();
/* 469 */       Point3 fPos = abstractFighter.getPosition();
/* 470 */       if (pos.getX() == fPos.getX() && pos.getY() == fPos.getY() && 
/* 471 */         fPos.getZ() <= pos.getZ() && fPos.getZ() + abstractFighter.getHeight() >= pos.getZ() && 
/* 472 */         !abstractFighter.isCarried()) {
/* 473 */         return (F)abstractFighter;
/*     */       }
/*     */     } 
/*     */     
/* 477 */     return null;
...
/* 484 */     this.m_context = (EffectContext)ArenaEffectContext.checkOut(this);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\fight\AbstractFight.class
