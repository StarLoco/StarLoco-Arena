...
/*     */ {
/*  29 */   private static final ObjectPool m_staticPool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<Rapprochement>() {
...
/*     */     Rapprochement re;
/*     */     try {
/*  41 */       re = (Rapprochement)m_staticPool.borrowObject();
...
/*     */     Rapprochement re;
/*     */     try {
/*  67 */       re = (Rapprochement)m_staticPool.borrowObject();
...
/*  92 */         hpLoss.execute((RunningEffect)null, false);
/*     */       }
/*     */     
/*     */     } else {
/*     */       
...
/* 130 */     if (this.m_caster instanceof com.ankamagames.dofusarena.common.game.fighter.AbstractFighter) {
/*     */ 
/*     */       
...
/*     */       int cellsCount;
/* 149 */       for (cellsCount = 0; cellsCount < this.m_value; cellsCount++) {
...
/* 164 */             (PathFindMover)this.m_caster, 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\effect\runningEffect\Rapprochement.class
