...
/*     */ {
/*  21 */   private static final ObjectPool m_staticPool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<HPGain>() {
...
/*     */     HPGain re;
/*     */     try {
/*  35 */       re = (HPGain)m_staticPool.borrowObject();
...
/*     */       case 1:
/*  64 */         if (!set) {
/*  65 */           this.m_value = (int)(this.m_value + howMuchToUpate); break;
/*     */         } 
...
/*  79 */       AbstractCharacteristic charac = this.m_target.getCharacteristic((CharacteristicType)FighterCharacteristicType.HP);
/*     */ 
/*     */       
...
/* 100 */         this.m_value = 0; break;
/*     */     } 
/* 102 */     float value = this.m_value;
/* 103 */     if (this.m_caster != null && this.m_caster.hasCharacteristic((CharacteristicType)FighterCharacteristicType.HEAL)) {
/* 104 */       value *= (100 + this.m_caster.getCharacteristicValue((CharacteristicType)FighterCharacteristicType.HEAL)) / 100.0F;
/*     */     }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\effect\runningEffect\HPGain.class
