...
/*    */ {
/* 20 */   private static final ObjectPool m_staticPool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<SummonMirror>() { public SummonMirror makeObject() {
/* 21 */           return new SummonMirror();
/*    */         } }
/*    */     );
/*    */ 
/*    */   
...
/*    */     SummonMirror re;
/*    */     try {
/* 32 */       re = (SummonMirror)m_staticPool.borrowObject();
...
/* 51 */       this.m_target = (EffectUser)((AbstractFighter)this.m_caster).summonMirror(this.m_newTargetId, this.m_targetCell, this.m_value);
/*    */     } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\effect\runningEffect\SummonMirror.class
