...
/* 65 */       return (count == 0);  byte b; int i; int[] arrayOfInt;
/* 66 */     for (i = (arrayOfInt = this.m_paramsCount).length, b = 0; b < i; ) { int counts = arrayOfInt[b];
/* 67 */       if (counts == count) return true;  b++; }
/*    */     
/* 69 */     return false;
/*    */   }
/*    */ }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\effect\RunningEffectDefinition.class
