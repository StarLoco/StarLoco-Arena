...
/*     */       return;
/*     */     } 
/* 134 */     m_logger.error("Impossible d'ajouter un effet pour la carte " + this.m_id + " : type de parent invalide : " + effect.getContainerType()); } public void addEffects(Effect[] effects) {
/*     */     byte b;
/*     */     int i;
/*     */     Effect[] arrayOfEffect;
/* 138 */     for (i = (arrayOfEffect = effects).length, b = 0; b < i; ) { Effect e = arrayOfEffect[b];
/* 139 */       addEffect(e);
/*     */       b++; }
/*     */   
...
/* 147 */     return (Iterator<Effect>)new MergedIterator(new Iterator[] { this.m_useTimeEffects.iterator(), this.m_equippementTimeEffects.iterator() });
/*     */   }
/*     */   
...
/* 159 */     return (Iterable<Effect>)this.m_equippementTimeEffects;
/*     */   }
/*     */   
/*     */   public Iterable<Effect> effectsAtUseTimeIterator() {
/* 163 */     return (Iterable<Effect>)this.m_useTimeEffects;
/*     */   }
/*     */   
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\card\AbstractFighterCard.class
