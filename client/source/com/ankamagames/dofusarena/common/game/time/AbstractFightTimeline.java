...
/* 120 */     if (super.startFighterTurn((BasicFighter)fighter)) {
/* 121 */       startTurnClock();
/* 122 */       return true;
/*     */     } 
/* 124 */     return false;
...
/* 206 */         if (ordered) {
/* 207 */           int init = fighterToAdd.getCharacteristicValue((CharacteristicType)FighterCharacteristicType.INIT);
/* 208 */           for (AbstractFighter abstractFighter : this.m_orderedFigthers) {
/* 209 */             int currentInit = abstractFighter.getCharacteristicValue((CharacteristicType)FighterCharacteristicType.INIT);
...
/* 223 */         for (AbstractFighter abstractFighter : this.m_orderedFigthers) {
/*     */           
/* 225 */           if (fatherFound && !abstractFighter.isSummoned()) {
/*     */             break;
/*     */           }
/* 228 */           if (!fatherFound && fighterToAdd.getFather() == abstractFighter) {
...
/* 237 */         if (index == this.m_orderedFigthers.size()) {
/* 238 */           addLast = true;
/*     */           
/* 240 */           abstractFighter = this.m_orderedFigthers.get(this.m_orderedFigthers.size() - 1);
/*     */         }
/*     */         else {
/*     */           
/* 244 */           abstractFighter = this.m_orderedFigthers.get(index);
/*     */         } 
/*     */ 
/*     */         
/* 248 */         List<TimeEvent<TurnBasedTimeUnit, TurnBasedTimeInterval>> lte = filter((Filter)new FighterTurnTimeEventFilter(abstractFighter));
/* 249 */         if (lte.size() > 0) {
/* 250 */           TurnBasedTimeUnit tu = (TurnBasedTimeUnit)((TimeEvent)lte.get(0)).when();
/*     */           
/* 252 */           addFighterTimeEventAt((BasicFighter)fighterToAdd, tu.getTableTurn(), tu.getTurn() + (addLast ? 1 : 0));
/*     */         } else {
...
/*     */     } 
/*     */     
/* 261 */     onFighterAdded((BasicFighter)fighterToAdd);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 300 */           askForFighterEndTurn(getCurrentFighter()); break;
/*     */         } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\time\AbstractFightTimeline.class
