...
/*     */ 
/*     */   
/*     */   protected boolean m_checkin = false;
/*     */ 
/*     */ 
/*     */   
/*     */   public boolean isCheckin() {
/*  92 */     return this.m_checkin;
/*     */   }
/*     */ 
/*     */   
...
/* 142 */     this.m_properties.reset(); } protected AbstractFighter() {
/*     */     byte b;
/*     */     int i;
/*     */     FighterCharacteristicType[] arrayOfFighterCharacteristicType;
/* 146 */     for (i = (arrayOfFighterCharacteristicType = FighterCharacteristicType.values()).length, b = 0; b < i; ) { FighterCharacteristicType c = arrayOfFighterCharacteristicType[b];
...
/* 312 */     int diceLimit = getCharacteristicValue((CharacteristicType)FighterCharacteristicType.CRITICAL_RATE);
...
/* 321 */     int diceLimit = getCharacteristicValue((CharacteristicType)FighterCharacteristicType.FUMBLE_RATE);
/* 322 */     return (diceLimit > 0 && DiceRoll.roll(100) <= diceLimit);
/*     */   }
/*     */   
/*     */   public void setTeamMate(TeamMate<? extends AbstractFighter> teamMate) {
...
/*     */     } 
/* 380 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.HP).setMax(breed.getBaseHp());
/* 381 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.MP).setMax(breed.getBaseMp());
/* 382 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.AP).setMax(breed.getBaseAp());
/* 383 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.INIT).setMax(breed.getBaseInit());
/* 384 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.AP).toMax();
/* 385 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.HP).toMax();
/* 386 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.MP).toMax();
/* 387 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.INIT).toMax();
/* 388 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.CRITICAL_RATE).set(breed.getBaseCH());
/* 389 */     getCharacteristic((CharacteristicType)FighterCharacteristicType.FUMBLE_RATE).set(breed.getBaseCM());
/*     */   }
/*     */   
...
/* 455 */     return (getCurrentFight() != null && getCharacteristic((CharacteristicType)FighterCharacteristicType.HP).isZero());
/*     */   }
/*     */   
...
/* 463 */     if (!getProperties().isActiveProperty((PropertyType)FighterPropertyType.INVISIBLE)) {
/* 464 */       return true;
/*     */     }
/* 466 */     return false;
/*     */   }
...
/* 486 */     this.m_specialEventListener = (FighterSpecialEventListener)fight;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 564 */       computeValue();
/*     */     }
/* 566 */     catch (BufferUnderflowException e) {
...
/*     */     EffectContextForUniqueEffectUser effectContextForUniqueEffectUser;
/* 604 */     if (card == null) {
/*     */       return;
/*     */     }
/*     */     
/* 608 */     if (getCurrentFight() != null) {
/* 609 */       EffectContext context = getCurrentFight().getContext();
/*     */     } else {
/* 611 */       effectContextForUniqueEffectUser = new EffectContextForUniqueEffectUser((EffectUser)this);
/*     */     } 
/* 613 */     for (Effect effect : card.effectsAtEquippementTimeIterator()) {
/* 614 */       effect.execute((EffectContainer)card, (EffectUser)this, (EffectContext)effectContextForUniqueEffectUser, (Constants)RunningEffectConstants.getInstance(), getPosition());
/*     */     }
/*     */   }
/*     */   
...
/* 619 */     if (card == null)
/*     */       return; 
/* 621 */     getRunningEffectManager().removeLinkedToContainer((EffectContainer)card);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\common\game\fighter\AbstractFighter.class
