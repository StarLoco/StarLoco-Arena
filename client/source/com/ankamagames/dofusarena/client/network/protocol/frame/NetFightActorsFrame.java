...
/*  49 */     return m_instance; } public boolean onMessage(Message message) {
/*     */     ActorAppearMessage actorAppearMessage;
/*     */     ActorDisapearMessage actorDisapearMessage;
/*     */     ActorRepositionMessage actorRepositionMessage;
/*     */     ActorMovementMessage actorMovementMessage;
/*     */     ActorTeleportsMessage msg;
/*     */     Fight fight1;
...
/*     */       
/*     */       case 4102:
/*  61 */         actorAppearMessage = (ActorAppearMessage)message;
/*     */         
/*  63 */         fight1 = DofusArenaGameEntity.getInstance().getFight();
/*  64 */         if (fight1 != null) {
/*  65 */           Iterable<FightingTeam<Fighter>> teams = fight1.getTeams();
/*  66 */           Iterable<ActorAppearMessage.CharacterAppearInformation> actorsInformations = actorAppearMessage.getCharacterInformations();
/*  67 */           for (ActorAppearMessage.CharacterAppearInformation actorInformations : actorsInformations) {
/*  68 */             Coach coach; Actor actor = null;
/*  69 */             Fighter fighter = (Fighter)fight1.getFighterById(actorInformations.getId());
/*  70 */             if (fighter != null) {
/*  71 */               fighter.setPosition(actorInformations.getWorldX(), actorInformations.getWorldY(), actorInformations.getAltitude());
/*  72 */               fighter.setDirection((Direction)actorInformations.getDirection());
/*  73 */               FighterActor fighterActor = fighter.getActor();
...
/*  78 */                 if (teamMate != null) {
/*  79 */                   Coach coach1 = (Coach)teamMate;
/*  80 */                   coach1.setWorldPosition(actorInformations.getWorldX(), actorInformations.getWorldY(), actorInformations.getAltitude());
/*  81 */                   coach1.setDirection(actorInformations.getDirection());
/*  82 */                   coach = coach1;
/*     */                   
/*     */                   break;
/*     */                 } 
...
/*     */             
/*  89 */             if (coach != null) {
/*  90 */               addMobile((Mobile)coach); continue;
/*     */             } 
...
/*     */       
/*     */       case 4104:
/* 104 */         actorDisapearMessage = (ActorDisapearMessage)message;
/*     */         
/* 106 */         fight1 = DofusArenaGameEntity.getInstance().getFight();
/* 107 */         if (fight1 != null) {
/* 108 */           Iterable<Long> actorIds = actorDisapearMessage.getCharacterIds();
/* 109 */           for (Iterator<Long> iterator = actorIds.iterator(); iterator.hasNext(); ) { long actorId = ((Long)iterator.next()).longValue();
/* 110 */             Fighter fighter = (Fighter)fight1.getFighterById(actorId);
/* 111 */             if (fighter != null) {
/* 112 */               FighterActor fighterActor = fighter.getActor();
/* 113 */               if (fighterActor != null) {
/*     */ 
/*     */                 
/* 116 */                 MobileManager.getInstance().removeMobile((Mobile)fighterActor);
/*     */                 continue;
/*     */               } 
...
/*     */       
/*     */       case 4106:
/* 131 */         actorRepositionMessage = (ActorRepositionMessage)message;
/*     */         
/* 133 */         fight1 = DofusArenaGameEntity.getInstance().getFight();
/* 134 */         if (fight1 != null) {
/* 135 */           Iterable<ActorRepositionMessage.CharacterAppearInformation> actorsInformations = actorRepositionMessage.getCharacterInformations();
/* 136 */           for (ActorRepositionMessage.CharacterAppearInformation actorInformations : actorsInformations) {
/* 137 */             Fighter fighter = (Fighter)fight1.getFighterById(actorInformations.getId());
/* 138 */             if (fighter != null) {
/*     */               
/* 140 */               fighter.setPosition(actorInformations.getWorldX(), actorInformations.getWorldY(), actorInformations.getAltitude()); continue;
/*     */             } 
...
/*     */       
/*     */       case 4500:
/* 153 */         actorMovementMessage = (ActorMovementMessage)message;
/*     */ 
/*     */         
/* 156 */         pathMobile = (PathMobile)MobileManager.getInstance().getMobile(actorMovementMessage.getActorId());
/* 157 */         if (pathMobile != null) {
/*     */ 
/*     */           
/* 160 */           PathFindResult node = actorMovementMessage.getPathResult();
/* 161 */           pathMobile.setPath(node, true);
/*     */         } else {
/*     */           
/* 164 */           m_logger.error("Impossible de déplacer le personnage " + actorMovementMessage.getActorId() + " car il n'existe pas !");
/*     */         } 
/*     */         
/* 167 */         return false;
/*     */ 
/*     */       
/*     */       case 4510:
/* 171 */         msg = (ActorTeleportsMessage)message;
/*     */         
/* 173 */         fight = DofusArenaGameEntity.getInstance().getFight();
/* 174 */         if (fight != null) {
...
/*     */ 
/*     */     
/* 240 */     mobile.addSelectionChangedListener(new MobileSelectionChangeListener() { DofusArenaOverHeadInfos m_overHeadInfos;
/*     */           
/*     */           public void selectionChanged(Mobile mobile, boolean selected) {
/* 243 */             if (selected && mobile.isVisible()) {
...
/* 250 */                 int healthPoints = fighter.getCharacteristicValue((CharacteristicType)FighterCharacteristicType.HP);
...
/* 255 */                 this.m_overHeadInfos.setTarget((IsoWorldTarget)mobile);
/* 256 */                 AdviserManager.getInstance().addAdviser((Adviser)this.m_overHeadInfos);
/*     */               } 
/*     */             } else {
/* 259 */               AdviserManager.getInstance().removeAdviser((Adviser)this.m_overHeadInfos);
/*     */             } 
/*     */           } }
/*     */       );
/*     */   }
