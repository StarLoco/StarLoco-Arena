...
/*     */   }
/*     */   
/*     */   private boolean m_flee = false;
/*     */   
/*  67 */   private final ArrayList<TeamMateResultInformations> m_winnerTeamMatesResultInformations = new ArrayList<TeamMateResultInformations>();
/*  68 */   private final ArrayList<TeamMateResultInformations> m_looserTeamMatesResultInformations = new ArrayList<TeamMateResultInformations>();
/*     */   
/*  70 */   private final ArrayList<BetCoachCard> m_lostCards = new ArrayList<BetCoachCard>();
/*  71 */   private final ArrayList<BetCoachCard> m_wonCards = new ArrayList<BetCoachCard>();
/*  72 */   private final ArrayList<BetCoachCard> m_bonusCards = new ArrayList<BetCoachCard>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 123 */         short s1 = buffer.getShort();
/* 124 */         PlayerStatisticsReport report = null;
/* 125 */         if (s1 > 0) {
/* 126 */           byte[] serial = new byte[s1];
...
/*     */       ArrayList<BetCoachCard> cards;
/*     */       
/* 241 */       long playerId = buffer.getLong();
/* 242 */       if (playerId == -1L) {
/*     */         
/* 244 */         cards = this.m_bonusCards;
/* 245 */       } else if (bLostCards) {
