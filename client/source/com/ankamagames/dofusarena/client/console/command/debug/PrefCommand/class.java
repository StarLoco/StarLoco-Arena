/*    */ package com.ankamagames.dofusarena.client.console.command.debug.PrefCommand;
/*    */ 
...
/* 32 */         DofusArenaClientInstance.getInstance().getPreferenceStore().removeChild((PreferenceStore)FightPreferenceStore.getInstance());
/* 33 */         manager.trace("remove FightPreferenceStore");
/*    */       } else {
/* 35 */         DofusArenaClientInstance.getInstance().getPreferenceStore().pushChild((PreferenceStore)FightPreferenceStore.getInstance());
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\console\command\debug\PrefCommand\class.class
