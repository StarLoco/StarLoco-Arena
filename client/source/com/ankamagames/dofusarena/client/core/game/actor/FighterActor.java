...
/*     */   static {
/*  64 */     m_highLightColor.setSpecular(0.2F, 0.2F, 0.2F, 0.0F);
...
/* 146 */     getFighter().setDirectionWithoutNotifyActor((Direction)direction);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 198 */         setPartDescriptor(library, linkageNames.<String>toArray(new String[linkageNames.size()]));
/*     */       } else {
...
/* 262 */     for (i = (arrayOfFighterActorEquipmentType = FighterActorEquipmentType.values()).length, b = 0; b < i; ) { FighterActorEquipmentType equipmentType = arrayOfFighterActorEquipmentType[b];
...
/* 277 */           this.m_teamParticleSystem.setTarget((IsoWorldTarget)this);
/* 278 */           IsoParticleSystemManager.getInstance().addParticleSystem((IsoParticleSystem)this.m_teamParticleSystem);
/*     */           return;
/*     */         } 
/*     */       } 
/*     */     } 
...
/* 308 */           this.m_activeParticleSystem.setTarget((IsoWorldTarget)getFighter().getActor());
/* 309 */           IsoParticleSystemManager.getInstance().addParticleSystem((IsoParticleSystem)this.m_activeParticleSystem);
/*     */           return;
/*     */         } 
/*     */       } 
/*     */     } 
...
/* 335 */         this.m_rootParticleSystem.setTarget((IsoWorldTarget)getFighter().getActor());
/* 336 */         IsoParticleSystemManager.getInstance().addParticleSystem((IsoParticleSystem)this.m_rootParticleSystem);
/*     */         return;
/*     */       } 
/*     */     } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\actor\FighterActor.class
