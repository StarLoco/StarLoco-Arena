...
/*  25 */   public static final String[] FIELDS = new String[] {
/*  26 */       "usable", 
/*  27 */       "smallDescription"
/*     */     };
/*     */ 
/*     */   
/*  31 */   public static final String[] ALL_FIELDS = new String[FIELDS.length + FighterCard.FIELDS.length]; static {
/*  32 */     System.arraycopy(FIELDS, 0, ALL_FIELDS, 0, FIELDS.length);
...
/*  82 */     return DofusArenaGameEntity.getInstance().getFight().getCardUseValidity((AbstractFighter)this.m_fighter, this, null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 103 */       return (getCastValidity() == CardUseValidity.OK) ? Boolean.valueOf(true) : Boolean.valueOf(false);
/*     */     }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\card\fighter\UsableFighterCard.class
