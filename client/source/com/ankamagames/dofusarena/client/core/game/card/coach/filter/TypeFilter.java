...
/*  36 */   public static final String[] FIELDS = new String[] { 
/*  37 */       "pantFilter", 
/*  38 */       "hairsFilter", 
/*  39 */       "tatooFilter", 
/*  40 */       "armbandFilter", 
...
/*     */ 
/*     */   
/*  51 */   private static final HashMap<CoachCardType, String[]> TYPE_FILEDS_CORRELATION = (HashMap)new HashMap<CoachCardType, String>();
/*     */   static {
/*  53 */     TYPE_FILEDS_CORRELATION.put(CoachCardType.PANT, new String[] { "pantFilter" });
...
/*     */   }
/*     */   
/*  67 */   private final ArrayList<CoachCardType> m_types = new ArrayList<CoachCardType>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/*  89 */       Xulor.getInstance().getEnvironment().getPropertiesProvider().firePropertyValueChanged(this, TYPE_FILEDS_CORRELATION.get(type));
...
/*     */ 
/*     */     
/* 103 */     Xulor.getInstance().getEnvironment().getPropertiesProvider().firePropertyValueChanged(this, TYPE_FILEDS_CORRELATION.get(type));
...
/* 123 */       removeType(this.m_types.get(i));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\card\coach\filter\TypeFilter.class
