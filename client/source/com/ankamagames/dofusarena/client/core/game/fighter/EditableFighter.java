...
/*  33 */   public static final String[] FIELDS = new String[] {
/*  34 */       "breedSpells", 
/*     */       
/*  36 */       "weaponCards", 
/*  37 */       "petCards", 
...
/*     */ 
/*     */   
/*  44 */   public static final String[] ALL_FIELDS = new String[FIELDS.length + Fighter.FIELDS.length]; static {
/*  45 */     System.arraycopy(FIELDS, 0, ALL_FIELDS, 0, FIELDS.length);
/*  46 */     System.arraycopy(Fighter.FIELDS, 0, ALL_FIELDS, FIELDS.length, Fighter.FIELDS.length);
/*     */   }
/*     */   
/*  49 */   private static final String[] UPDATE_SPELL_PROPERTIES = new String[] { "spells", "value" };
/*  50 */   private static final String[] UPDATE_EQUIPMENT_PROPERTIES = new String[] {
/*  51 */       "weaponEquipment", 
/*  52 */       "petEquipment", 
/*  53 */       "cloakEquipment", 
/*  54 */       "hatEquipment", 
...
/*  85 */     setDirection((Direction)getDirection().getNextDirection4(1));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  92 */     setDirection((Direction)getDirection().getNextDirection4(-1));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 131 */     try { getSpellInventory().add((InventoryContent)spell);
/*     */ 
/*     */       
/* 134 */       computeValue();
/*     */ 
...
/*     */     
/* 139 */     catch (InventoryCapacityReachedException inventoryCapacityReachedException) {  }
/* 140 */     catch (ContentAlreadyPresentException contentAlreadyPresentException) {}
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     getSpellInventory().remove((InventoryContent)spell);
/*     */ 
/*     */     
/* 154 */     computeValue();
/*     */ 
...
/*     */     
/* 169 */     try { if (!getEquipmentInventory().isPositionFree(position)) {
/* 170 */         getEquipmentInventory().destroyAt(position);
/*     */       }
/*     */ 
/*     */       
/* 174 */       getEquipmentInventory().addAt((InventoryContent)equipment, position);
/*     */ 
/*     */       
/* 177 */       computeValue();
/*     */ 
...
/*     */     
/* 182 */     catch (InventoryCapacityReachedException inventoryCapacityReachedException) {  }
/* 183 */     catch (ContentAlreadyPresentException contentAlreadyPresentException) {  }
/* 184 */     catch (PositionAlreadyUsedException positionAlreadyUsedException) {}
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 196 */     getEquipmentInventory().remove((InventoryContent)equipment);
/*     */ 
/*     */     
/* 199 */     computeValue();
/*     */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\fighter\EditableFighter.class
