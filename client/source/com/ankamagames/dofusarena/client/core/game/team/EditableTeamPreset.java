...
/*  29 */   public static final String[] FIELDS = new String[] {
/*  30 */       "name", 
/*  31 */       "fighters", 
/*  32 */       "value"
/*     */     };
...
/*     */   
/*     */   public int getValue() {
/*  41 */     HashMap<Byte, Byte> breedCount = new HashMap<Byte, Byte>();
/*     */     
/*  43 */     int value = 0;
/*  44 */     TLongArrayList fighterIds = getFightersIds();
/*  45 */     for (int i = 0; i < fighterIds.size(); i++) {
/*  46 */       Fighter fighter = FighterManager.getInstance().getFighter(fighterIds.getQuick(i));
/*  47 */       if (fighter != null) {
...
/*     */ 
/*     */     
/*  66 */     for (Iterator<Byte> iterator = breedCount.values().iterator(); iterator.hasNext(); ) { byte count = ((Byte)iterator.next()).byteValue();
/*     */       
/*  68 */       int previousValue = 0;
/*  69 */       for (byte b1 = 1; b1 <= count - 1; b1 = (byte)(b1 + 1)) {
/*  70 */         previousValue += previousValue + b1 * 100;
/*     */       }
/*     */       
...
/*     */       
/* 114 */       List<Fighter> fighters = new ArrayList<Fighter>();
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\team\EditableTeamPreset.class
