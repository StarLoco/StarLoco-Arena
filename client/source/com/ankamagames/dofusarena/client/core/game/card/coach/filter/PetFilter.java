...
/*     */     };
/*     */   
/*  36 */   private static final HashMap<CoachCardType, String[]> TYPE_FILEDS_CORRELATION = (HashMap)new HashMap<CoachCardType, String>();
/*     */   static {
/*  38 */     TYPE_FILEDS_CORRELATION.put(CoachCardType.PET_HEART, new String[] { "heartFilter" });
...
/*     */   }
/*     */   
/*  45 */   private final ArrayList<CoachCardType> m_types = new ArrayList<CoachCardType>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/*  67 */       Xulor.getInstance().getEnvironment().getPropertiesProvider().firePropertyValueChanged(this, TYPE_FILEDS_CORRELATION.get(type));
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  80 */     Xulor.getInstance().getEnvironment().getPropertiesProvider().firePropertyValueChanged(this, TYPE_FILEDS_CORRELATION.get(type));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */       removeType(this.m_types.get(i));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\game\card\coach\filter\PetFilter.class
