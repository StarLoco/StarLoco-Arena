...
/* 49 */     ConsoleManager.getInstance().addView((ConsoleView)DofusArenaConsoleView.getInstance());
/* 50 */     ConsoleManager.getInstance().addView((ConsoleView)new StandardConsoleView());
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\core\contentInitializer\ConsoleLoader.class
