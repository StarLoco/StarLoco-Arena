...
/*  42 */   private static final float[] STATIC_ZONE_EFFECT_COLOR = new float[] { 0.0F, 0.0F, 0.0F, 0.4F };
...
/*     */   }
/*     */   
/*  55 */   protected ElementSelector m_elementSelector = (ElementSelector)new ElementSelectorGround();
/*  56 */   private HashMap<BasicEffectArea, ElementSelection> m_areaSelections = new HashMap<BasicEffectArea, ElementSelection>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  81 */           float[] color = DofusArenaClientConstants.TEAM_COLOR[i];
...
/* 125 */     if (isActivated()) {
/* 126 */       ElementSelection selection = new ElementSelection(String.valueOf(PREFIX_SELECTION_NAME) + getNextSelectionId(), STATIC_ZONE_EFFECT_COLOR);
...
/* 156 */     if (isActivated()) {
/* 157 */       ElementSelection selection = this.m_areaSelections.get(area);
/*     */       
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\alea\highlightingCells\StaticEffectAreaDisplayer.class
