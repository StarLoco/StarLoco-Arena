...
/*     */ 
/*     */   
/*  54 */   protected ElementSelector m_elementSelector = (ElementSelector)new ElementSelectorGround();
/*     */   
...
/* 103 */         List<WorldElement> elements = CellSelector.getWorldElements(centerCell, scene, direction, this.m_elementSelector, pattern);
...
/*     */ 
/*     */     
/* 141 */     Object[] worldMaps = WorldManager.getInstance().getWorldMaps().getValues(); byte b; int i; Object[] arrayOfObject1;
/* 142 */     for (i = (arrayOfObject1 = worldMaps).length, b = 0; b < i; ) { Object objectMap = arrayOfObject1[b];
...
/*     */       b++; }
/*     */     
/* 175 */     this.m_range.refreshDisplay((AleaWorldScene)scene);
/* 176 */     this.m_rangeWithConstraint.refreshDisplay((AleaWorldScene)scene);
/*     */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\client\alea\highlightingCells\RangeAndEffectDisplayer.class
