...
/*     */     UIMessage msg;
/*     */     OpponentSearchCancelMessage netMessage;
/*     */     OpponentSearchRequestMessage opponentSearchRequestMessage;
/*  44 */     switch (message.getId()) {
/*     */       
/*     */       case 19501:
/*  47 */         msg = (UIMessage)message;
/*     */ 
/*     */         
/*  50 */         opponentSearchRequestMessage = new OpponentSearchRequestMessage();
/*  51 */         opponentSearchRequestMessage.setFightTypeId((byte)1);
/*  52 */         opponentSearchRequestMessage.setBet(msg.getIntValue());
/*  53 */         DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage((Message)opponentSearchRequestMessage);
/*     */ 
/*     */         
/*  56 */         DofusArenaGameEntity.getInstance().pushFrame((MessageFrame)NetRandomFightFrame.getInstance());
/*     */         
/*  58 */         return false;
/*     */ 
/*     */ 
...
/*     */       
/*     */       case 19503:
/*  72 */         netMessage = new OpponentSearchCancelMessage();
/*  73 */         DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage((Message)netMessage);
/*     */         
/*  75 */         return false;
/*     */     } 
/*     */ 
...
/*     */ 
/*     */       
/* 127 */       DofusArenaGameEntity.getInstance().removeFrame((MessageFrame)NetRandomFightFrame.getInstance());
/*     */ 
/*     */       
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\clien\\ui\protocol\frame\UIRandomFightCreationFrame.class
