...
/*  44 */     return m_instance; } public boolean onMessage(Message message) { UIChatContentMessage uIChatContentMessage; UIChatPipeSelectionMessage uIChatPipeSelectionMessage; boolean state;
/*     */     UserFilter filter;
/*     */     final UIFriendUserMessage msg;
/*     */     UIUserMessage msg;
/*     */     ChatView view;
/*     */     final DofusArenaUser user;
/*     */     DofusArenaUser friend;
/*     */     FieldedUser friendUser;
/*     */     IPopupMenu popupMenu;
/*  53 */     switch (message.getId()) {
/*     */       
/*     */       case 19000:
/*  56 */         uIChatContentMessage = (UIChatContentMessage)message;
/*     */ 
/*     */ 
/*     */         
/*  60 */         view = ChatViewManager.getInstance().getView();
/*     */         
/*  62 */         if (view != null) view.getConsole().parseInput(uIChatContentMessage.getMessage());
/*     */         
/*  64 */         return false;
/*     */ 
/*     */       
/*     */       case 19001:
/*  68 */         uIChatPipeSelectionMessage = (UIChatPipeSelectionMessage)message;
/*     */         
/*  70 */         view = ChatViewManager.getInstance().getView(uIChatPipeSelectionMessage.getViewIndex());
/*     */         
/*  72 */         uIChatPipeSelectionMessage.getPipeWrapper().setOpen(uIChatPipeSelectionMessage.isListenPipe());
/*     */         
/*  74 */         if (uIChatPipeSelectionMessage.isListenPipe()) { uIChatPipeSelectionMessage.getPipeWrapper().getChatPipe().addListener((ChatPipeListener)view); }
/*  75 */         else { uIChatPipeSelectionMessage.getPipeWrapper().getChatPipe().removeListener((ChatPipeListener)view); }
/*     */         
...
/*     */       
/*     */       case 19007:
/* 107 */         state = Xulor.getInstance().getEnvironment().getPropertiesProvider().getBooleanProperty("chat.isMaximize");
...
/*     */       
/*     */       case 19009:
/* 116 */         filter = DofusArenaUserGroupManager.getInstance().getUserFilter();
...
/*     */       
/*     */       case 19010:
/* 128 */         filter = DofusArenaUserGroupManager.getInstance().getUserFilter();
...
/*     */       
/*     */       case 19003:
/* 140 */         uIFriendUserMessage = (UIFriendUserMessage)message;
/*     */         
/* 142 */         user = uIFriendUserMessage.getUser();
/*     */         
/* 144 */         popupMenu = Xulor.getInstance().popupMenu();
...
/*     */         {
/* 149 */           popupMenu.addButton(DofusArenaTranslator.getInstance().getString("chat.removeFromIgnoreList", new Object[0]), null, (IMouseClickListener)new MouseClickListener() {
...
/* 153 */                   DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage((Message)netMessage);
/*     */                 }
/* 155 */               },  true);
/*     */         }
/*     */ 
...
/*     */           
/* 161 */           popupMenu.addButton(DofusArenaTranslator.getInstance().getString("chat.removeFromFriendList", new Object[0]), null, (IMouseClickListener)new MouseClickListener() {
/*     */                 public void run(MouseClickEvent event) {
/* 163 */                   RemoveFriendMessage netMessage = new RemoveFriendMessage();
/* 164 */                   netMessage.setFriendName(user.getName());
/* 165 */                   DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage((Message)netMessage);
/*     */                 }
/* 167 */               },  true);
/*     */ 
/*     */           
/* 170 */           popupMenu.addButton(DofusArenaTranslator.getInstance().getString("defy", new Object[0]), null, (IMouseClickListener)new MouseClickListener() {
/*     */                 public void run(MouseClickEvent event) {
...
/* 177 */                   DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage((Message)netMessage);
/*     */                 }
/* 179 */               },  true);
/*     */ 
/*     */           
/* 182 */           popupMenu.addButton(DofusArenaTranslator.getInstance().getString("chat.sendPrivateMessage", new Object[0]), null, (IMouseClickListener)new MouseClickListener() {
/*     */                 public void run(MouseClickEvent event) {
/* 184 */                   UIChatFrame.this.sendPrivateMessageTo((User)user);
/*     */                 }
/* 186 */               },  true);
/*     */         } 
/*     */         
...
/*     */       
/*     */       case 19005:
/* 196 */         uIFriendUserMessage = (UIFriendUserMessage)message;
/*     */         
/* 198 */         friend = uIFriendUserMessage.getUser();
/* 199 */         if (friend != null) {
...
/*     */       
/*     */       case 19006:
/* 207 */         msg = (UIUserMessage)message;
/* 208 */         friendUser = msg.getUser();
/*     */         
/* 210 */         if (friendUser != null) {
/* 211 */           sendPrivateMessageTo((User)friendUser);
/*     */         }
/*     */         
/* 214 */         return false;
/*     */     } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\clien\\ui\protocol\frame\UIChatFrame.class
