...
/*  79 */           DofusArenaGameEntity.getInstance().removeFrame((MessageFrame)NetTeamManagementFrame.getInstance());
/*     */         }
/*     */         else {
/*     */           
/*  83 */           DofusArenaGameEntity.getInstance().pushFrame(UITeamManagementFrame.getInstance());
/*  84 */           DofusArenaGameEntity.getInstance().pushFrame((MessageFrame)NetTeamManagementFrame.getInstance());
/*     */         } 
/*     */ 
/*     */         
/*  88 */         return false;
...
/* 104 */           DofusArenaGameEntity.getInstance().removeFrame((MessageFrame)NetTeamManagementFrame.getInstance());
/*     */         } 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\clien\\ui\protocol\frame\UIMenuBarFrame.class
