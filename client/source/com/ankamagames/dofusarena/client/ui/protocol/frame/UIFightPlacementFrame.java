...
/*     */     TeamMateSetReadyForObservationRequestMessage netMessage;
...
/*     */       
/*     */       case 18010:
/*  62 */         netMessage = new TeamMateSetReadyForObservationRequestMessage();
...
/*     */       
/*     */       case 30000:
/*  69 */         msg = (UIWorldSceneMouseReleasedMessage)message;
/*     */         
...
/*  80 */               Mobile mobile = hitMobiles.get(0);
...
/* 104 */               DisplayedElement displayedElement = hitElements.get(index);
/*     */               
...
/* 117 */                 Mobile mobile = hitMobiles.get(0);
...
/*     */ 
/*     */               
/* 126 */               MoveToFreePlacementRequestMessage moveToFreePlacementRequestMessage = new MoveToFreePlacementRequestMessage();
/* 127 */               moveToFreePlacementRequestMessage.setFighterId(this.m_selectedFighter.getId());
/* 128 */               moveToFreePlacementRequestMessage.setWorldX(target.getX());
/* 129 */               moveToFreePlacementRequestMessage.setWorldY(target.getY());
/* 130 */               moveToFreePlacementRequestMessage.setAltitude(target.getZ());
/* 131 */               DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage((Message)moveToFreePlacementRequestMessage);
/*     */             } 
/*     */ 
/*     */             
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\clien\\ui\protocol\frame\UIFightPlacementFrame.class
