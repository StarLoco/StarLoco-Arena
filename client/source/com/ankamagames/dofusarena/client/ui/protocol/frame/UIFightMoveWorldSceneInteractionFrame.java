...
/*     */     UIWorldSceneMouseMovedMessage uIWorldSceneMouseMovedMessage;
/*     */     UIWorldSceneMouseReleasedMessage msg;
/*  84 */     switch (message.getId()) {
/*     */       
/*     */       case 30001:
/*  87 */         uIWorldSceneMouseMovedMessage = (UIWorldSceneMouseMovedMessage)message;
/*     */         
/*  89 */         this.m_mouseX = uIWorldSceneMouseMovedMessage.getMouseX();
/*  90 */         this.m_mouseY = uIWorldSceneMouseMovedMessage.getMouseY();
...
/*     */       
/*     */       case 30000:
/*  98 */         msg = (UIWorldSceneMouseReleasedMessage)message;
...
/* 114 */               if (actor != null) {
/*     */                 
/* 116 */                 int movementPoints = currentFighter.getCharacteristicValue((CharacteristicType)FighterCharacteristicType.MP);
/*     */                 
/* 118 */                 if (movementPoints > 0) {
/* 119 */                   this.m_defaultParameters.m_obstacleInformationProvider = (MovementObstacleInformationProvider)fight;
/* 120 */                   this.m_defaultParameters.m_maxNodes = movementPoints;
/*     */ 
/*     */                   
/* 123 */                   PathFindResult pathResult = WorldSceneInteractionUtils.getPathSolutionFromMouseCoordinates(DofusArenaClientInstance.getInstance().getWorldScene(), (PathMobile)actor, msg.getMouseX(), msg.getMouseY(), WorldSceneInteractionUtils.PathSolutionCriterions.NEAREST_UP_FACE, this.m_defaultParameters);
...
/* 231 */         int movementPoints = currentFighter.getCharacteristicValue((CharacteristicType)FighterCharacteristicType.MP);
/*     */         
...
/*     */         } 
/* 240 */         if (movementPoints > 0 && !currentFighter.getProperties().isActiveProperty((PropertyType)FighterPropertyType.PETRIFIED)) {
/* 241 */           FighterActor actor = currentFighter.getActor();
/* 242 */           if (actor != null) {
/* 243 */             this.m_defaultParameters.m_obstacleInformationProvider = (MovementObstacleInformationProvider)fight;
/* 244 */             this.m_defaultParameters.m_maxNodes = movementPoints;
/*     */ 
/*     */             
/* 247 */             PathFindResult pathResult = WorldSceneInteractionUtils.getPathSolutionFromMouseCoordinates(DofusArenaClientInstance.getInstance().getWorldScene(), (PathMobile)actor, this.m_mouseX, this.m_mouseY, WorldSceneInteractionUtils.PathSolutionCriterions.NEAREST_UP_FACE, this.m_defaultParameters);
/*     */             
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\clien\\ui\protocol\frame\UIFightMoveWorldSceneInteractionFrame.class
