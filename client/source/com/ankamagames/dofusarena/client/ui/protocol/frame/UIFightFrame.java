...
/*  48 */     return m_instance; } public boolean onMessage(Message message) { UIFighterMessage uIFighterMessage1; UIFightEventCardMessage uIFightEventCardMessage;
/*     */     UIFighterSpellMessage uIFighterSpellMessage;
/*     */     UIFighterEquipmentMessage uIFighterEquipmentMessage;
/*     */     UIFighterMessage msg;
/*     */     Fighter fighter1;
/*     */     Event eventCard;
/*     */     Spell spell;
...
/*  69 */                   DofusArenaGameEntity.getInstance().getNetworkEntity().sendMessage((Message)netMessage);
/*     */                 } 
/*     */               }
/*     */             });
/*     */ 
...
/*     */       
/*     */       case 18012:
/*  79 */         uIFighterMessage1 = (UIFighterMessage)message;
/*     */         
/*  81 */         fighter1 = uIFighterMessage1.getFighter();
/*  82 */         if (fighter1 != null) {
/*     */ 
/*     */           
...
/*  88 */           if (property != null && property.getValue().equals(fighter1) && Xulor.getInstance().isLoaded("fighterInformationsDialog")) {
/*     */             
/*  90 */             Xulor.getInstance().unload("fighterInformationsDialog");
/*     */           } else {
/*     */             
/*  93 */             Xulor.getInstance().getEnvironment().getPropertiesProvider().setPropertyValue("fight.timeline.selectedFighter", fighter1);
/*     */ 
/*     */             
...
/*     */       
/*     */       case 18015:
/* 104 */         uIFightEventCardMessage = (UIFightEventCardMessage)message;
/*     */         
/* 106 */         eventCard = uIFightEventCardMessage.getEvent();
...
/*     */       
/*     */       case 16624:
/* 126 */         uIFighterSpellMessage = (UIFighterSpellMessage)message;
/*     */         
/* 128 */         spell = uIFighterSpellMessage.getSpell();
/* 129 */         if (spell != null)
/*     */         {
...
/*     */       
/*     */       case 16622:
/* 146 */         uIFighterEquipmentMessage = (UIFighterEquipmentMessage)message;
/*     */         
/* 148 */         equipment = uIFighterEquipmentMessage.getEquipment();
...
/*     */       
/*     */       case 18016:
/* 166 */         msg = (UIFighterMessage)message;
/* 167 */         fighter = msg.getFighter();
/* 168 */         if (fighter != null) {
...
/*     */       
/*     */       case 18017:
/* 175 */         msg = (UIFighterMessage)message;
/* 176 */         fighter = msg.getFighter();
/* 177 */         if (fighter != null) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\clien\\ui\protocol\frame\UIFightFrame.class
