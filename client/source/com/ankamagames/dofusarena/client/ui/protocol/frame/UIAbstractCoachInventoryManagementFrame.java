...
/*     */     UICoachEquipmentMessage uICoachEquipmentMessage1;
/*     */     UILocalCoachMessage uILocalCoachMessage;
/*     */     UICoachEquipmentMessage msg;
/*     */     CoachCard equipment;
/*     */     final LocalCoach localCoach;
/*     */     CoachCardType type;
/*     */     final CoachCard equipment;
/*  48 */     switch (message.getId()) {
/*     */       
/*     */       case 16700:
/*  51 */         uICoachEquipmentMessage1 = (UICoachEquipmentMessage)message;
/*     */         
/*  53 */         equipment = uICoachEquipmentMessage1.getEquipment();
...
/*     */       
/*     */       case 16704:
/*  70 */         uILocalCoachMessage = (UILocalCoachMessage)message;
/*     */         
/*  72 */         localCoach = uILocalCoachMessage.getLocalCoach();
/*  73 */         type = CoachCardType.getFromId(uILocalCoachMessage.getIntValue());
...
/*     */       
/*     */       case 16712:
/*  90 */         uILocalCoachMessage = (UILocalCoachMessage)message;
/*     */         
/*  92 */         localCoach = uILocalCoachMessage.getLocalCoach();
/*  93 */         type = CoachCardType.getFromId(uILocalCoachMessage.getIntValue());
...
/*     */       
/*     */       case 16705:
/* 110 */         uILocalCoachMessage = (UILocalCoachMessage)message;
/*     */         
/* 112 */         localCoach = uILocalCoachMessage.getLocalCoach();
...
/*     */       
/*     */       case 16713:
/* 129 */         uILocalCoachMessage = (UILocalCoachMessage)message;
/*     */         
/* 131 */         localCoach = uILocalCoachMessage.getLocalCoach();
...
/*     */       
/*     */       case 16711:
/* 148 */         uILocalCoachMessage = (UILocalCoachMessage)message;
/*     */         
/* 150 */         localCoach = uILocalCoachMessage.getLocalCoach();
...
/* 155 */             setFilter.setCurrentSetName(uILocalCoachMessage.getStringValue());
...
/*     */       
/*     */       case 16714:
/* 163 */         uILocalCoachMessage = (UILocalCoachMessage)message;
/*     */         
/* 165 */         localCoach = uILocalCoachMessage.getLocalCoach();
/* 166 */         if (localCoach != null) {
/* 167 */           localCoach.setSelectedCostFilter(uILocalCoachMessage.getStringValue());
...
/*     */       
/*     */       case 16706:
/* 174 */         msg = (UICoachEquipmentMessage)message;
/*     */         
/* 176 */         localCoach = msg.getLocalCoach();
/* 177 */         coachCard1 = msg.getEquipment();
/* 178 */         if (localCoach != null && coachCard1 != null) {
/*     */ 
/*     */           
/* 181 */           String question = DofusArenaTranslator.getInstance().getString("question.deleteCoachEquipment", new Object[] { Short.valueOf(coachCard1.getQuantity()), coachCard1.getName() });
/*     */ 
/*     */ 
/*     */           
...
/* 195 */                     Worker.getInstance().pushMessage((Message)uiMessage);
/*     */                     
...
/*     */       
/*     */       case 16707:
/* 208 */         msg = (UICoachEquipmentMessage)message;
/*     */         
/* 210 */         localCoach = msg.getLocalCoach();
/* 211 */         coachCard1 = msg.getEquipment();
/* 212 */         if (localCoach != null && coachCard1 != null) {
/* 213 */           localCoach.deleteEquipment(coachCard1);
/*     */         }
/*     */         
/* 216 */         return false;
/*     */ 
/*     */       
/*     */       case 16708:
/* 220 */         msg = (UICoachEquipmentMessage)message;
/*     */         
/* 222 */         localCoach = msg.getLocalCoach();
/* 223 */         coachCard1 = msg.getEquipment();
/* 224 */         if (localCoach != null && coachCard1 != null) {
/* 225 */           if (coachCard1.isLocked()) {
/* 226 */             localCoach.unlockEquipment(coachCard1);
/*     */           } else {
/* 228 */             localCoach.lockEquipment(coachCard1);
/*     */           } 
/*     */         }
/*     */         
/* 232 */         return false;
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\dofusarena\clien\\ui\protocol\frame\UIAbstractCoachInventoryManagementFrame.class
