...
/*  31 */   public static final String[] FIELDS = new String[] { "history", "input" };
/*     */   
...
/*     */   
/*  38 */   private List<ChatPipeWrapper> m_wrappedPipes = new ArrayList<ChatPipeWrapper>();
/*     */   
...
/*  59 */     ArrayList<ChatMessage> visibleMessages = new ArrayList<ChatMessage>();
/*     */     
...
/* 189 */       this.m_input = (this.m_input == null) ? (String)value : (String.valueOf(value) + this.m_input);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 201 */       this.m_history = String.valueOf(this.m_history) + (String)value;
/* 202 */     } else if (fieldName.equals("input")) {
/* 203 */       this.m_input = (this.m_input == null) ? (String)value : (String.valueOf(this.m_input) + (String)value);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphicalClient\chat\AbstractChatView.class
