...
/*  35 */       Material material = HighLightManager.getInstance().getLayer(this.m_name).getMaterial();
/*  36 */       material.setDiffuse(color);
/*  37 */       material.setUseDiffuse(true);
...
/*     */       case SOUTH_EAST:
/*  84 */         originX = originCell.getX() - brush.getCenterX();
/*  85 */         originY = originCell.getY() - brush.getCenterY();
/*     */         
/*  87 */         for (x = 0; x < brushSizeX; x++) {
...
/*     */         break;
/*     */       case SOUTH_WEST:
/* 100 */         originX = originCell.getX() - brush.getCenterY() + brush.getSizeY() - 1;
/* 101 */         originY = originCell.getY() - brush.getCenterX();
/*     */         
/* 103 */         for (x = 0; x < brushSizeX; x++) {
...
/*     */         break;
/*     */       case NORTH_WEST:
/* 116 */         originX = originCell.getX() - brush.getCenterX() + brush.getSizeX() - 1;
/* 117 */         originY = originCell.getY() - brush.getCenterY() + brush.getSizeY() - 1;
/*     */         
/* 119 */         for (x = 0; x < brushSizeX; x++) {
...
/*     */         break;
/*     */       case NORTH_EAST:
/* 132 */         originX = originCell.getX() - brush.getCenterY();
/* 133 */         originY = originCell.getY() + brush.getCenterX();
/*     */         
/* 135 */         for (x = 0; x < brushSizeX; x++) {
...
/*     */ 
/*     */         
/* 206 */         return elementSelector.getListElement();case SOUTH_WEST: for (int[] offset : pattern) { WorldCell cell = (WorldCell)scene.getWorldCell(originX - offset[1], originY + offset[0]); if (cell != null) elementSelector.addElementFromCell(cell);  }  return elementSelector.getListElement();case NORTH_WEST: for (int[] offset : pattern) { WorldCell cell = (WorldCell)scene.getWorldCell(originX - offset[0], originY - offset[1]); if (cell != null) elementSelector.addElementFromCell(cell);  }  return elementSelector.getListElement();case NORTH_EAST: for (int[] offset : pattern) { WorldCell cell = (WorldCell)scene.getWorldCell(originX + offset[1], originY - offset[0]); if (cell != null) elementSelector.addElementFromCell(cell);  }  return elementSelector.getListElement(); }  m_logger.error("Impossible de selectionner des cellules dans cette direction :" + orientation); return elementSelector.getListElement();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */         HighLightManager.getInstance().remove((UniqueHandleReference)element, this.m_name);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\cellSelector\CellSelector.class
