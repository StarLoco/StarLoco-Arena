...
/*   74 */   public static final GLRenderStates DEFAULT_PRE_RENDERSTATE = (GLRenderStates)new DefaultMobilePreRenderState();
/*   75 */   public static final GLRenderStates DEFAULT_POST_RENDERSTATE = (GLRenderStates)new DefaultMobilePostRenderState();
/*      */   
...
/*      */ 
/*      */   
/*      */   protected boolean m_visibleChanged = true;
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*      */   private boolean m_applyEffectTochild = false;
/*      */ 
/*      */   
/*  125 */   private String m_animation = "AnimStatique";
/*      */   private boolean m_animationChanged = false;
...
/*      */   
/*      */   private boolean m_directionChanged = false;
/*      */   
...
/*      */   
/*      */   protected boolean m_selectedChanged = false;
/*      */   
/*  159 */   protected ArrayList<MobileSelectionChangeListener> m_selectionChangedListeners = new ArrayList<MobileSelectionChangeListener>();
/*      */ 
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*  170 */   protected HashMap<String, Material> m_customLinkageMaterials = new HashMap<String, Material>();
/*      */ 
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*      */   public void setDescriptorLibraryFromFile(String fileName) throws Exception {
...
/*  741 */     if (this.m_descriptorLibrary != null) {
/*  742 */       byte b; int i; String[] arrayOfString; for (i = (arrayOfString = linkageNames).length, b = 0; b < i; ) { String linkageName = arrayOfString[b];
...
/*  755 */     setPartDescriptor((AbstractDescriptorLibrary)srcLibrary, linkageName, linkageName);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  785 */     if (this.m_descriptorLibrary != null) {
/*  786 */       byte b; int i; String[] arrayOfString; for (i = (arrayOfString = linkageNames).length, b = 0; b < i; ) { String linkageName = arrayOfString[b];
...
/*  820 */     for (i = (arrayOfString = linkageNames).length, b = 0; b < i; ) { String linkageName = arrayOfString[b];
...
/*  857 */       applyCustomMaterial(entry.getKey(), entry.getValue());
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  930 */         return descriptor.createInstance((AbstractDescriptorLibrary)this.m_descriptorLibrary);
/*      */       }
/*      */     } 
/*  933 */     return null;
/*      */   }
...
/*  963 */       DescriptorLibraryManager.getInstance().tagResourceInUse((ManageableResource)this.m_descriptorLibrary.getParent());
/*      */     }
/*      */     
...
/* 1013 */                 if (!(mesh.getEffect() instanceof com.ankamagames.graphics.effects.OutlineEffect)) {
/* 1014 */                   mesh.getMaterial().setUseDiffuse(true);
/*      */                 }
/*      */ 
/*      */                 
/* 1018 */                 mesh.getMaterial().getDiffuse()[0] = mesh.getMaterial().getDiffuse()[0] * this.m_alpha;
/* 1019 */                 mesh.getMaterial().getDiffuse()[1] = mesh.getMaterial().getDiffuse()[1] * this.m_alpha;
/* 1020 */                 mesh.getMaterial().getDiffuse()[2] = mesh.getMaterial().getDiffuse()[2] * this.m_alpha;
/*      */                 
/* 1022 */                 mesh.getMaterial().getDiffuse()[3] = mesh.getMaterial().getDiffuse()[3] * this.m_alpha;
/*      */               } 
/*      */             } 
/*      */ 
/*      */             
/* 1027 */             AnimationManager.getInstance().addAnimatedObject((Scene)scene, (AnimatedObject)this.m_displayObject);
/*      */           } 
/*      */         } else {
...
/* 1057 */       linkageName = String.valueOf(linkageName) + this.m_animationSuffix;
/*      */     }
...
/* 1071 */     return String.valueOf(directionIndex) + "_" + linkageName;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/*      */       protected void run(int paramCount) throws LuaException {
/* 1145 */         Mobile.InnerMobileFunctionsLibrary.access$0(Mobile.InnerMobileFunctionsLibrary.this).setAnimation(Mobile.InnerMobileFunctionsLibrary.access$0(Mobile.InnerMobileFunctionsLibrary.this).getStaticAnimationKey());
/*      */       }
/*      */     }
/*      */ 
/*      */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\mobile\Mobile.class
