...
/*     */ 
/*     */   
/*  86 */   private ArrayList<RenderProcessHandler> m_renderProcessHandlers = new ArrayList<RenderProcessHandler>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 121 */     setCamera((GLMatrix)this.m_isoCamera);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 154 */     DisplayedElement element = null; byte b; int i; DisplayedCell[] arrayOfDisplayedCell;
/* 155 */     for (i = (arrayOfDisplayedCell = this.m_displayedCells).length, b = 0; b < i; ) { DisplayedCell cell = arrayOfDisplayedCell[b];
...
/* 234 */       SoundManager.getInstance().addGroup((AudioSourceGroup)field);
/* 235 */       field.setMaxGain(0.4F);
/* 236 */       field.createReferences(String.valueOf(this.m_sndPath) + fileName, true, false, range, rolloff);
/*     */     } 
/*     */     
...
/*     */ 
/*     */     
/* 278 */     AnimationManager.getInstance().invalidateAllDisplayObjects((Scene)this);
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 307 */     setPreRenderStates((GLRenderStates)new DefaultScenePreRenderStates());
/* 308 */     setPostRenderStates((GLRenderStates)new DefaultScenePostRenderStates());
/*     */ 
/*     */ 
/*     */     
...
/*     */     } 
/*     */     
/* 322 */     AnimationManager.getInstance().registerScene((Scene)this, this, AnimationManager.ProcessType.AUTO_PROCESS);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 382 */       if (this.m_displayedCells != null) {
/* 383 */         byte b; int j; DisplayedCell[] arrayOfDisplayedCell; for (j = (arrayOfDisplayedCell = this.m_displayedCells).length, b = 0; b < j; ) { DisplayedCell m_displayedCell = arrayOfDisplayedCell[b];
/* 384 */           if (m_displayedCell != null)
/* 385 */             m_displayedCell.release();  b++; }
/*     */       
/*     */       } 
...
/* 399 */     if (this.m_displayedCells != null) {
/* 400 */       byte b; int i; DisplayedCell[] arrayOfDisplayedCell; for (i = (arrayOfDisplayedCell = this.m_displayedCells).length, b = 0; b < i; ) { DisplayedCell m_displayedCell = arrayOfDisplayedCell[b];
/* 401 */         if (m_displayedCell != null)
/* 402 */           m_displayedCell.release();  b++; }
/*     */     
...
/*     */ 
/*     */     
/* 545 */     if (this.m_displayedCells != null) {
/* 546 */       byte b; int i; DisplayedCell[] arrayOfDisplayedCell; for (i = (arrayOfDisplayedCell = this.m_displayedCells).length, b = 0; b < i; ) { DisplayedCell cell = arrayOfDisplayedCell[b];
...
/*     */ 
/*     */     
/* 575 */     ArrayList<DisplayedElement> hitElements = new ArrayList<DisplayedElement>(); byte b; int i;
/*     */     DisplayedCell[] arrayOfDisplayedCell;
/* 577 */     for (i = (arrayOfDisplayedCell = this.m_displayedCells).length, b = 0; b < i; ) { DisplayedCell cell = arrayOfDisplayedCell[b];
...
/*     */   private float m_outdoorZoomFactor; private float m_indoorZoomFactor;
/* 645 */   public AleaWorldScene() { this.m_outdoorZoomFactor = DEFAULT_OUTDOOR_ZOOM_FACTOR;
/* 646 */     this.m_indoorZoomFactor = DEFAULT_INDOOR_ZOOM_FACTOR; addRenderProcessHandler((RenderProcessHandler)MobileManager.getInstance()); addRenderProcessHandler((RenderProcessHandler)IsoParticleSystemManager.getInstance()); addRenderProcessHandler((RenderProcessHandler)LightManager.getInstance()); addRenderProcessHandler((RenderProcessHandler)HighLightManager.getInstance()); addRenderProcessHandler((RenderProcessHandler)LinesManager.getInstance());
/*     */     addRenderProcessHandler(FadeManager.getInstance());
/*     */     addRenderProcessHandler((RenderProcessHandler)TweenManager.getInstance());
/* 649 */     addRenderProcessHandler((RenderProcessHandler)AdviserManager.getInstance()); } public float getOutdoorZoomFactor() { return this.m_outdoorZoomFactor; }
/*     */ 
/*     */   
...
/* 812 */     return (Partition)getWorldCell((int)x, (int)y);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 836 */     return (Partition)WorldManager.getInstance();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 856 */     return String.valueOf(surface) + " px, " + screenCount + " écrans, " + "zoom=" + this.m_isoCamera.getZoomFactor() + ", " + super.toString();
/*     */   }
/*     */   
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\display\AleaWorldScene.class
