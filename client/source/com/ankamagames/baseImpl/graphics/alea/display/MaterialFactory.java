...
/* 53 */     String filePath = String.valueOf(this.m_gfxPath) + System.getProperties().getProperty("file.separator") + characterPath + System.getProperties().getProperty("file.separator") + directionIndex + "-" + 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\display\MaterialFactory.class
