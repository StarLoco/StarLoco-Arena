...
/* 32 */     this.m_cellsMesh = new Mesh2D[3000];
/*    */     
...
/* 51 */       mesh.initialize();
/*    */     }
/* 53 */     Mesh2DManager.getInstance().tagResourceInUse((ManageableResource)mesh);
/*    */ 
/*    */     
...
/*    */ 
/*    */     
/* 61 */     mesh.setTexture((BaseTexture)AleaTextureManager.getInstance().getTextureForCell(graphicalElement.getStateProperties(state).getGfxId()));
/*    */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\graphics\alea\display\CellMeshFactory.class
