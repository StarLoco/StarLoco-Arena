...
/*     */ 
/*     */   
/*  24 */   protected final ItemExchangerUser<ContentType>[] m_users = (ItemExchangerUser<ContentType>[])new ItemExchangerUser[2];
/*  25 */   protected final long[] m_usersId = new long[2];
/*  26 */   protected final boolean[] m_usersReady = new boolean[2];
/*     */ 
/*     */   
/*  29 */   protected final HashMap<Long, ContentType>[] m_usersExchangeList = (HashMap<Long, ContentType>[])new HashMap[2];
/*     */   
...
/*  72 */       notifyUser(0, (ItemExchangerEvent)ItemExchangerEndEvent.checkOut(this, ItemExchangerEndEvent.Reason.INVITATION_IMPOSSIBLE_USER_BUSY));
/*  73 */       finishExchange();
/*     */       
/*     */       return;
/*     */     } 
/*  77 */     if (!ItemExchangerManager.getInstance().addExchanger(this)) {
/*  78 */       notifyUser(0, (ItemExchangerEvent)ItemExchangerEndEvent.checkOut(this, ItemExchangerEndEvent.Reason.INVITATION_IMPOSSIBLE_USER_BUSY));
/*  79 */       finishExchange();
/*     */       
/*     */       return;
/*     */     } 
...
/*     */ 
/*     */   
/*     */   protected boolean isUserConcerned(ItemExchangerUser<ContentType> user) {
/*  98 */     return !(user != this.m_users[0] && user != this.m_users[1]);
/*     */   }
/*     */   
/*     */   protected int getUserInnerIndex(ItemExchangerUser<ContentType> user) {
...
/*     */       return;
/*     */     }
/* 255 */     notifyUser(0, (ItemExchangerEvent)ItemExchangerEndEvent.checkOut(this, ItemExchangerEndEvent.Reason.INVITATION_REMOTELY_CANCELED));
/* 256 */     notifyUser(1, (ItemExchangerEvent)ItemExchangerEndEvent.checkOut(this, ItemExchangerEndEvent.Reason.INVITATION_LOCALLY_CANCELED));
/*     */     
/* 258 */     finishExchange();
/*     */   }
/*     */ 
...
/* 271 */     notifyUser(index, (ItemExchangerEvent)ItemExchangerEndEvent.checkOut(this, ItemExchangerEndEvent.Reason.LOCALLY_CANCELED));
/* 272 */     notifyUser(1 - index, (ItemExchangerEvent)ItemExchangerEndEvent.checkOut(this, ItemExchangerEndEvent.Reason.REMOTELY_CANCELED));
/*     */     
/* 274 */     finishExchange();
/*     */   }
/*     */ 
...
/*     */ 
/*     */     
/* 293 */     notifyUsers((ItemExchangerEvent)ItemExchangerEndEvent.checkOut(this, ItemExchangerEndEvent.Reason.EXCHANGE_DONE));
/*     */     
/* 295 */     finishExchange();
/*     */   }
/*     */ 
...
/* 310 */       this.m_usersReady[userIndex] = !this.m_usersReady[userIndex];
/*     */ 
/*     */       
/* 313 */       if (this.m_usersReady[0] && this.m_usersReady[1]) {
...
/*     */ 
/*     */   
/*     */   public byte getIndexByUser(ItemExchangerUser<ContentType> user) {
...
/* 370 */       this.m_usersExchangeList[userIndex] = new HashMap<Long, ContentType>();
/*     */     }
/*     */     
/* 373 */     if (this.m_usersExchangeList[userIndex].containsKey(Long.valueOf(referenceContent.getUniqueId()))) {
/*     */       
/* 375 */       InventoryContent inventoryContent = (InventoryContent)this.m_usersExchangeList[userIndex].get(Long.valueOf(referenceContent.getUniqueId()));
/*     */       
/* 377 */       if (isCheckQuantityNeeded() && inventoryContent.getQuantity() + quantity > referenceContent.getQuantity()) {
/* 378 */         m_logger.error("On essaye d'ajouter plus de carte qu'il n'en a de disponible dans un échange");
/*     */         return;
/*     */       } 
/* 381 */       inventoryContent.updateQuantity(quantity);
/*     */     } else {
/*     */       
...
/*     */         return;
/*     */       } 
/* 389 */       InventoryContent inventoryContent = referenceContent.getClone();
/* 390 */       inventoryContent.setQuantity(quantity);
/*     */       
/* 392 */       this.m_usersExchangeList[userIndex].put(Long.valueOf(referenceContent.getUniqueId()), (ContentType)inventoryContent);
/*     */     } 
/*     */     
/* 395 */     notifyUsers((ItemExchangerEvent)ItemExchangerModifiedEvent.checkOut(this, ItemExchangerModifiedEvent.Modification.CONTENT_ADDED, userIndex, (InventoryContent)referenceContent, quantity));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return;
/*     */     } 
/* 427 */     InventoryContent inventoryContent = (InventoryContent)this.m_usersExchangeList[userIndex].get(Long.valueOf(referenceContent.getUniqueId()));
/* 428 */     inventoryContent.updateQuantity((short)-quantity);
/*     */ 
/*     */     
/* 431 */     if (inventoryContent.getQuantity() <= 0) {
/* 432 */       inventoryContent.release();
/* 433 */       this.m_usersExchangeList[userIndex].remove(Long.valueOf(referenceContent.getUniqueId()));
/*     */     } 
/*     */     
/* 436 */     notifyUsers((ItemExchangerEvent)ItemExchangerModifiedEvent.checkOut(this, ItemExchangerModifiedEvent.Modification.CONTENT_REMOVED, userIndex, (InventoryContent)referenceContent, quantity));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 449 */       for (InventoryContent inventoryContent : this.m_usersExchangeList[index].values())
/*     */       {
/* 451 */         inventoryContent.release();
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\inventory\ItemExchanger.class
