...
/*  81 */     for (i = (arrayOfEffect = this.m_effects).length, b = 0; b < i; ) { Effect eff = arrayOfEffect[b];
...
/* 103 */     return (Iterator<Effect>)new ArrayIterator((Object[])this.m_effects, false);
/*     */   }
/*     */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\spell\BasicSpellStep.class
