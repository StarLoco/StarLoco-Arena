...
/*     */ 
/*     */   
/*  53 */   private static final ObjectPool m_staticPool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<ItemExchangerEvent>() { public ItemExchangerEvent makeObject() {
/*  54 */           return new ItemExchangerEvent();
/*     */         } }
/*     */     );
/*     */   public static ItemExchangerEvent checkOut(ItemExchanger itemExchanger, Action action) {
/*     */     ItemExchangerEvent event;
/*     */     try {
/*  60 */       event = (ItemExchangerEvent)m_staticPool.borrowObject();
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\inventory\event\ItemExchangerEvent.class
