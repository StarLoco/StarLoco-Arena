...
/*     */   
/*     */   protected boolean m_valueComputationEnabled = true;
/*     */   
/* 111 */   private final ArrayList<RunningEffect> m_stackedRunningEffect = new ArrayList<RunningEffect>();
/*     */ 
/*     */   
...
/* 215 */     return determineTargets(this.m_genericEffect, (Target)this.m_caster, this.m_context, this.m_targetCell);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 233 */     setParameters(genericEffect, container, context, launcher, (EffectUser)null, targetCell);
/*     */     
...
/*     */       
/* 243 */       RunningEffect reOnCellOnly = newParameterizedInstance(genericEffect, container, context, launcher, (EffectUser)null, targetCell);
...
/* 250 */           reOnCellOnly.computeValue((RunningEffect)null); 
/* 251 */         reOnCellOnly.execute((RunningEffect)null, false);
/*     */       } 
/*     */     } 
/*     */     
/* 255 */     if (useTarget()) {
/*     */       
/* 257 */       Collection<EffectUser> targets = determineTargets(genericEffect, (Target)launcher, context, targetCell);
/* 258 */       applyOnTargets(targets.<EffectUser>toArray(new EffectUser[0]));
/*     */     } 
/*     */ 
/*     */     
/* 262 */     clearParameters();
...
/* 281 */       if (this.m_target.isDead())
/* 282 */         return;  this.m_target.getRunningEffectManager().trigger(this, (byte)2);
/* 283 */       if (this.m_target.isDead())
/*     */         return; 
...
/* 582 */     ArrayList<RunningEffect> runningEffectsToApply = new ArrayList<RunningEffect>(); byte b; int i; EffectUser[] arrayOfEffectUser;
/* 583 */     for (i = (arrayOfEffectUser = targets).length, b = 0; b < i; ) { EffectUser target = arrayOfEffectUser[b];
/*     */       
...
/* 591 */           re.computeValue((RunningEffect)null); 
/* 592 */         if (target != null) {
/*     */           
/* 594 */           if (target.getRunningEffectManager() != null) {
/* 595 */             target.getRunningEffectManager().trigger(re, (byte)1);
/*     */           }
/* 597 */           if (re.getTarget() != null && re.getTarget().isDead())
/* 598 */             return;  if (re.getCaster() != null && re.getCaster().isDead())
/*     */             return; 
...
/*     */ 
/*     */       
/* 625 */       if (re.getTarget() != null && re.getTarget().isDead())
/* 626 */         return;  if (re.getCaster() != null && re.getCaster().isDead()) {
/*     */         return;
/*     */       }
/*     */       
...
/*     */         
/* 633 */         if (re.getTarget() != null && re.getTarget().isDead())
/* 634 */           return;  if (re.getCaster() != null && re.getCaster().isDead()) {
/*     */           return;
/*     */         }
/*     */       } 
...
/* 644 */         re.execute((RunningEffect)null, false);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 838 */     reToStack.setStackingRunningEffect((RunningEffect)null);
/*     */   }
/*     */   
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\effect\runningEffect\RunningEffect.class
