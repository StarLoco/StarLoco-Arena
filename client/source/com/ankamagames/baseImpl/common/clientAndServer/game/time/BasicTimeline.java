...
/*  63 */       for (TimeEvent<TU, TI> te : this.m_timeline) {
/*  64 */         te.release();
/*     */       }
...
/*     */   
/*     */   public void reset() {
/*  73 */     for (TimeEvent<TU, TI> te : this.m_timeline) {
/*  74 */       te.release();
/*     */     }
...
/*     */       } 
/* 126 */       if (diff == 0 && 
/* 127 */         te.getPriority() <= event.getPriority()) {
/* 128 */         index++;
/*     */ 
/*     */         
/*     */         continue;
...
/* 170 */     ArrayList<TimeEvent<TU, TI>> filteredTimeEvents = new ArrayList<TimeEvent<TU, TI>>();
...
/* 242 */       return this.m_timeline.get(0);
/*     */     }
/* 244 */     return null;
/*     */   }
/*     */ 
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\time\BasicTimeline.class
