...
/*     */   
/*  27 */   private final ArrayList<RunningEffect> m_effects = new ArrayList<RunningEffect>();
/*     */   
...
/* 102 */       RunningEffect re = it.next();
/* 103 */       if (re.getParent() == parentEffect) {
/* 104 */         if (effectsToRemove == null)
/* 105 */           effectsToRemove = new ArrayList<RunningEffect>(); 
...
/* 117 */       RunningEffect re = it.next();
/* 118 */       if (re.m_caster == caster) {
/* 119 */         if (effectsToRemove == null)
/* 120 */           effectsToRemove = new ArrayList<RunningEffect>(); 
...
/* 132 */       RunningEffect re = it.next();
/* 133 */       if (re.m_effectContainer == container) {
/* 134 */         if (effectsToRemove == null)
/* 135 */           effectsToRemove = new ArrayList<RunningEffect>(); 
...
/* 197 */     ArrayList<RunningEffect> effectToActivate = new ArrayList<RunningEffect>();
/* 198 */     ArrayList<RunningEffect> effectToDeactivate = new ArrayList<RunningEffect>();
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\effect\runningEffect\RunningEffectManager.class
