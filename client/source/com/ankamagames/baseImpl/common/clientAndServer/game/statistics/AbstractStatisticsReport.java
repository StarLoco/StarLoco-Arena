...
/*  24 */   private final HashMap<Short, StatisticsEntry> m_statistics = new HashMap<Short, StatisticsEntry>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*  43 */     for (Map.Entry<Short, StatisticsEntry> statistic : this.m_statistics.entrySet()) {
/*  44 */       StatisticsEntry entry = statistic.getValue();
/*     */       
/*  46 */       buffer.putShort(((Short)statistic.getKey()).shortValue());
/*  47 */       buffer.put(entry.getType().getTypeId());
/*     */       
/*  49 */       if (entry.getType() == StatisticType.TYPE_INT) {
/*  50 */         buffer.putInt(entry.getIntValue()); continue;
/*  51 */       }  if (entry.getType() == StatisticType.TYPE_LONG) {
/*  52 */         buffer.putLong(entry.getLongValue()); continue;
/*  53 */       }  if (entry.getType() == StatisticType.TYPE_FLOAT) {
...
/* 116 */         addReportEntry(((Short)entry.getKey()).shortValue(), ((StatisticsEntry)entry.getValue()).getIntValue()); continue;
/* 117 */       }  if (type == StatisticType.TYPE_LONG) {
/* 118 */         addReportEntry(((Short)entry.getKey()).shortValue(), ((StatisticsEntry)entry.getValue()).getLongValue()); continue;
/* 119 */       }  if (type == StatisticType.TYPE_FLOAT) {
...
/* 157 */     StatisticsEntry entry = this.m_statistics.get(Short.valueOf(id));
/* 158 */     if (entry == null) {
...
/* 171 */     StatisticsEntry entry = this.m_statistics.get(Short.valueOf(id));
/* 172 */     if (entry == null) {
...
/* 185 */     StatisticsEntry entry = this.m_statistics.get(Short.valueOf(id));
/* 186 */     if (entry == null) {
...
/* 200 */     StatisticsEntry entry = this.m_statistics.get(Short.valueOf(id));
/* 201 */     if (entry != null)
...
/* 212 */     int value = 0;
/* 213 */     StatisticsEntry entry = this.m_statistics.get(Short.valueOf(id));
/* 214 */     if (entry != null)
...
/* 229 */     long value = 0L;
/* 230 */     StatisticsEntry entry = this.m_statistics.get(Short.valueOf(id));
/* 231 */     if (entry != null)
...
/* 247 */     StatisticsEntry entry = this.m_statistics.get(Short.valueOf(id));
/* 248 */     if (entry != null)
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\statistics\AbstractStatisticsReport.class
