...
/*     */   extends SqlRequest
/*     */ {
/*  26 */   private static final ObjectPool m_pool = (ObjectPool)new MonitoredPool((PoolableObjectFactory)new ObjectFactory<StatisticsReportSaveRequest>() { public StatisticsReportSaveRequest makeObject() {
/*  27 */           return new StatisticsReportSaveRequest();
/*     */         } }
/*     */     );
/*     */   
/*     */   static StatisticsReportSaveRequest checkOut() {
/*     */     StatisticsReportSaveRequest msg;
/*     */     try {
/*  34 */       msg = (StatisticsReportSaveRequest)m_pool.borrowObject();
...
/*     */ 
/*     */   
/*     */   public Message execute(SqlRequestChannel channel) throws SQLException {
...
/*  89 */         stmt = channel.getConnection().prepareStatement(this.m_sql);
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServer\game\statistics\StatisticsReportSaveRequest.class
