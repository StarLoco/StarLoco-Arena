...
/*     */     
/* 203 */     this.mt = new int[624];
/*     */     
/* 205 */     this.mag01 = new int[2];
/* 206 */     this.mag01[0] = 0;
/* 207 */     this.mag01[1] = -1727483681;
/*     */     
/* 209 */     this.mt[0] = (int)(seed & 0xFFFFFFFL);
/* 210 */     for (this.mti = 1; this.mti < 624; this.mti++) {
/*     */       
...
/*     */ 
/*     */       
/* 218 */       this.mt[this.mti] = this.mt[this.mti] & 0xFFFFFFFF;
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 235 */     int i = 1, j = 0;
/* 236 */     int k = (624 > array.length) ? 624 : array.length;
/* 237 */     for (; k != 0; k--) {
/*     */       
/* 239 */       this.mt[i] = (this.mt[i] ^ (this.mt[i - 1] ^ this.mt[i - 1] >>> 30) * 1664525) + array[j] + j;
/* 240 */       this.mt[i] = this.mt[i] & 0xFFFFFFFF;
/* 241 */       i++;
/* 242 */       j++;
/* 243 */       if (i >= 624) { this.mt[0] = this.mt[623]; i = 1; }
/* 244 */        if (j >= array.length) j = 0; 
/*     */     } 
/* 246 */     for (k = 623; k != 0; k--) {
/*     */       
/* 248 */       this.mt[i] = (this.mt[i] ^ (this.mt[i - 1] ^ this.mt[i - 1] >>> 30) * 1566083941) - i;
/* 249 */       this.mt[i] = this.mt[i] & 0xFFFFFFFF;
/* 250 */       i++;
/* 251 */       if (i >= 624) {
/*     */         
/* 253 */         this.mt[0] = this.mt[623]; i = 1;
/*     */       } 
/*     */     } 
...
/*     */ 
/*     */       
/* 272 */       for (kk = 0; kk < 227; kk++) {
/*     */         
/* 274 */         int j = this.mt[kk] & Integer.MIN_VALUE | this.mt[kk + 1] & Integer.MAX_VALUE;
/* 275 */         this.mt[kk] = this.mt[kk + 397] ^ j >>> 1 ^ this.mag01[j & 0x1];
/*     */       } 
/* 277 */       for (; kk < 623; kk++) {
/*     */         
/* 279 */         int j = this.mt[kk] & Integer.MIN_VALUE | this.mt[kk + 1] & Integer.MAX_VALUE;
/* 280 */         this.mt[kk] = this.mt[kk + -227] ^ j >>> 1 ^ this.mag01[j & 0x1];
/*     */       } 
/* 282 */       int i = this.mt[623] & Integer.MIN_VALUE | this.mt[0] & Integer.MAX_VALUE;
/* 283 */       this.mt[623] = this.mt[396] ^ i >>> 1 ^ this.mag01[i & 0x1];
/*     */       
/* 285 */       this.mti = 0;
/*     */     } 
/*     */     
...
/*     */     }
/* 356 */     if ((n & -n) == n) {
/* 357 */       return (int)(n * next(31) >> 31L);
/*     */     }
/*     */ 
/*     */     
/*     */     while (true) {
/* 362 */       int bits = next(31);
/* 363 */       int val = bits % n;
/*     */       
/* 365 */       if (bits - val + n - 1 >= 0) {
/* 366 */         return val;
/*     */       }
/*     */     } 
/*     */   }
...
/*     */     
/*     */     while (true) {
/* 384 */       long bits = nextLong() >>> 1L;
/* 385 */       long val = bits % n;
/*     */       
/* 387 */       if (bits - val + n - 1L >= 0L) {
/* 388 */         return val;
/*     */       }
/*     */     } 
/*     */   }
...
/* 396 */     return ((next(26) << 27L) + next(27)) / 
...
/* 414 */     for (int x = 0; x < bytes.length; ) { bytes[x] = (byte)next(8); x++; }
/*     */   
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*     */     while (true) {
/* 458 */       double v1 = 2.0D * nextDouble() - 1.0D;
/* 459 */       double v2 = 2.0D * nextDouble() - 1.0D;
/* 460 */       double s = v1 * v1 + v2 * v2;
/* 461 */       if (s < 1.0D && s != 0.0D) {
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServe\\utils\MersenneTwister.class
