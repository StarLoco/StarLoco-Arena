...
/* 22 */     ConstantDefinition<O> cd = (ConstantDefinition<O>)this.m_list.get(id);
/* 23 */     if (cd != null)
/* 24 */       return (ConstantDefinition<O>)this.m_list.get(id); 
/* 25 */     return null;
/*    */   }
/*    */ 
/*    */   
/*    */   public O getObjectFromId(int id) {
/* 30 */     ConstantDefinition<O> cd = (ConstantDefinition<O>)this.m_list.get(id);
/* 31 */     if (cd != null)
/* 32 */       return ((ConstantDefinition<O>)this.m_list.get(id)).getObject(); 
/* 33 */     return null;
/*    */   }
/*    */   
/*    */   public Iterator<ConstantDefinition<O>> iterator() {
/* 37 */     return (Iterator<ConstantDefinition<O>>)new TroveIntHashMapValueIterator(this.m_list);
/*    */   }
/*    */ }


/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\common\clientAndServe\\utils\Constants.class
