...
/*     */ 
/*     */   
/*     */   private boolean m_useMultiCommands = true;
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*  87 */     this.m_nativeCommandDescriptorSet.addChild((CommandPattern)GLOBAL_PARENT_COMMAND);
/*  88 */     this.m_nativeCommandDescriptorSet.addChild((CommandPattern)GLOBAL_HELP_COMMAND);
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/*  95 */     this.m_views = new ArrayList<ConsoleView>();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 242 */       return String.valueOf(this.m_commandDescriptorSet.getPath()) + ">";
/*     */     }
/* 244 */     return "";
/*     */   }
/*     */ 
...
/* 284 */     for (i = (arrayOfString1 = commandLines).length, b = 0; b < i; ) { String commandLine = arrayOfString1[b];
/*     */ 
/*     */       
...
/*     */           
/* 302 */           String path[], pathGroup = matcher.group();
/*     */ 
/*     */           
/* 305 */           boolean isAbsolutePath = pathGroup.startsWith("/");
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 313 */             path = pathGroup.substring(1).split("/");
...
/*     */           } else {
/*     */             byte b1; int j; String[] arrayOfString;
/* 325 */             for (j = (arrayOfString = path).length, b1 = 0; b1 < j; ) { String commandSet = arrayOfString[b1];
...
/* 328 */                 err("Chemin " + commandSet + " invalide"); break;
/*     */               } 
/* 330 */               if (pathMatches.size() == 1) {
/* 331 */                 CommandPattern commandPattern = pathMatches.get(0);
...
/*     */ 
/*     */       
/* 354 */       ArrayList<CommandPattern> matchesDescriptors = new ArrayList<CommandPattern>();
...
/* 381 */             while (argsMatcher.find()) {
/* 382 */               for (int j = 0; j <= argsMatcher.groupCount(); j++) {
/* 383 */                 args.add(argsMatcher.group(j));
/*     */               }
/*     */             } 
/*     */ 
/*     */             
/* 388 */             command.execute(this, commandPattern, args);
/*     */           }
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\client\proxyclient\base\console\ConsoleManager.class
