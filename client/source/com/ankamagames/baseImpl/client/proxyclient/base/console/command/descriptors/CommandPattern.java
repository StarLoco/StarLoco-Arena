...
/* 37 */       cmdFullRegex = String.valueOf(cmdRegex) + "(?:\\s+.*|$)";
/*    */     }
/*    */     
...
/* 44 */       !argsRegex.startsWith(String.valueOf(argFullRegex) + "\\s+")) {
/* 45 */       argFullRegex = String.valueOf(argFullRegex) + "\\s+" + argsRegex;
/*    */     }
/*    */     
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\com\ankamagames\baseImpl\client\proxyclient\base\console\command\descriptors\CommandPattern.class
