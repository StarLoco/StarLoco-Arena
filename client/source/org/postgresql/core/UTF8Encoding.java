...
/*     */     } 
/*  63 */     throw new IOException(GT.tr("Illegal UTF-8 sequence: {0} bytes used to encode a {1} byte value: {2}", new Object[] { new Integer(actualLen), new Integer(b), new Integer(ch) }));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 144 */           cdata[out++] = (char)(56320 + (ch & 0x3FF)); continue;
...
/* Location:              E:\Jeux\Ankama\DofusArena2-offi\game\core.jar!\org\postgresql\core\UTF8Encoding.class
